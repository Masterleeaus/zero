...
enum Introduction: string implements Contracts\WithStringBackedEnum
{
    ...
    case AI_CHAT_PRO_IMAGE_CHAT = 'ai_chat_pro_image_chat';
    ...
    case AI_IMAGE_PRO = 'ai_image_pro';
    case AI_IMAGE_PRO_MEDIA_LIBRARY = 'ai_image_pro_media_library';
    ...
    case DISCOUNT_MANAGER = 'discount_manager';
    ...
    case ADMIN_AI_IMAGE_PRO_PUBLISH_REQS = 'ai_image_pro_publish_reqs';
    ...
    case ADMIN_FOOTER_MENU_SETTINGS = 'footer_menu_setting';
    ...
    case AI_INFLUENCER = 'ai_influencer';

    case URL_TO_VIDEO = 'url_to_video';
    ...
    public function label(): string
    {
        return match ($this) {
            ...
            self::AI_CHAT_PRO                             => __('AI Chat Pro'),
            self::AI_IMAGE_PRO                            => __('AI Image Pro'),
            self::AI_IMAGE_PRO_MEDIA_LIBRARY              => __('AI Image Pro Media Library'),
            ...
            self::DISCOUNT_MANAGER                        => __('Admin Discount Manager'),
