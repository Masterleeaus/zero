...
class MenuService
{
    ...
    public function data(): array
    {
        ...
        $menu = [
            ...
            // Cleaning vertical menu
            'cleaning_label' => [
                'parent_key'       => null,
                'key'              => 'cleaning_label',
                'route'            => null,
                'label'            => workcore_label('cleaning', __('Cleaning')),
                'icon'             => 'tabler-broom',
                'svg'              => null,
                'order'            => 6,
                'is_active'        => true,
            ...
            'cleaning_customers' => [
                'parent_key'       => 'cleaning_label',
                'key'              => 'cleaning_customers',
                'route'            => 'dashboard.crm.customers.index',
                'label'            => workcore_label('customers', __('Customers')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.crm.customers.*'],
                'show_condition'   => Route::has('dashboard.crm.customers.index'),
            ],
            'cleaning_enquiries' => [
                'parent_key'       => 'cleaning_label',
                'key'              => 'cleaning_enquiries',
                'route'            => 'dashboard.crm.enquiries.index',
                'label'            => workcore_label('enquiries', __('Enquiries')),
                'icon'             => 'tabler-mail',
                'svg'              => null,
                'order'            => 7,
                'is_active'        => true,
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.crm.enquiries.*'],
                'show_condition'   => Route::has('dashboard.crm.enquiries.index'),
            ],
            'cleaning_follow_ups' => [
                'parent_key'       => 'cleaning_label',
                'key'              => 'cleaning_follow_ups',
                'route'            => 'dashboard.crm.enquiries.index',
                'label'            => workcore_label('follow_ups', __('Follow-Ups')),
            ...
            'cleaning_jobs' => [
                ...
                'label'            => workcore_label('service_jobs', __('Jobs')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.work.service-jobs.*'],
                'show_condition'   => Route::has('dashboard.work.service-jobs.index'),
            ],
            'cleaning_schedule' => [
                'parent_key'       => 'cleaning_label',
                'key'              => 'cleaning_schedule',
                'route'            => 'dashboard.work.shifts.index',
                'label'            => workcore_label('schedule_dispatch', __('Schedule & Dispatch')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.work.shifts.*'],
                'show_condition'   => Route::has('dashboard.work.shifts.index'),
            ],
            'cleaning_checklists' => [
                'parent_key'       => 'cleaning_label',
                'key'              => 'cleaning_checklists',
                'route'            => 'dashboard.work.checklists.index',
                'label'            => workcore_label('checklists', __('Cleaning Checklist')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.work.checklists.*'],
                'show_condition'   => Route::has('dashboard.work.checklists.index'),
            ],
            'cleaning_team' => [
                'parent_key'       => 'cleaning_label',
                'key'              => 'cleaning_team',
                'route'            => null,
                'label'            => workcore_label('team', __('Team')),
                ...
                'active_condition' => [
                    'dashboard.team.*',
                    'dashboard.work.leaves.*',
                    'dashboard.work.timelogs.*',
                    'dashboard.work.attendance.*',
                ],
                'show_condition'   => true,
            ],
            'cleaning_team_cleaners' => [
                'parent_key'       => 'cleaning_team',
                'key'              => 'cleaning_team_cleaners',
                'route'            => 'dashboard.team.roster.index',
                'label'            => workcore_label('cleaners', __('Cleaners')),
                'icon'             => 'tabler-user',
                'svg'              => null,
                'order'            => 1,
                'is_active'        => true,
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.team.roster.*'],
                'show_condition'   => Route::has('dashboard.team.roster.index'),
            ],
            'cleaning_team_availability' => [
                'parent_key'       => 'cleaning_team',
                'key'              => 'cleaning_team_availability',
                'route'            => 'dashboard.work.attendance.index',
                'label'            => workcore_label('availability', __('Availability')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.work.attendance.*'],
                'show_condition'   => Route::has('dashboard.work.attendance.index'),
            ],
            'cleaning_team_shift_log' => [
                'parent_key'       => 'cleaning_team',
                'key'              => 'cleaning_team_shift_log',
                'route'            => 'dashboard.work.timelogs.index',
                'label'            => workcore_label('shift_log', __('Shift Log')),
                'icon'             => 'tabler-clock',
                'svg'              => null,
                'order'            => 3,
                'is_active'        => true,
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.work.timelogs.*'],
                'show_condition'   => Route::has('dashboard.work.timelogs.index'),
            ],
            'cleaning_team_leave' => [
                'parent_key'       => 'cleaning_team',
                'key'              => 'cleaning_team_leave',
                'route'            => 'dashboard.work.leaves.index',
                'label'            => workcore_label('leave', __('Leave')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.work.leaves.*'],
                'show_condition'   => Route::has('dashboard.work.leaves.index'),
            ],
            'cleaning_team_roles' => [
                'parent_key'       => 'cleaning_team',
                'key'              => 'cleaning_team_roles',
                'route'            => 'dashboard.team.roles.index',
                'label'            => workcore_label('roles', __('Roles')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.team.roles.*'],
                'show_condition'   => Route::has('dashboard.team.roles.index'),
            ],
            'cleaning_team_teams' => [
                'parent_key'       => 'cleaning_team',
                'key'              => 'cleaning_team_teams',
                'route'            => 'dashboard.team.teams.index',
                'label'            => workcore_label('teams', __('Teams')),
                'icon'             => 'tabler-users',
                'svg'              => null,
                'order'            => 6,
                'is_active'        => true,
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.team.teams.*'],
                'show_condition'   => Route::has('dashboard.team.teams.index'),
            ],
            'cleaning_team_zones' => [
                'parent_key'       => 'cleaning_team',
                'key'              => 'cleaning_team_zones',
                'route'            => 'dashboard.team.zones.index',
                'label'            => workcore_label('zones', __('Zones')),
                'icon'             => 'tabler-map',
                'svg'              => null,
                'order'            => 7,
                'is_active'        => true,
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.team.zones.*'],
                'show_condition'   => Route::has('dashboard.team.zones.index'),
            ],
            'cleaning_money' => [
                'parent_key'       => 'cleaning_label',
                'key'              => 'cleaning_money',
                'route'            => null,
                'label'            => workcore_label('money', __('Money')),
                'icon'             => 'tabler-cash',
                'svg'              => null,
                'order'            => 13,
                'is_active'        => true,
                ...
                'active_condition' => [
                    ...
                    'dashboard.money.invoices.*',
                    'dashboard.money.payments.*',
                    'dashboard.money.credit-notes.*',
                    'dashboard.money.expenses.*',
                    'dashboard.money.bank-accounts.*',
                    'dashboard.money.expense-categories.*',
                ],
                'show_condition'   => true,
            ],
            'cleaning_money_quotes' => [
                'parent_key'       => 'cleaning_money',
                'key'              => 'cleaning_money_quotes',
                'route'            => 'dashboard.money.quotes.index',
                'label'            => workcore_label('quotes', __('Quotes')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.money.quotes.*'],
                'show_condition'   => Route::has('dashboard.money.quotes.index'),
            ],
            'cleaning_money_invoices' => [
                'parent_key'       => 'cleaning_money',
                'key'              => 'cleaning_money_invoices',
                'route'            => 'dashboard.money.invoices.index',
                'label'            => workcore_label('invoices', __('Invoices')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.money.invoices.*'],
                'show_condition'   => Route::has('dashboard.money.invoices.index'),
            ],
            'cleaning_money_payments' => [
                'parent_key'       => 'cleaning_money',
                'key'              => 'cleaning_money_payments',
                'route'            => 'dashboard.money.payments.index',
                'label'            => workcore_label('payments', __('Payments')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.money.payments.*'],
                'show_condition'   => Route::has('dashboard.money.payments.index'),
            ],
            'cleaning_money_credit_notes' => [
                'parent_key'       => 'cleaning_money',
                'key'              => 'cleaning_money_credit_notes',
            ...
            'cleaning_money_expenses' => [
                'parent_key'       => 'cleaning_money',
                'key'              => 'cleaning_money_expenses',
                'route'            => 'dashboard.money.expenses.index',
                'label'            => workcore_label('expenses', __('Expenses')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.money.expenses.*'],
                'show_condition'   => Route::has('dashboard.money.expenses.index'),
            ],
            'cleaning_money_bank_accounts' => [
                'parent_key'       => 'cleaning_money',
                'key'              => 'cleaning_money_bank_accounts',
                'route'            => 'dashboard.money.bank-accounts.index',
                'label'            => workcore_label('bank_accounts', __('Bank Accounts')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.money.bank-accounts.*'],
                'show_condition'   => Route::has('dashboard.money.bank-accounts.index'),
            ],
            'cleaning_money_expense_categories' => [
                'parent_key'       => 'cleaning_money',
                'key'              => 'cleaning_money_expense_categories',
                'route'            => 'dashboard.money.expense-categories.index',
                'label'            => workcore_label('expense_categories', __('Expense Categories')),
                'icon'             => 'tabler-folders',
                'svg'              => null,
                'order'            => 7,
                'is_active'        => true,
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.money.expense-categories.*'],
                'show_condition'   => Route::has('dashboard.money.expense-categories.index'),
            ],
            'cleaning_service_requests' => [
                'parent_key'       => 'cleaning_label',
                'key'              => 'cleaning_service_requests',
                'route'            => 'dashboard.service-requests.index',
                'label'            => workcore_label('service_requests', __('Service Requests')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.service-requests.*'],
                'show_condition'   => Route::has('dashboard.service-requests.index'),
            ],
            'cleaning_playbooks' => [
                'parent_key'       => 'cleaning_label',
                'key'              => 'cleaning_playbooks',
                'route'            => 'dashboard.playbooks.index',
                'label'            => workcore_label('playbooks', __('Playbooks')),
                'icon'             => 'tabler-book',
                'svg'              => null,
                'order'            => 15,
                'is_active'        => true,
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.playbooks.*'],
                'show_condition'   => Route::has('dashboard.playbooks.index'),
            ],
            'cleaning_insights' => [
                'parent_key'       => 'cleaning_label',
                'key'              => 'cleaning_insights',
                'route'            => 'dashboard.insights.overview',
                'label'            => workcore_label('insights', __('Insights')),
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.insights.*'],
                'show_condition'   => Route::has('dashboard.insights.overview'),
            ],

            // Operations menu
            'operations_label' => [
                'parent_key'       => null,
                'key'              => 'operations_label',
                'route'            => null,
                'label'            => 'Operations',
                'icon'             => 'tabler-briefcase',
                'svg'              => null,
            ...
            'operations_insights' => [
                'parent_key'       => 'operations_label',
                'key'              => 'operations_insights',
                'route'            => 'dashboard.insights.overview',
                'label'            => 'Insights',
                'icon'             => 'tabler-chart-donut-2',
                'svg'              => null,
            ...
            'operations_support' => [
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.support.*'],
                'show_condition'   => Route::has('dashboard.support.index'),
            ],
            'operations_notifications' => [
                'parent_key'       => 'operations_label',
                'key'              => 'operations_notifications',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.user.notifications.*'],
                'show_condition'   => Route::has('dashboard.user.notifications.index'),
            ],
            'operations_timelogs' => [
                'parent_key'       => 'operations_label',
                'key'              => 'operations_timelogs',
                'route'            => 'dashboard.work.timelogs.index',
                'label'            => 'Timelogs',
            ...
            'operations_agreements' => [
                'parent_key'       => 'operations_label',
                'key'              => 'operations_agreements',
                ...
                'type'             => 'item',
                'extension'        => null,
                'active_condition' => ['dashboard.work.agreements.*'],
                'show_condition'   => Route::has('dashboard.work.agreements.index'),
            ],
            'ext_chat_bot_agent' => [
                'parent_key'       => null,
    ...
    public function mergeExtensionMenu($menu)
    {
        ...
        $menu = array_merge($menu, [
            ...
            'business_suite_agent_chat_settings_extension' => [
                ...
                'route'            => 'dashboard.admin.social-media.agent.chat.settings',
                'label'            => 'Business Agent Chat Settings',
                'icon'             => null,
                'svg'              => null,
                'order'            => 78,
                'is_active'        => true,
