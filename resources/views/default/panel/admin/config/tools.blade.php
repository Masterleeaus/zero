        ...
        <div class="col-md-12 mb-4">
            <div class="mb-3">
                @php
                    ...
                    $current_engine = EngineEnum::fromSlug(
                        setting('default_ai_engine', EngineEnum::OPEN_AI->slug()),
                    )->slug();
                @endphp
                <x-engine-select-list-with-change-alert
                    :listLabel="'Default AI engine'"
                    :listId="'default_ai_engine'"
        ...
        <div class="col-md-12 mb-4">
            <div class="mb-3">
                ...
                <x-card
                    ...
                    size="sm"
                >
                    <label class="form-label">{{ __('Voice Chat Engine') }}</label>
                    <select
                        class="form-select"
                        id="voice_chat_engine"
                        name="voice_chat_engine"
                    >
                        @foreach ($voice_chat_engines as $engine)
                            <option
                                value="{{ $engine->value }}"
        ...
        <div class="col-md-12 mb-4">
            <div class="mb-3">
                @php
                    ...
                    $current_aw_engine = EngineEnum::fromSlug(
                        setting('default_aw_image_engine', EngineEnum::UNSPLASH->slug()),
                    )->slug();
                @endphp
                <x-engine-select-list-with-change-alert
                    :isAW="'true'"
                    :listLabel="'Article Wizard default image engine'"
                    :listId="'default_aw_image_engine'"
                    currentEngine="{{ $current_aw_engine }}"
                    :engines="$aw_engines"
                />
            </div>
        </div>
        ...
        <div class="row mb-4 mt-4">
            <div class="mb-3">
                ...
                <x-forms.input
                    ...
                    type="checkbox"
                    :checked="setting('user_ai_image_prompt_library') == 1 ||
                        setting('user_ai_image_prompt_library') == null"
