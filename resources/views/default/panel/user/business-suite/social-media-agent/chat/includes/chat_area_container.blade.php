@php
    ...
    $example_prompts = json_decode(setting('social_media_agent_example_prompts', $example_prompts_json), false, 512, JSON_THROW_ON_ERROR);
@endphp
...
>
    ...
    <div class="relative flex grow flex-col">
        ...
        <div @class([
            ...
            <div
                ...
                >
                    <img
                        src="{{ @asset('/vendor/social-media-agent/images/img-10.png') }}"
                        alt="{{ __('Service Ops Agent') }}"
                        width="300"
                        height="265"
                    >
                </figure>
                <h2 class="mb-8 text-center text-[30px] font-medium leading-[1.1em] md:text-[34px] lg:text-[clamp(34px,2vw,40px)]">
                    ...
                    <br>
                    {{ __('Ask me anything about social media.') }}
                </h2>
    ...
    @if (view()->hasSection('chat_form'))
        @yield('chat_form')
    @else
        @include('social-media-agent::chat.includes.chat_form')
    @endif
</div>
