...
@section('title', $job->exists ? __('work.jobs.edit') : __('work.jobs.new'))
    ...
    <div class="py-6">
        <form method="post"
            ...
            <div class="grid md:grid-cols-2 gap-4">
                <div>
                    <label class="form-label">{{ __('work.labels.site') }}</label>
                ...
                <div>
                    <label class="form-label">{{ __('crm.customers.title') }}</label>
                    <x-select name="customer_id">
                        <option value="">{{ __('work.jobs.select_customer') }}</option>
                ...
                <div>
                    ...
                    <x-select name="assigned_user_id">
                        <option value="">{{ __('work.jobs.unassigned') }}</option>
                ...
                <x-input label="{{ __('work.jobs.scheduled_at') }}" type="datetime-local" name="scheduled_at"
