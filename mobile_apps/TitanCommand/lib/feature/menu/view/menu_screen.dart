...
class MenuScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final List<MenuModel> menuList = [
      ...
      MenuModel(icon: Images.settings, title: 'team_settings'.tr, route: RouteHelper.getLanguageBottomSheet('menu')),
      ...
      MenuModel(icon: Images.reportOverview2, title: 'quality'.tr, route: RouteHelper.getReportingPageRoute('menu')),
      MenuModel(icon: Images.helpIcon, title: 'ask_titan'.tr, route: RouteHelper.getHelpAndSupportScreen()),
      MenuModel(icon: Images.helpIcon, title: 'voice_control'.tr, route: RouteHelper.getHelpAndSupportScreen()),
      MenuModel(icon: Images.helpIcon, title: 'training'.tr, route: RouteHelper.getHelpAndSupportScreen()),
