...
>
    ...
    <div class="lqd-ext-chatbot-training mt-16 flex flex-col justify-center gap-9">
        ...
        <div class="lqd-ext-chatbot-training-content grid">
            @include('titan-hello::admin.partials.training.training-tabs.training-tab-website')
            @include('titan-hello::admin.partials.training.training-tabs.training-tab-pdf')
            @include('titan-hello::admin.partials.training.training-tabs.training-tab-text')
        </div>
    </div>
                ...
                Alpine.data('externalChatbotTraining', () => ({
                    ...
                    async fetchEmbeddings() {
                        ...
                        const res = await fetch(
                            `{{ route('dashboard.titan-hello.train.data') }}?id=${this.activeChatbot.id}`
                        );
                    ...
                    async deleteEmbedding(embeddingId) {
                        ...
                        const res = await fetch(
                            '{{ route('dashboard.titan-hello.train.delete') }}', {
                                method: 'DELETE',
                                headers: {
                                    'Content-Type': 'application/json',
                                    'Accept': 'application/json',
