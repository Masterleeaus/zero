            ...
            <div class="flex flex-wrap items-center justify-between gap-4 px-3 py-3 lg:h-[--header-height] lg:px-12">
                ...
                <div class="lqd-steps hidden flex-col gap-1 lg:flex">
                    <div class="lqd-steps-steps flex items-center justify-between gap-1 lg:gap-3">
                        @foreach (\Extensions\TitanHello\Helpers\Enums\StepEnum::toArray() as $step)
                            <button
        ...
        <div class="lqd-chatbot-edit-window-content py-8 lg:py-0">
            <div class="container flex flex-wrap justify-center gap-y-5">
                ...
                <div
                    ...
                    >
                    @include('titan-hello::admin.partials.edit-window.edit-steps.edit-step-configure')
                    @include('titan-hello::admin.partials.edit-window.edit-steps.edit-step-customize', [
                        'avatars' => $avatars,
                    ])
                    @include('titan-hello::admin.partials.edit-window.edit-steps.edit-step-train')
                    @include('titan-hello::admin.partials.edit-window.edit-steps.edit-step-embed')
                    <div
            ...
            document.addEventListener('alpine:init', () => {
                Alpine.data('customAvatar', () => ({
                    ...
                    async onPickerChange() {
                        ...
                        await fetch('{{ route('dashboard.titan-hello.upload.avatar') }}', {
                                method: 'POST',
                                body: formData,
                            })
                            .then(response => {
