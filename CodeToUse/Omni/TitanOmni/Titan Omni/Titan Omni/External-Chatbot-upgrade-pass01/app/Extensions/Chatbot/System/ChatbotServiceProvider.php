...
use App\Extensions\Chatbot\System\Http\Controllers\Api\ChatbotPortalController;
    ...
    private function registerRoutes(): static
    {
        $this->router()
            ...
            ->group([
                'middleware' => ['api', LanguageMiddleware::class],
                'prefix'     => 'api/v2/chatbot',
                'as'         => 'api.v2.chatbot.portal.',
                'controller' => ChatbotPortalController::class,
            ], function (Router $router) {
                $router->get('{chatbot:uuid}/session/{sessionId}/portal', 'overview')->name('overview');
                $router->get('{chatbot:uuid}/session/{sessionId}/portal/notifications', 'notifications')->name('notifications');
            })
