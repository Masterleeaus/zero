...
class ChatbotResource extends JsonResource
{
    public function toArray(Request $request): array|Arrayable|JsonSerializable
    {
        return [
            ...
            'portal'                     => [
                'enabled' => (bool) $this->is_customer_portal,
                'home_title' => $this->portal_home_title,
                'primary_cta' => $this->portal_primary_cta,
                'modules' => $this->portal_modules ?? [],
                'quick_actions' => $this->portal_quick_actions ?? [],
