...
>
    ...
    >
        ...
        <div
            ...
            @include('titan-hello::admin.partials.chats-history.chats-list')
            ...
            >
                <x-button
                    ...
                    variant="link"
                    href="{{ route('dashboard.titan-hello.conversation.with.paginate', ['page' => 1]) }}"
                    x-ref="loadMore"
    ...
    <div class="lqd-ext-chatbot-history-content-wrap flex grow flex-col max-sm:h-[70vh]">
        <div
            class="lqd-ext-chatbot-history-head hidden h-[--header-height] w-full justify-between gap-4 border-b px-8 py-5">
            <form
        ...
        <div class="lqd-ext-chatbot-history-messages-wrap grow overflow-hidden">
            ...
            >
                @include('titan-hello::admin.partials.chats-history.chat-messages')
            </div>
        </div>
