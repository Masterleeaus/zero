...
use Extensions\TitanHello\Helpers\Requests\Train\DataRequest;
use Extensions\TitanHello\Helpers\Requests\Train\FileRequest;
use Extensions\TitanHello\Helpers\Requests\Train\TextRequest;
use Extensions\TitanHello\Helpers\Requests\Train\TrainRequest;
use Extensions\TitanHello\Helpers\Requests\Train\TrainUrlRequest;
use Extensions\TitanHello\Helpers\Resources\ChatbotTrainResource;
use Extensions\TitanHello\Models\ExtVoicechatbotTrain;
use Extensions\TitanHello\Services\Parsers\LinkParser;
...
class ChatbotVoiceTrainController extends Controller
{
    ...
    public function trainFile(FileRequest $request): JsonResponse|AnonymousResourceCollection
    {
        ...
        $defaultDisk = 'public';
        $path = $file->store('titan-hello', ['disk' => $defaultDisk]);
