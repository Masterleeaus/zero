...
@vite('app/Extensions/ChatbotVoice/resources/assets/scss/external-titan-hello.scss')
@vite('resources/views/default/js/voiceChatbot.js')

<div
    class="lqd-ext-titan-hello"
...
>
    ...
    @else
        <div class="icon">
            <img
                id="lqd-ext-titan-hello-vis-img"
                src="{{ asset($chatbot->avatar) }}"
                alt="{{ $chatbot->title }}}"
            >
        </div>
        <div class="lqd-ext-titan-hello-trigger">
            <p id="lqd-ext-titan-hello-bot-status">{{ $chatbot->bubble_message ?? __('Need help?') }}</p>
            <button
                class="lqd-ext-titan-hello-trigger-btn"
                id="lqd-ext-titan-hello-start-btn"
            >
                <svg
                    viewBox="0 0 640 640"
            ...
            <button
                class="lqd-ext-titan-hello-trigger-btn"
                id="lqd-ext-titan-hello-end-btn"
            >
                <svg
                    viewBox="0 0 640 640"
                    xmlns="http://www.w3.org/2000/svg"
...
<script>
    const extVoiceChatbotServer = () => ({
        ...
        // init
        init() {
            this.wrapper = document.querySelector('.lqd-ext-titan-hello');
