<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.units.manageGroups')</h5>
    ...
    <div class="portlet-body">
        <div class="table-responsive">
            <x-table class="table-bordered">
                <x-slot name="thead">
                    <th>#</th>
                    <th>@lang('modules.units.group')</th>
        ...
        <hr>
        <x-form id="createUnitGroup" method="POST" class="ajax-form">
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.units.groupName')"
...
<script>
    $('#createUnitGroup').on('submit', function(e) {
        return false;
    })
    ...
    $('.delete-group').click(function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed)
            {
                ...
                var url = "{{ route('unit-groups.destroy',':id') }}";
    ...
    $('#save-group').click(function () {
        $.easyAjax({
            url: "{{route('unit-groups.store')}}",
            container: '#createUnitGroup',
            type: "POST",
            blockUI: true,
            data: $('#createUnitGroup').serialize(),
            success: function (response) {
                if(response.status == 'success'){
