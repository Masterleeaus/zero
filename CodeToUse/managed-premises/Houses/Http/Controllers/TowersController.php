...
use Modules\Houses\Http\Requests\StoreTowerRequest;
use Modules\Houses\Http\Requests\UpdateTowerRequest;
...
class TowersController extends AccountBaseController
{
    ...
    {
        return view('houses::house-settings.create-tower-modal');
    }
    ...
    public function edit($id)
    {
        ...
        return view('houses::house-settings.edit-tower-modal', $this->data);
    }
