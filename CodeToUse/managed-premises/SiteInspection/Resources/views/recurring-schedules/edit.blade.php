            ...
            <input type="hidden" name="schedule_count" value="{{count($schedule->recurrings)}}">
                ...
                <div class="row px-lg-4 px-md-4 px-3 pt-3">
                    <div class="col-md-8">
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-4">
                                <div class="form-group c-inv-select mb-4">
                                    <x-forms.label fieldId="rotation" :fieldLabel="__('modules.schedules.billingFrequency')"
                                                fieldRequired="true">
                                    </x-forms.label>
                            ...
                            <div class="col-lg-4 mt-0 billingInterval">
                                <x-forms.number class="mr-0  mr-lg-2 mr-md-2 mt-0"
                                                :fieldLabel="__('modules.schedules.totalCount')"
                                                fieldName="billing_cycle" fieldId="billing_cycle" :fieldValue="$billingCycle"
                                                :fieldHelp="__('modules.schedules.noOfBillingCycle')" :fieldReadOnly="(count($schedule->recurrings) > 0) ? true : ''"/>
                            </div>
                        </div>
                    </div>
                    @php
                    ...
                    <div class="col-md-4 mt-4 information-box">
                        <p id="plan">@lang('modules.schedules.customerCharged') @if($schedule->rotation != 'daily') @lang('app.every') @endif {{$rotationType}}</p>
                    ...
                    <div class="row px-lg-4 px-md-4 px-3 pb-3 pt-0 mb-3  mt-2">
                        <div class="col-md-12">
                            <a class="f-15 f-w-500" href="javascript:;" id="add-item"><i
                                    class="icons icon-plus font-weight-bold mr-1"></i>@lang('modules.schedules.addItem')</a>
                        </div>
                    </div>
                <!--  ADD ITEM END-->
                ...
                <div class="px-lg-4 px-md-4 px-3 py-3 c-inv-btns">
                    <div class="d-flex">
                        <x-forms.button-cancel :link="route('recurring-schedules.index')"
    ...
    <script>
        $(document).ready(function () {
            ...
            $('.save-form').click(function () {
                $.easyAjax({
                    url: "{{ route('recurring-schedules.update', $schedule->id) }}",
