                                ...
                                <table class="inv-detail f-14 table-responsive-sm" width="100%">
                                    ...
                                    <p class="mb-0">
                                        {{-- @if ($scheduleSetting->show_project == 1 && isset($schedule->project->project_name))
                                            <span class="text-dark-grey text-capitalize">@lang('modules.schedules.projectName')</span><br>
                                            ...
                                            <table width="100%">
                                                {{-- <tr class="text-dark-grey" align="right">
                                                    <td class="w-50 border-top-0 border-left-0">
                                                        @lang('modules.schedules.subTotal')</td>
                                                ...
                                                @if ($discount != 0 && $discount != '')
                                                    <tr class="text-dark-grey" align="right">
                                                        <td class="w-50 border-top-0 border-left-0">
                                                            @lang('modules.schedules.discount')</td>
                                                        <td class="border-top-0 border-right-0">
                                                ...
                                                <tr class=" text-dark-grey font-weight-bold" align="right">
                                                    <td class="w-50 border-bottom-0 border-left-0">
                                                        @lang('modules.schedules.total')</td>
