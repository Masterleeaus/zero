  ...
  <div class="card"><div class="card-body">
    ...
    <div class="row">
      <div class="col-md-6 mb-3">
        <label class="form-label">{{ __('propertymanagement::app.starts_on') }}</label>
        <input type="date" class="form-control" name="starts_on" value="{{ old('starts_on', optional($plan->starts_on ?? null)->format('Y-m-d')) }}">
      </div>
      <div class="col-md-6 mb-3">
        <label class="form-label">{{ __('propertymanagement::app.ends_on') }}</label>
    ...
    <div class="form-check mb-3">
      ...
      <label class="form-check-label">{{ __('propertymanagement::app.active') }}</label>
    </div>
