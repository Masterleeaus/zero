        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($asset_maintenances)
                ...
                ->addColumn('action', function ($row) {
                    $html = '<button type="button" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-primary edit_maintenance" data-href="'.action([\Modules\AssetManagement\Http\Controllers\AssetMaitenanceController::class, 'edit'], [$row->id]).'"><i class="fas fa-edit"></i> '.__('messages.edit').'</button>';

                    $html .= ' <button type="button" data-href="'.action([\Modules\AssetManagement\Http\Controllers\AssetMaitenanceController::class, 'destroy'], [$row->id]).'"  id="delete_asset_maintenance" class="tw-dw-btn tw-dw-btn-xs tw-dw-btn-outline  tw-dw-btn-error">
