...
import 'package:demandium/feature/booking/widget/proof_of_service_viewer.dart';
          ...
          return SingleChildScrollView( physics: const ClampingScrollPhysics(), child: Center(
            child: Padding( padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                ...
                ProofOfServiceViewer(bookingDetailsContent: bookingDetails): const SizedBox(),
          ...
          return Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
            ...
            Padding(padding: const EdgeInsets.only(left: 15, right: 15, bottom: 10),
              child: OutlinedButton.icon(
                ...
                icon: Icon(Icons.flag_outlined, size: 16, color: Theme.of(context).colorScheme.error),
                label: Text('report_issue'.tr, style: robotoMedium.copyWith(color: Theme.of(context).colorScheme.error, fontSize: Dimensions.fontSizeSmall)),
                onPressed: () => Get.toNamed(RouteHelper.getReportIssueRoute(bookingId: bookingDetailsController.bookingDetailsContent?.id)),
              ),
            ),
            ]) : const SizedBox()
