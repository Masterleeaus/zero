                ...
                text:TextSpan(text: '${'payment_status'.tr} ',
                    ...
                    children: [
                      TextSpan(text:bookingDetails.isPaid==1? 'paid'.tr: 'unpaid'.tr,
                        style: robotoMedium.copyWith(fontSize: Dimensions.fontSizeDefault,
                            color:bookingDetails.isPaid==1?Colors.green:
