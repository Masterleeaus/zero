...
class IntegrationPoints
{
    public static function all(): array
    {
        return [
            'events' => [
                'Modules\\PropertyManagement\\Events\\PropertyVisitScheduled',
                'Modules\\PropertyManagement\\Events\\PropertyVisitCompleted',
            ],
            'adapters' => [
                'Modules\\PropertyManagement\\Integrations\\Core\\TaskAdapterInterface',
                'Modules\\PropertyManagement\\Integrations\\Core\\HrAdapterInterface',
            ],
            'endpoints' => [
