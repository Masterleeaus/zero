@php
    ...
    $action = $isEdit ? route('propertymanagement.properties.update', $property->id) : route('propertymanagement.properties.store');
@endphp
...
<x-form id="property-form" method="POST" :action="$action">
    ...
    <div class="row">
        <div class="col-md-6">
            <x-forms.text fieldId="name" fieldName="name" :fieldLabel="__('propertymanagement::app.labels.name')" :fieldValue="$property->name" />
        </div>
        <div class="col-md-3">
            <x-forms.text fieldId="property_code" fieldName="property_code" :fieldLabel="__('propertymanagement::app.labels.code')" :fieldValue="$property->property_code" />
        </div>
        <div class="col-md-3">
            <x-forms.select fieldId="type" fieldName="type" :fieldLabel="__('propertymanagement::app.labels.type')">
    ...
    <div class="row">
        <div class="col-md-8">
            <x-forms.text fieldId="address_line1" fieldName="address_line1" :fieldLabel="__('propertymanagement::app.labels.address')" :fieldValue="$property->address_line1" />
        </div>
        <div class="col-md-4">
    ...
    <div class="row">
        <div class="col-md-6">
            <x-forms.textarea fieldId="access_notes" fieldName="access_notes" :fieldLabel="__('propertymanagement::app.labels.accessNotes')" :fieldValue="$property->access_notes" />
        </div>
        <div class="col-md-6">
            <x-forms.textarea fieldId="hazards" fieldName="hazards" :fieldLabel="__('propertymanagement::app.labels.hazards')" :fieldValue="$property->hazards" />
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col-md-4">
            <x-forms.select fieldId="status" fieldName="status" :fieldLabel="__('propertymanagement::app.labels.status')">
    ...
    <h5 class="mt-3 mb-2">@lang('propertymanagement::app.labels.primaryContact')</h5>
    <div class="row">
        <div class="col-md-4">
