...
@section('content')
    ...
    <div class="card mb-3">
        ...
        <div class="card-body">
            <x-form method="POST" :action="route('propertymanagement.properties.jobs.store', $property->id)">
                @csrf
                <div class="row">
                    <div class="col-md-4">
                        ...
                        @forelse($property->jobs as $job)
                            <tr>
                                ...
                                <td class="text-right">
                                    ...
                                    <form id="delete-job-{{ $job->id }}" method="POST" action="{{ route('propertymanagement.properties.jobs.destroy', [$property->id, $job->id]) }}" style="display:none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
                                </td>
