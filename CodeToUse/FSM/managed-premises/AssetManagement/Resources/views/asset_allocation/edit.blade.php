<div class="modal-dialog" role="document">
    {!! Form::open(['url' => action([\Modules\AssetManagement\Http\Controllers\AssetAllocationController::class, 'update'], [$asset_allocated->id]), 'method' => 'put', 'id' => 'asset_allocation_form']) !!}
