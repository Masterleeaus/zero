<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.houses.manageGroups')</h5>
    ...
    <div class="portlet-body">
        <div class="table-responsive">
            <x-table class="table-bordered">
                <x-slot name="thead">
                    <th>#</th>
                    <th>@lang('modules.houses.group')</th>
        ...
        <hr>
        <x-form id="createHouseGroup" method="POST" class="ajax-form">
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.houses.groupName')"
...
<script>
    $('#createHouseGroup').on('submit', function(e) {
        return false;
    })
    ...
    $('.delete-group').click(function () {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed)
            {
                ...
                var url = "{{ route('house-groups.destroy',':id') }}";
    ...
    $('#save-group').click(function () {
        $.easyAjax({
            url: "{{route('house-groups.store')}}",
            container: '#createHouseGroup',
            type: "POST",
            blockUI: true,
            data: $('#createHouseGroup').serialize(),
            success: function (response) {
                if(response.status == 'success'){
