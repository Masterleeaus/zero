<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">
        @lang('modules.schedules.payOffline')
    </h5>
                ...
                <div class="form-body">
                    <div class="row" id="addressDetail">
                        <div class="col-lg-12 col-md-12">
                            <x-forms.select class="select-picker" fieldId="offlineMethod" :fieldLabel="__('modules.schedules.paymentMethod')"
...
<script>
    ...
    $('#save-offline-payment').click(function() {
        $.easyAjax({
            url: "{{ route('schedules.store_offline_payment') }}",
