...
class ScheduleController extends AccountBaseController
{
    ...
    {
        $this->authorizeResource(Modules\Inspection\Entities\Schedule::class, 'schedule');
        parent::__construct();
    ...
    public function index(SchedulesDataTable $dataTable)
    {
        ...
        return $dataTable->render('siteinspection::schedules.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        if (request()->ajax()) {
            $html = view('siteinspection::schedules.ajax.create', $this->data)->render();

            return Reply::dataOnly(['status' => 'success', 'html' => $html, 'title' => $this->pageTitle]);
        }

        $this->view = 'siteinspection::schedules.ajax.create';

        return view('siteinspection::schedules.create', $this->data);
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            $html = view('siteinspection::schedules.ajax.edit', $this->data)->render();

            return Reply::dataOnly(['status' => 'success', 'html' => $html, 'title' => $this->pageTitle]);
        }

        $this->view = 'siteinspection::schedules.ajax.edit';
    ...
    public function update(UpdateSchedule $request, $id)
    {
        ...
        $redirectUrl = route('schedules.index');
        return Reply::successWithData(__('siteinspection::messages.updateReceive'), ['redirectUrl' => $redirectUrl]);
    }
    ...
    public function show($id)
    {
        ...
        return view('siteinspection::schedules.show', $this->data);
    ...
    public function domPdfObjectForDownload($id)
    {
        ...
        $pdf->loadView('schedules.pdf.' . $this->scheduleSetting->template, $this->data);
    ...
    public function domPdfObjectForConsoleDownload($id)
    {
        ...
        $pdf->loadView('schedules.pdf.schedule-recurring', $this->data);
