...
class RecurringScheduleController extends AccountBaseController
{
    ...
    {
        $this->authorizeResource(Modules\Inspection\Entities\RecurringSchedule::class, 'recurring_schedule');
        parent::__construct();
        $this->pageTitle = 'Recurring Schedules Inspection';
        $this->middleware(function ($request, $next) {
            abort_403(!in_array('inspection', $this->user->modules));
    ...
    public function index(ScheduleRecurringDataTable $dataTable)
    {
        ...
        return $dataTable->render('siteinspection::recurring-schedules.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        $this->view = 'siteinspection::recurring-schedules.ajax.create';
        ...
        return view('siteinspection::recurring-schedules.create', $this->data);
    }
    ...
    public function store(StoreRecurringSchedule $request)
    {
        ...
        return Reply::redirect(route('recurring-schedules.index'), __('messages.recordSaved'));
    }
    ...
    public function show($id)
    {
        ...
        default:
                $this->view = 'siteinspection::recurring-schedules.ajax.overview';
                break;
        }
        ...
        return view('siteinspection::recurring-schedules.show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('siteinspection::recurring-schedules.edit', $this->data);
    }
    ...
    public function recurringSchedules(RecurringSchedulesDataTable $dataTable, $id)
    {
        ...
        return $dataTable->render('recurring-schedules.recurring-schedules', $this->data);
    }
    ...
    public function schedules($recurringID)
    {
        ...
        $this->view = 'siteinspection::recurring-schedules.ajax.schedules';

        return $dataTable->render('siteinspection::recurring-schedules.show', $this->data);
    }
