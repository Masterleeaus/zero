# META PROMPT — Integrate `fieldservice_calendar` Into Titan Zero Backend

## Objective
Add calendar-oriented backend scheduling support for service jobs and shifts.

## Mapping target
**Primary Titan domain:** service_jobs, shifts, attendance

## Copilot instructions
You are integrating the Odoo addon **fieldservice_calendar** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add date-span support, slot/all-day scheduling fields, calendar query service, route/controller methods for schedule feeds if absent.
...
## Avoid
Do not build a separate frontend calendar app.
