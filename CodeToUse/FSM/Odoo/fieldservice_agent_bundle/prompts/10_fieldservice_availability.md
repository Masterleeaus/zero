# META PROMPT — Integrate `fieldservice_availability` Into Titan Zero Backend

## Objective
Add availability constraints for jobs, routes, staff, and service windows.

## Mapping target
**Primary Titan domain:** availability rules

## Copilot instructions
You are integrating the Odoo addon **fieldservice_availability** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add blackout windows, customer preferred windows, site access windows, job window validation service integrated with leave/shift systems.
...
## Avoid
Do not replace leave or shift systems.
