# META PROMPT — Integrate `fieldservice_sale_agreement` Into Titan Zero Backend

## Objective
Join sales/quotes with agreements more tightly.

## Mapping target
**Primary Titan domain:** quote -> agreement

## Copilot instructions
You are integrating the Odoo addon **fieldservice_sale_agreement** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Enhance quote-to-agreement conversion, cross references, preserve current QuoteService patterns.
...
## Avoid
Do not create parallel contract sales flow.
