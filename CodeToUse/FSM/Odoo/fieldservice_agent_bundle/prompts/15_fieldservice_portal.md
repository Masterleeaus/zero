# META PROMPT — Integrate `fieldservice_portal` Into Titan Zero Backend

## Objective
Prepare backend data contracts for Titan Portal customer experience.

## Mapping target
**Primary Titan domain:** portal-safe resources

## Copilot instructions
You are integrating the Odoo addon **fieldservice_portal** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add customer-visible jobs, schedules, proof, invoices, preferred cleaner, issue tracking scopes/resources/endpoints.
