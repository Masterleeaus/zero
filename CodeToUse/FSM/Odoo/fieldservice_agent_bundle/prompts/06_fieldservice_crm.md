# META PROMPT — Integrate `fieldservice_crm` Into Titan Zero Backend

## Objective
Strengthen enquiry/deal/customer to site/job conversion flows.

## Mapping target
**Primary Titan domain:** crm -> ops conversion

## Copilot instructions
You are integrating the Odoo addon **fieldservice_crm** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add conversion services, missing foreign keys/state fields, actions to convert enquiry/deal into customer/site/service_job/quote.
