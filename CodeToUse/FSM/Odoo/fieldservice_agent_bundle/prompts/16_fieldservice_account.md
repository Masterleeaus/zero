# META PROMPT — Integrate `fieldservice_account` Into Titan Zero Backend

## Objective
Strengthen accounting links around service jobs.

## Mapping target
**Primary Titan domain:** jobs -> invoices/payments

## Copilot instructions
You are integrating the Odoo addon **fieldservice_account** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add traceability between jobs and invoices/payment records, job cost/revenue helpers, accounting event hooks if useful.
