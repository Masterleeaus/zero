# META PROMPT — Integrate `fieldservice_timesheet` Into Titan Zero Backend

## Objective
Deepen time tracking beyond current timelogs.

## Mapping target
**Primary Titan domain:** timelogs / timesheets

## Copilot instructions
You are integrating the Odoo addon **fieldservice_timesheet** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Enrich timelogs with billable/non-billable, travel/on-site, approval state, job labor totals, weekly aggregation helpers.
...
## Avoid
Do not create a second time system.
