# META PROMPT — Integrate `fieldservice_skill` Into Titan Zero Backend

## Objective
Add cleaner skill matching for job assignment.

## Mapping target
**Primary Titan domain:** skills matrix

## Copilot instructions
You are integrating the Odoo addon **fieldservice_skill** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add skill tables and pivots, job required skills, eligible assignee query scopes, assignment validation and recommendation helpers.
