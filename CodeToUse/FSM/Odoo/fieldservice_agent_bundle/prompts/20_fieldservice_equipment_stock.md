# META PROMPT — Integrate `fieldservice_equipment_stock` Into Titan Zero Backend

## Objective
Track service equipment allocated to stock, teams, sites, and jobs.

## Mapping target
**Primary Titan domain:** equipment assets

## Copilot instructions
You are integrating the Odoo addon **fieldservice_equipment_stock** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add equipment models/tables, stock linkage, assignment to vehicle/team/site/job, lifecycle status and notes.
...
## Avoid
Do not overlap badly with existing assets; merge if found.
