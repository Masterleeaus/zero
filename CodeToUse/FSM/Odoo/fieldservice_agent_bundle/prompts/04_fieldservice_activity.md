# META PROMPT — Integrate `fieldservice_activity` Into Titan Zero Backend

## Objective
Add structured activities and follow-ups linked to service jobs, sites, customers, and issues.

## Mapping target
**Primary Titan domain:** activities

## Copilot instructions
You are integrating the Odoo addon **fieldservice_activity** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add due dates, assignee, completion state, timeline feed support, polymorphic or explicit relations.
...
## Avoid
Do not duplicate checklist logic.
