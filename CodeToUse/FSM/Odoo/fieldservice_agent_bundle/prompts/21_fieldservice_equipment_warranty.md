# META PROMPT — Integrate `fieldservice_equipment_warranty` Into Titan Zero Backend

## Objective
Add warranty and coverage metadata to tracked equipment.

## Mapping target
**Primary Titan domain:** equipment warranty

## Copilot instructions
You are integrating the Odoo addon **fieldservice_equipment_warranty** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add warranty fields, coverage dates, supplier references, reminder helpers, relation to repair workflows.
...
## Avoid
Do not turn this into customer warranty logic unless tied to equipment.
