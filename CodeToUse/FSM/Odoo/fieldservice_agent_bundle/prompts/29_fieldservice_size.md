# META PROMPT — Integrate `fieldservice_size` Into Titan Zero Backend

## Objective
Add size/measurement concepts useful for quoting and job planning.

## Mapping target
**Primary Titan domain:** size / units

## Copilot instructions
You are integrating the Odoo addon **fieldservice_size** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add size/unit fields for Site, Quote, ServiceJob; estimators and filters flexible for cleaning vertical.
...
## Avoid
Do not import full generic UOM complexity.
