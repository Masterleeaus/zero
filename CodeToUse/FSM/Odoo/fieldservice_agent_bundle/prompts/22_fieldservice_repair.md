# META PROMPT — Integrate `fieldservice_repair` Into Titan Zero Backend

## Objective
Add equipment/service repair workflows where field operations need them.

## Mapping target
**Primary Titan domain:** repairs

## Copilot instructions
You are integrating the Odoo addon **fieldservice_repair** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add repair request/order model if needed, relation to equipment/site/service_issue, statuses, diagnosis, resolution notes, parts used.
...
## Avoid
Do not turn this into manufacturing repair.
