# META PROMPT — Integrate `fieldservice_sale_recurring` Into Titan Zero Backend

## Objective
Improve recurring sales/service package handling.

## Mapping target
**Primary Titan domain:** recurring commercial metadata

## Copilot instructions
You are integrating the Odoo addon **fieldservice_sale_recurring** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add recurring quote/package metadata and helpers, link into AgreementSchedulerService.
...
## Avoid
Do not create a subscription billing engine from scratch.
