# META PROMPT — Integrate `fieldservice_sale_agreement_equipment_stock` Into Titan Zero Backend

## Objective
Connect agreements, sold services, and allocated equipment/stock.

## Mapping target
**Primary Titan domain:** agreement equipment bridge

## Copilot instructions
You are integrating the Odoo addon **fieldservice_sale_agreement_equipment_stock** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add bridge records/rollups where operationally useful, agreement-linked equipment/material defaults.
...
## Avoid
Do not overcomplicate agreement domain.
