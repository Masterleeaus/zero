# META PROMPT — Integrate `fieldservice_agreement` Into Titan Zero Backend

## Objective
Deepen agreement/contract layer for recurring or contracted service work.

## Mapping target
**Primary Titan domain:** service_agreements

## Copilot instructions
You are integrating the Odoo addon **fieldservice_agreement** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Extend agreements with terms, billing cadence, SLA notes, inclusions/exclusions, renewal/suspension/expiry logic.
...
## Avoid
Do not replace current agreements.
