# META PROMPT — Integrate `fieldservice_sale_stock` Into Titan Zero Backend

## Objective
Connect sold work to stock/material consumption.

## Mapping target
**Primary Titan domain:** sales-stock bridge

## Copilot instructions
You are integrating the Odoo addon **fieldservice_sale_stock** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add minimal stock-sales bridge for service jobs, cost rollups, and consumption references.
...
## Avoid
Do not build full warehouse complexity.
