# META PROMPT — Integrate `fieldservice_sale` Into Titan Zero Backend

## Objective
Improve quote/sales linkage to operational delivery.

## Mapping target
**Primary Titan domain:** quote -> job flow

## Copilot instructions
You are integrating the Odoo addon **fieldservice_sale** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Improve conversion services, quote line to job scope linkage, accepted quote -> job package generation.
...
## Avoid
Do not create duplicate sales order domain.
