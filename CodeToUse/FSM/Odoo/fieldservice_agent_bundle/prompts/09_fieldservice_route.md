# META PROMPT — Integrate `fieldservice_route` Into Titan Zero Backend

## Objective
Add route/day-run planning backend for dispatch.

## Mapping target
**Primary Titan domain:** route plans

## Copilot instructions
You are integrating the Odoo addon **fieldservice_route** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add route/day entity or plan tables, ordered stop sequence, travel and duration estimates, assignment of jobs to route runs, planning service layer.
...
## Avoid
Do not rewrite TitanCommand in this pass.
