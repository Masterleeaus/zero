# META PROMPT — Integrate `fieldservice_project` Into Titan Zero Backend

## Objective
Allow grouped multi-job projects/work packages above service jobs where useful.

## Mapping target
**Primary Titan domain:** work_package / project

## Copilot instructions
You are integrating the Odoo addon **fieldservice_project** into the existing **zero-main** Titan Zero Laravel repo as a **backend overlay**, not a new subsystem.
...
Add optional parent grouping entity, relation from service jobs to package/project, aggregate status/progress helpers.
...
## Avoid
Do not force all jobs into projects.
