  ...
  <script>
    const pageData = {
      urls: {
        ...
        warehousesStore: @json(route('wmsinventorycore.warehouses.store'))
      }
    };
  </script>
    ...
    <div class="card mb-4">
      ...
      <div class="card-body">
        <form id="warehouseForm" action="#" method="POST">
          ...
          <div class="mt-4">
            <button type="submit" class="btn btn-primary me-2">{{ __('Create Warehouse') }}</button>
