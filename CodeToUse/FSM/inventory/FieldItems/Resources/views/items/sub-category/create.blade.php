@php
    $deleteItemSubCategoryPermission = user()->permission('manage_item_sub_category');
@endphp

<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('fielditems::modules.itemCategory.itemSubCategory')</h5>
...
<div class="modal-body">
    <x-table class="table-bordered" headType="thead-light">
        <x-slot name="thead">
            <th>#</th>
            <th>@lang('fielditems::modules.itemCategory.category')</th>
            <th>@lang('fielditems::modules.itemCategory.subCategory')</th>
        ...
        @forelse($subcategories as $key => $subcategory)
            <tr id="cat-{{ $subcategory->id }}">
                ...
                <td class="text-right">
                    @if ($deleteItemSubCategoryPermission == 'all' || ($deleteItemSubCategoryPermission == 'added' && $subcategory->added_by == user()->id))
    ...
    <x-form id="createProjectCategory">
        <div class="row border-top-grey ">
            ...
            <div class="col-sm-12 col-md-6">
                <x-forms.text fieldId="category_name" :fieldLabel="__('fielditems::modules.itemCategory.itemSubCategory')"
...
<script>
    ...
    $('.delete-category').click(function () {
        ...
        let url = "{{ route('itemSubCategory.destroy', ':id') }}";
    ...
    $('#save-category').click(function () {
        var url = "{{ route('itemSubCategory.store') }}";
        $.easyAjax({
            url: url,
    ...
    $('[contenteditable=true]').focus(function () {
        ...
        if ($(this).data("initialText") !== $(this).html()) {
            ...
            let url = "{{ route('itemSubCategory.update', ':id') }}";
            url = url.replace(':id', id);
