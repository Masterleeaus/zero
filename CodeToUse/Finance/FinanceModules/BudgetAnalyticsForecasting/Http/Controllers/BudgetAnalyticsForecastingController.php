...
class BudgetUtilsModuleController extends AccountBaseController
{
    ...
    public function index(BudgetUtilsDataTable $dataTable)
    {
        ...
        return $dataTable->render('budgetanalyticsforecasting::index', $this->data);
    }
    ...
    public function create()
    {
        ...
        $this->view = 'budgetanalyticsforecasting::ajax.create';

        if (request()->ajax()) {
            return $this->returnAjax($this->view);
        }

        return view('budgetanalyticsforecasting::create', $this->data);
    }
    ...
    public function show($id)
    {
        ...
        $this->view = 'budgetanalyticsforecasting::ajax.show';
        if (request()->ajax()) {
            return $this->returnAjax($this->view);
        }

        return view('budgetanalyticsforecasting::show', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            return $this->returnAjax('budgetanalyticsforecasting::ajax.edit');
        }

        return view('budgetanalyticsforecasting::edit', $this->data);
    }
