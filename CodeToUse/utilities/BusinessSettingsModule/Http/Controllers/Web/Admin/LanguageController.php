...
class LanguageController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $langFile = $fp = fopen(base_path('resources/lang/' . $request['code'] . '/' . 'lang.php'), "w");
        if ($fp === false) {
            \Illuminate\Support\Facades\Log::error('BusinessSettingsModule: Unable to open file for writing', ['path' => base_path('resources/lang/' . $request['code'] . '/' . 'lang.php'), "w"]);
...
use Illuminate\Support\Facades\Log; return " . var_export($fullData, true) . ";";
...
use Illuminate\Support\Facades\Log; return " . var_export($filteredData, true) . ";";
        file_put_contents(base_path('resources/lang/' . $lang . '/lang.php'), $str);
...
use Illuminate\Support\Facades\Log; return " . var_export($data_filtered, true) . ";";
...
use Illuminate\Support\Facades\Log; return " . var_export($translated_data, true) . ";";
                file_put_contents($new_messages_path, $str);
