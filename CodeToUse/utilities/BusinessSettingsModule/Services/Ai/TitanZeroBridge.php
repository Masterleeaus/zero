...
namespace Modules\BusinessSettingsModule\Services\Ai;
...
class TitanZeroBridge
{
    ...
    public function ingestSignal(array $signal, $tenantId = null): array
    {
        try {
            ...
            Log::warning('[TitanAI] ingestSignal failed', ['module' => 'BusinessSettingsModule', 'err' => $e->getMessage()]);
    ...
    public function runAgent(string $agentSlug, array $context, $tenantId = null): ?array
    {
        try {
            ...
            Log::warning('[TitanAI] runAgent failed', ['module' => 'BusinessSettingsModule', 'agent' => $agentSlug, 'err' => $e->getMessage()]);
            return null;
        }
    }
