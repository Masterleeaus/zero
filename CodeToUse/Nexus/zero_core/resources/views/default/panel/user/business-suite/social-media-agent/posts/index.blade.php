                ...
                @foreach ($platforms as $platform)
                    ...
                    >
                        ...
                        <p class="mb-0 text-sm font-medium">
                            {{ Str::headline($platform->platform) }}
                        </p>
                            ...
                            @if (filled($platformEnums))
                                @foreach ($platformEnums as $platform)
                                    <button
                                        ...
                                        :class="{ active: filters.platform == '{{ $platform->name }}' }"
                                        @click.prevent="filterPosts({platform: '{{ $platform->name }}'}); selectedPlatformLabel = '{{ Str::headline($platform->name) }}';"
                                    >
                                        {{ Str::headline($platform->name) }}
                                    </button>
                                @endforeach
                            @endif
                        </div>
