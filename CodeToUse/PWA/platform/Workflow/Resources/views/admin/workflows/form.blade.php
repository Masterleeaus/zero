...
<div class="content-wrapper">
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ $mode === 'create' ? route('workflow.admin.workflows.store') : route('workflow.admin.workflows.update', $workflow->id) }}">
                @csrf
                ...
                <a class="btn btn-light" href="{{ route('workflow.admin.workflows.index') }}">{{ __('Back') }}</a>
            </form>
