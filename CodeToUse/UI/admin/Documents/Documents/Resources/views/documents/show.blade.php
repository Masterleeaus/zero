...
<div class="container">
  <div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <div class="d-flex gap-2">
      @can('documents.export')
        <a class="btn btn-outline-secondary" href="{{ route('documents.pdf.preview', $document->id) }}" target="_blank">Preview PDF</a>
        <a class="btn btn-outline-secondary" href="{{ route('documents.pdf.export', $document->id) }}">Download PDF</a>
      @endcan
  ...
  @include('documents::documents.partials.workflow.actions', ['document' => $document])

  @include('documents::documents.partials.versions.widget', ['document' => $document])

  @include('documents::documents.partials.links.widget', ['document' => $document])
  ...
  @include('documents::documents.partials.tags', ['document' => $document])
