...
You are required to contact HR department on the date you report for work as per terms of this Documents at 9:30 A.M.<br>
...
Please sign a duplicate copy of this Documents confirming your acceptance of the above terms and conditions of appointment and return it to us for office records.<br>
...
HOD;
        ...
        $joiningLetter = <<<HOD
                                       ...
                                       <p>                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><div style="text-align: center;">&nbsp;<b>Joining Documents</b></div>
<br>
...
<br>
Thank you for joining ABC Pvt. Ltd. on<b>&nbsp;<span style="font-size: 12px;">##EMPLOYEE_JOINING_DATE##</span>&nbsp;</b>and accepting the position of<b>&nbsp;<span style="font-size: 12px;">##EMPLOYEE_DESIGNATION##</span></b>. We are pleased to have you on our team. This Documents acknowledges that you have completed all the formalities for joining ##COMPANY_NAME## and have accepted the terms of job as described below:<br>
<br>
...
<p><br></p><p><div style="text-align: center;"><b>Acceptance Documents</b></div>
<br>
...
<br>
Subject: Acceptance Documents<br>
<br>
Dear&nbsp;<span style="font-size: 12px;">##SIGNATORY## </span>,<br>
<br>
I am pleased to accept your offer and I would like to inform you that I am joining the company from&nbsp;<span style="font-size: 12px;">##EMPLOYEE_JOINING_DATE##</span>&nbsp;as a<span style="font-size: 12px;">##EMPLOYEE_DESIGNATION## i</span>n respect to your appointment Documents dated XXOFFERLETTERDATEXXX As we discussed, my starting salary will be 9,000 per month. I understand and accept the conditions of employment that you explained in your appointment documents.<br>
<br>
The position is ideally suited to my educational background and interests. I confidently feel that I can make a significant contribution to your company, and I am grateful for the opportunity you have given me. I humbly request you to accept my acceptance documents.<br>
<br>
Regards,<br>
<br>
...
HOD;
        ...
        $welcomeLetter = <<<HOD
<p><br></p><p><div style="text-align: center;"><b>Welcome Documents</b></div>
<br>
...
<br>
<br>
Date:&nbsp;<span style="font-size: 12px;">##EMPLOYEE_EXIT_DATE##</span><br><div style="text-align: center;"><b>Relieving Documents &amp; Experience Certificate&nbsp;</b></div><div style="text-align: center;"><b><br></b></div>
...
<br><div style="text-align: center;"><b>Excellent Attendance Documents</b></div>
<br>
<br>
...
HOD;
        ...
        $Documents = [
            ...
            [
                'title' => 'Relieving and Experience Documents',
                'template' => $relievingLetter
            ],
            [
                'title' => 'Excellent Attendance Documents',
        ...
        foreach ($Documents as $Documents) {
            ...
            $let = Template::where('company_id', $company->id)
                ->where('title', $Documents['title'])
                ->first();

            if ($let) {
                $let->company_id = $company->id;
                $let->title = $Documents['title'];

                $let->description = $Documents['template'];
                $let->save();
                continue;
            }
