# Documents (Patched Scaffold)

This module was auto-patched to include missing Worksuite/Laravel module scaffolding.

## Added
- ServiceProvider: `Modules\Documents\Providers\LetterServiceProvider`
- `module.json` with provider registration
- Routes: `routes/web.php`, `routes/api.php`
- Config: `Config/config.php`
- Controller: `Modules\Documents\Http\Controllers\DocumentsController`
