...
class DocumentsController extends Controller
{
    ...
    public function show(Document $document)
    {
        ...
        $document->load(['files', 'sections', 'metadata']);
    ...
    public function edit(Document $document)
    {
        ...
        $document->load(['sections', 'metadata']);
    ...
    public function templates()
    {
        ...
        $templates = DocumentTemplate::where(function ($q) use ($tenantId) {
        ...
        return view('documents::documents.templates', compact('templates'));
    }
