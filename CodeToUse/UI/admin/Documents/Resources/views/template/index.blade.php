        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            ...
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if (user()->permission('add_template') != 'none')
                    <x-forms.link-primary :link="route('documents.template.create')" class="mr-3 openRightModal float-left mb-2 mb-lg-0 mb-md-0"
                        icon="plus">
                        @lang('documents::app.addTemplate')
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url = "{{ route('documents.template.destroy', ':id') }}";
