<div class="content-wrapper border-top-0 client-detail-wrapper">
    <div class="card bg-white rounded">
        <h4 class="mb-0 p-20 f-21 font-weight-normal border-bottom">
            @lang('documents::app.letterDetails')
        ...
        <div class="col-md-12 p-0 text-wrap ql-editor" id="descriptionPreviewArea"
            ...
            <div @style(['padding-top:' . $Documents->top . 'px', 'padding-bottom:' . $Documents->bottom . 'px', 'padding-left:' . $Documents->left . 'px', 'padding-right:' . $Documents->right . 'px']) id="descriptionPreview">{!! $description !!}</div>
        </div>
    </div>
</div>
...
<script>
    $(document).ready(function() {
        $('#downloadButton').on('click', function() {
            window.location.href = "{{ route('documents.download', $Documents->id) }}";
        });
