...
namespace Modules\Kontrak\Observers;
...
class RecurringKontrakObserver
{
    public function creating(RecurringKontrak $schedule)
    {
        if (company()) {
    ...
    public function deleting(RecurringKontrak $schedule)
    {
