        ...
        <div class="d-flex justify-content-between action-bar">
            ...
            <div id="table-actions" class="d-flex align-items-center">
                @if ($addContractPermission == 'all' || $addContractPermission == 'added')
                    <x-forms.link-primary :link="route('kontrak.create')" class="mr-3 openRightModal" icon="plus">
                        @lang('app.add') @lang('kontrak::modules.recContract')
    ...
    <script>
        ...
        $('body').on('click', '.delete-schedule', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('kontrak.destroy', ':id') }}";
        ...
        const applyQuickAction = () => {
            var rowdIds = $("#schedules-recurring-table input:checkbox:checked").map(function() {
                return $(this).val();
            }).get();

            var url = "{{ route('kontrak.apply_quick_action') }}?row_ids=" + rowdIds;
