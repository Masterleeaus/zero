        ...
        <tbody>
                ...
                <td align="right" class="f-21 text-black font-weight-700 text-uppercase">@lang('Form Izin Keluar / Masuk Barang')<br>
                    <table class="text-black mt-1 f-13 b-collapse rightaligned">
                        ...
                        <tr>
                            ...
                            <td class="heading-table-right">{{ ucwords($tenancy->pj) }}</td>
                        </tr>
                        <tr>
                            <td class="heading-table-left">@lang('No Handphone')</td>
                            <td class="heading-table-right">{{ ucwords($tenancy->no_hp) }}</td>
                        </tr>
                        <tr>
                            <td class="heading-table-left">@lang('Pembawa Barang')</td>
                            <td class="heading-table-right">{{ ucwords($tenancy->pembawa_brg) }}</td>
                        </tr>
                    </table>
                </td>
            </tr>
            <tr>
                ...
                <td class="f-14 text-black" width="82%">
                    <p class="line-height mb-0">
                        <span class="text-black text-capitalize">: {{ $tenancy->name }}</span>
                    </p>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td class="f-14 text-black" width="82%">
                    <p class="line-height mb-0">
                        <span class="text-black text-capitalize">: {{ ucwords(str_replace('-', ' ', $tenancy->keterangan)) }}</span>
                    </p>
                </td>
            </tr>
            <tr>
                ...
                <td class="f-14 text-black" width="82%">
                    <p class="line-height mb-0">
                        <span class="text-black text-capitalize">: {{ ucwords($tenancy->jenis_barang) }}</span>
                    </p>
                </td>
            </tr>
            <!-- Table Row End -->
