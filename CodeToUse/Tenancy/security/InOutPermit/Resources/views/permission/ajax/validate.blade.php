        ...
        <x-form id="save-lead-data-form">
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    @lang('trinoutpermit::app.trinoutpermit.validateTrInOutPermit')</h4>
                <div class="row p-20">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-3">
                        <x-forms.label class="mt-3" fieldId="parent_label" :fieldLabel="__('trinoutpermit::app.menu.penanggungJawab')" fieldName="parent_label">
                        </x-forms.label>
                    ...
                    <div class="col-md-3">
                        <x-forms.label class="mt-3" fieldId="parent_label" :fieldLabel="__('trinoutpermit::app.menu.resident')" fieldName="parent_label">
                        </x-forms.label>
                        <input type="text"  class="form-control height-35 rounded p-0 text-left f-15"
                    ...
                    <div class="col-md-3">
                        <x-forms.label class="mt-3" fieldId="parent_label" :fieldLabel="__('trinoutpermit::app.menu.keterangan')"
                    ...
                    <div class="col-md-3">
                        <x-forms.label class="my-3" fieldId="description-text" :fieldLabel="__('trinoutpermit::app.menu.jenisBarang')"
                            fieldRequired="true">
                        </x-forms.label>
                        <div>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-leave-form').click(function() {
            const url = "{{ route('trinoutpermit.validated', $tenancy->id) }}";
            $.easyAjax({
                url: url,
