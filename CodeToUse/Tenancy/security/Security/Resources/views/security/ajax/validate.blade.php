        ...
        <x-form id="save-lead-data-form">
            <div class="add-client bg-white rounded">
                <h4 class="mb-0 p-20 f-21 font-weight-normal text-capitalize border-bottom-grey">
                    @lang('security::app.menu.validateTransfer')</h4>
                <div class="row p-20">
                    <div class="col-md-2">
                    ...
                    <div class="col-md-3">
                        <x-forms.label class="mt-3" fieldId="parent_label" :fieldLabel="__('security::app.menu.keterangan')"
...
<script>
    $(document).ready(function() {
        ...
        $('#save-leave-form').click(function() {
            const url = "{{ route('security.validated', $security->id) }}";
            $.easyAjax({
                url: url,
