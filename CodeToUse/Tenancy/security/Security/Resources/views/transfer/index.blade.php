...
@php
    $addUnitPermission = user()->permission('add_security');
@endphp
...
@section('filter-section')
    <x-filters.filter-box>
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            <p class="mb-0 pr-2 f-14 text-dark-grey d-flex align-items-center">@lang('security::app.menu.statusValidasi')</p>
            <div class="select-status">
                <select class="form-control select-picker" name="status_validate" id="status_validate">
                    ...
                    <option value="approve">@lang('app.yes')</option>
                    <option value="notApprove">@lang('app.no')</option>
                </select>
            </div>
        </div>
        <!-- STATUS VALIDATE END -->
        ...
        <x-filters.more-filter-box>
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 text-capitalize" for="usr">@lang('security::app.menu.keterangan')</label>
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('security-transfer.destroy', ':id') }}";
