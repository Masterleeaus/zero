...
@section('filter-section')
    <x-filters.filter-box>
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            <p class="mb-0 pr-2 f-14 text-dark-grey d-flex align-items-center">@lang('app.statusApprove')</p>
            <div class="select-status">
                <select class="form-control select-picker" name="status_approve" id="status_approve">
                    ...
                    <option value="approve">@lang('app.approve')</option>
                    <option value="notApprove">@lang('app.notApprove')</option>
                </select>
            </div>
        </div>
        <!-- STATUS APPROVAL END -->
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            <p class="mb-0 pr-2 f-14 text-dark-grey d-flex align-items-center">@lang('app.statusValidate')</p>
            <div class="select-status">
