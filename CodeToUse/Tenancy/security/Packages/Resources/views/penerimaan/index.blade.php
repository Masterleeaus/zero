...
@php
    $addUnitPermission = user()->permission('add_package');
@endphp
...
@section('filter-section')
    <x-filters.filter-box>
        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            <p class="mb-0 pr-2 f-14 text-dark-grey d-flex align-items-center">@lang('Status Package')</p>
        ...
        <div class="d-block d-lg-flex d-md-flex justify-content-between action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if ($addUnitPermission == 'all' || $addUnitPermission == 'added')
                    <x-forms.link-primary :link="route('receive.create')" class="mr-3 openRightModal float-left" icon="plus">
                        @lang('trpackage::app.receive.addReceive')
...
@push('scripts')
    ...
    <script>
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('receive.destroy', ':id') }}";
        ...
        const applyQuickAction = () => {
            ...
            const url = "{{ route('receive.apply_quick_action') }}?row_ids=" + rowdIds;
