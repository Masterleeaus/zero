...
@section('title', 'Edit Evidence Rule')

@section('content')
<div class="container py-3">
    <div class="d-flex justify-content-between align-items-center mb-3">
        <h3 class="mb-0">Edit Rule #{{ $rule->id }}</h3>
    ...
    <div class="card">
        <div class="card-body">
            <form method="POST" action="{{ route('dashboard.user.titan-trust.rules.update', $rule->id) }}">
                @csrf
                @method('PUT')
<div class="row g-3">
    <div class="col-md-4">
    ...
    <div class="col-md-3">
        ...
        <input type="number" min="0" max="100" name="req_signoff" class="form-control" value="{{ old('req_signoff', $rule->required['signoff'] ?? 0) }}">
                ...
                <div class="mt-4 d-flex gap-2">
                    ...
                    <a class="btn btn-outline-secondary" href="{{ route('dashboard.user.titan-trust.rules.index') }}">Cancel</a>
                </div>
            </form>
        </div>
    </div>
