...
>
    @include('titantrust::editor.editor-toolbar', ['tools' => $tools, 'primary_tool_keys' => $primary_tool_keys])
    @include('titantrust::editor.editor-canvas')
    @include('titantrust::editor.editor-sidebar', ['tools' => $tools])
