...
class _AddressScreenState extends State<AddressScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: widget.fromPage == 'checkout' ? 'my_address'.tr : 'my_properties'.tr),
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            CustomButton(
                              width: 200,
                              buttonText: widget.fromPage == 'checkout' ? 'add_new_address'.tr : 'add_property'.tr,
        ...
        child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Text(widget.fromPage == 'checkout' ? 'add_new_address'.tr : 'add_property'.tr, style: robotoMedium.copyWith(
