    ...
    >
        ...
        >
            ...
            <div class="mb-11 flex flex-col items-center justify-between gap-4 lg:flex-row">
                ...
                <div class="flex w-full grow flex-wrap items-center gap-3 lg:w-auto lg:justify-end">
                    ...
                    <button
                        ...
                        x-text="selectedItems.length === images.length && images.length > 0 ? '{{ __('Deselect all') }}' : '{{ __('Select all') }}'"
                    >
                    </button>
            ...
            <x-empty-state
                ...
                show="!loading && images.length === 0 && filter === 'bookmarks'"
                x-cloak
            />
            ...
            <x-empty-state
                ...
                show="!loading && images.length === 0 && filter === 'assets' && searchQuery"
                x-cloak
            />
                        ...
                        >
                            ...
                            >
                                <div
                                    ...
                                    :data-id="`media-library-${image.id}`"
            ...
            <div
                ...
                x-show="hasMore && images.length > 0"
                x-cloak
