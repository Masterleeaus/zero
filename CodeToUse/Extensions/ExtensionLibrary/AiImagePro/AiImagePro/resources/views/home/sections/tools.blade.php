                ...
                <div class="snap-start max-sm:w-1/2 max-sm:shrink-0 max-sm:grow-0 max-sm:basis-auto">
                    ...
                    >
                        ...
                        <a
                            ...
                            @click.prevent="Alpine.$data(document.getElementById('image-editor-modal')).modalOpen = true;"
                        ></a>
                    </div>
                ...
                <div class="snap-start max-sm:w-1/2 max-sm:shrink-0 max-sm:grow-0 max-sm:basis-auto">
                    ...
                    >
                        ...
                        <a
                            ...
                            @click.prevent="Alpine.$data(document.getElementById('marketing-modal')).modalOpen = true;"
                        ></a>
                    </div>
            ...
            >
                ...
                >
                    ...
                    <a
                        ...
                        data-depth="1.5"
                        href="#tools-modal"
                        @click.prevent="Alpine.$data(document.getElementById('tools-modal')).modalOpen = true;"
                    ></a>
                </div>
            ...
            <div class="snap-start max-sm:w-1/2 max-sm:shrink-0 max-sm:grow-0 max-sm:basis-auto">
                ...
                >
                    ...
                    <a
                        ...
                        @click.prevent="Alpine.$data(document.getElementById('social-media-modal')).modalOpen = true;"
                    ></a>
                </div>
            ...
            Alpine.data('toolsTemplates', (templatesListUrl) => ({
                ...
                openTemplate(template) {
                    ...
                    template.data.inputs.forEach(input => {
                        if (input.type === 'select') {
                            const defaultOption = input.options.find(opt => opt.selected);
                            this.formData[input.key] = defaultOption?.value || '';
                        } else {
                            this.formData[input.key] = '';
                        }
                    });
                },
                ...
                handleSubmit() {
                    ...
                    this.selectedTemplate?.data.inputs.forEach(input => {
                        if (input.required && !this.formData[input.key]) {
                    ...
                    this.selectedTemplate.data.inputs.forEach(input => {
                        if (input.type === 'file') {
                            ...
                            const value = this.formData[input.key];
                    ...
                    fetch('/ai-image-pro/tools/generate', {
                        ...
                        .then(data => {
                            if (data.success) {
                                ...
                                // Dispatch event to notify navbar about new generation
                                ...
                                // Close all modals - find and close the template modal first
                                document.querySelectorAll('.lqd-modal').forEach(modal => {
                                    const modalData = Alpine.$data(modal);
                                    if (modalData && modalData.modalOpen === true) {
