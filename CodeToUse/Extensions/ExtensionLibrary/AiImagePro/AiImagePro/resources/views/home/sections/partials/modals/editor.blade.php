<div class="lqd-adv-editor-enhance-grid grid grid-cols-1 gap-x-5 gap-y-7 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5">
    @foreach ($tools as $tool)
        <div
            class="lqd-adv-editor-enhance-grid-item group/item relative"
