    ...
    >
        ...
        >
            ...
            <x-forms.input
                ...
                x-show="getPromptInput()"
                ::id="getPromptInput().name"
                ::name="getPromptInput().name"
                type="textarea"
                ::required="getPromptInput().required"
                rows="3"
                ::placeholder="getPromptInput().placeholder || '{{ __('Describe your idea') }}'"
                x-model="formValues[getPromptInput().name]"
