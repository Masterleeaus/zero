...
@section('content')
    ...
    >
        {{-- Top Navbar --}}
        <header
            class="lqd-img-editor-header fixed inset-x-[var(--body-padding,0px)] top-[calc(var(--body-padding,var(--navbar-height,0px)))+var(--header-height,var(--header-h,0px))] z-10 flex h-[--navbar-height] items-center justify-between gap-1 px-3 py-2 sm:px-4 sm:py-4 md:px-6 lg:top-[var(--body-padding,0px)] lg:ps-[--sidebar-w]"
        >
            <div class="flex items-center gap-1">
                ...
                <div
                    ...
                    :class="{ 'max-sm:absolute max-sm:start-3 max-sm:top-full max-sm:z-20 max-sm:-mt-1': selectedTab === 'smart_edit' }"
                    x-show="currentImage"
                    x-cloak
                    x-data="{ open: false }"
            ...
            <div class="flex items-center justify-end gap-1">
                ...
                <div
                    class="flex items-center gap-0.5 rounded-full bg-surface-background/90 px-1.5 py-1 text-2xs font-medium shadow-sm backdrop-blur-sm md:gap-1"
