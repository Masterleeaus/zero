...
>
    <div class="relative">
        <figure>
            <img
                ...
                src="{{ asset('vendor/social-media-agent/images/img-1.png') }}"
                width="571"
                height="572"
            >
        </figure>
        <figure class="absolute start-10 top-16">
            <img
                ...
                src="{{ asset('vendor/social-media-agent/images/img-2.png') }}"
                width="162"
                height="209"
            >
        </figure>
    ...
    <h2 class="mb-7 text-[21px] font-medium leading-[1.2em]">
        @lang('<span class="opacity-50">Hey 👋. I’m your Service Ops Agent. From intake to delivery, I help you create, schedule, and</span> optimize service work with intelligent performance insights.')
    </h2>
    ...
    <p class="text-[12px]">
        ...
        <a
            ...
            href="#"
        >
            @lang('Learn more about Service Ops Agent')
        </a>
    </p>
</div>
