...
import 'package:demandium/feature/support/issue_report_screen.dart';
...
class RouteHelper {
  ...
  static String getReportIssueRoute({String? bookingId}) => '$reportIssue?bookingId=${bookingId ?? ''}';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(name: notification, page: () => getRoute(const NotificationScreen())),
      ...
      GetPage(name: reportIssue, page: () => IssueReportScreen(bookingId: Get.parameters['bookingId']?.isNotEmpty == true ? Get.parameters['bookingId'] : null)),
