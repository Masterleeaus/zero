        ...
        document.addEventListener('alpine:init', () => {
            Alpine.data('externalChatbot', (isEditor = false) => ({
                ...
                sendPromptMessage(prompt) {
                    ...
                    // Just prefill the input with the prompt coming from external widget
                    // and trigger the input event so any bindings update.
                    // Do NOT auto-send the message; wait for the user to submit manually.
                ...
                async onFileSelect(event) {
                    ...
                    @else
                        ...
                        const isLiveAgent = conversation?.connect_agent_at != null;

                        if (isLiveAgent) {
                            // Live Agent mode: upload immediately (existing behavior)
                            ...
                            // AI mode: stage the image for sending with the message
                            const file = files[0];
