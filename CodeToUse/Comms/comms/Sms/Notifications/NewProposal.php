...
class NewProposal extends Notification implements ShouldQueue
{
    ...
    public function __construct(Proposal $proposal)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'new-proposal')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.proposal.subject')."\n".__('email.proposal.text');
