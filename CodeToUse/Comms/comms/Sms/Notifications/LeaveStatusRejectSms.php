...
class LeaveStatusRejectSms extends Notification implements ShouldQueue
{
    ...
    public function __construct(Leave $leave)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'leave-rejected')->where('company_id', $this->company->id)->first();
