...
class NewPayment extends Notification implements ShouldQueue
{
    ...
    public function __construct(Payment $payment)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'new-payment')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.payment.subject')."\n".__('email.payment.text');
