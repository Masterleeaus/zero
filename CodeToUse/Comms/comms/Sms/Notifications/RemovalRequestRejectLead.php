...
class RemovalRequestRejectLead extends Notification implements ShouldQueue
{
    ...
    public function __construct(Lead $lead)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'removal-request-reject-lead')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.removalRequestRejectedLead.subject')."\n".__('email.removalRequestRejectedLead.text');
