...
class RemovalRequestReject extends Notification implements ShouldQueue
{
    ...
    public function __construct(User $user)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'removal-request-reject')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.removalRequestReject.subject')."\n".__('email.removalRequestReject.text');
