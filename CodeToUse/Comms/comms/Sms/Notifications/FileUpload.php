...
class FileUpload extends Notification implements ShouldQueue
{
    ...
    public function toTwilio($notifiable)
    {
        $this->toWhatsapp(
            ...
            $notifiable,
            __($this->smsSetting->slug->translationString(), ['projectName' => $this->project->project_name, 'fileName' => $this->file->filename, 'date' => $this->file->created_at->format($this->company->date_format)]),
            ['1' => $this->project->project_name, '2' => $this->file->filename, '3' => $this->file->created_at->format($this->company->date_format)]
        );
