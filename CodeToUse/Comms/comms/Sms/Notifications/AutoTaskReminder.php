...
class AutoTaskReminder extends Notification implements ShouldQueue
{
    ...
    public function toTwilio($notifiable)
    {
        ...
        $this->toWhatsapp(
            ...
            $notifiable,
            __($this->smsSetting->slug->translationString(), ['taskId' => $this->task->id, 'heading' => $this->task->heading, 'dueDate' => $this->dueDate]),
            ['1' => $this->task->id, '2' => $this->task->heading, '3' => $this->dueDate]
        );
