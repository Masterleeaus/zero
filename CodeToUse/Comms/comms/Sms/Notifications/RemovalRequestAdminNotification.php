...
class RemovalRequestAdminNotification extends Notification implements ShouldQueue
{
    ...
    public function __construct(Company $company)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'removal-request-admin-notification')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.removalRequestAdmin.subject')."\n".__('email.removalRequestAdmin.text');
