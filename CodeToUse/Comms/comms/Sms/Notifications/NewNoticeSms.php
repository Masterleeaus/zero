...
class NewNoticeSms extends Notification implements ShouldQueue
{
    ...
    public function __construct(Notice $notice)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'new-notice-published')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.newNotice.subject')."\n".($this->notice->heading);
    ...
    public function toTelegram($notifiable)
    {
        ...
        return TelegramMessage::create()
            ...
            // Markdown supported.
            ->content($this->message)
            ->button(__('app.view'), route('notices.show', $this->notice->id));
    }
}
