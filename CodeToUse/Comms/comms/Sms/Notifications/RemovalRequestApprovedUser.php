...
class RemovalRequestApprovedUser extends Notification implements ShouldQueue
{
    ...
    public function __construct(User $user)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'removal-request-approved-user')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.removalRequestApprovedUser.subject')."\n".__('email.removalRequestApprovedUser.text');
