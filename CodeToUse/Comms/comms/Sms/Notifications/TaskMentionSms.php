...
class TaskMentionSms extends Notification implements ShouldQueue
{
    ...
    public function __construct(Task $task)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'task-mention-notification')->where('company_id', $this->company->id)->first();
