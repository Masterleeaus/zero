...
class RemovalRequestRejectUser extends Notification implements ShouldQueue
{
    ...
    public function __construct(User $user)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'removal-request-reject-user')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.removalRequestRejectedUser.subject')."\n".__('email.removalRequestRejectedUser.text');
