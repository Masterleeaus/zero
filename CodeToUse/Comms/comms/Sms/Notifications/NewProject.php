...
class NewProject extends Notification implements ShouldQueue
{
    ...
    public function __construct(Project $project)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'new-project')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.newProject.text').' - '.($this->project->project_name).'. '."\n".__('email.newProject.loginNow');
