...
class AttendanceReminder extends Notification implements ShouldQueue
{
    ...
    {
        $this->smsSetting = SmsNotificationSetting::where('slug', 'attendance-reminder')->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.AttendanceReminder.text');
    ...
    public function toTelegram($notifiable)
    {
        return TelegramMessage::create()
            ...
            // Markdown supported.
            ->content($this->message)
            ->button(__('email.AttendanceReminder.action'), route('dashboard'));
    }
}
