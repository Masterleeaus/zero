...
class RemovalRequestApprovedLead extends Notification implements ShouldQueue
{
    ...
    public function __construct(Lead $lead)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'removal-request-approved-lead')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.removalRequestApprovedLead.subject')."\n".__('email.removalRequestApprovedLead.text');
