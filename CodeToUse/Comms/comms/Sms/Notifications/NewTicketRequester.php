...
class NewTicketRequester extends Notification implements ShouldQueue
{
    ...
    public function __construct(Ticket $ticket)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'new-ticket-request')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.newTicketRequester.text');
