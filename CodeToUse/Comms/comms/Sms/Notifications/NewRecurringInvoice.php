...
class NewRecurringInvoice extends Notification implements ShouldQueue
{
    ...
    public function __construct(RecurringInvoice $invoice)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'new-recurring-invoice')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.newInvoiceRecurring.smsText');
    ...
    public function toTelegram($notifiable)
    {
        ...
        return TelegramMessage::create()
            ...
            // Markdown supported.
            ->content($this->message)
            ->button(__('email.newInvoiceRecurring.action'), route('recurring-invoices.show', $this->invoice->id));
    }
}
