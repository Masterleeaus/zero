...
class RemovalRequestApproved extends Notification implements ShouldQueue
{
    ...
    public function __construct(User $user)
    {
        ...
        $this->smsSetting = SmsNotificationSetting::where('slug', 'removal-request-approved')->where('company_id', $this->company->id)->first();
    ...
    public function via($notifiable)
    {
        ...
        $this->message = __('email.removalRequestApproved.subject')."\n".__('email.removalRequestApproved.text');
