...
class TitanZeroBridge
{
    ...
    public function ingestSignal(array $signal, $tenantId = null): array
    {
        try {
            ...
            Log::warning('[TitanAI] ingestSignal failed', ['module' => 'Communication', 'err' => $e->getMessage()]);
    ...
    public function runAgent(string $agentSlug, array $context, $tenantId = null): ?array
    {
        try {
            ...
            Log::warning('[TitanAI] runAgent failed', ['module' => 'Communication', 'agent' => $agentSlug, 'err' => $e->getMessage()]);
            return null;
        }
    }
