...
namespace Modules\ZoneManagement\Services\Ai;
...
class TitanZeroBridge
{
    ...
    public function ingestSignal(array $signal, $tenantId = null): array
    {
        try {
            ...
            Log::warning('[TitanAI] ingestSignal failed', ['module' => 'ZoneManagement', 'err' => $e->getMessage()]);
    ...
    public function runAgent(string $agentSlug, array $context, $tenantId = null): ?array
    {
        try {
            ...
            Log::warning('[TitanAI] runAgent failed', ['module' => 'ZoneManagement', 'agent' => $agentSlug, 'err' => $e->getMessage()]);
            return null;
        }
    }
