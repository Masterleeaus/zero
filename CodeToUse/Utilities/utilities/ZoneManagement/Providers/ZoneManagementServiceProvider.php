...
class ZoneManagementServiceProvider extends ServiceProvider
{
    /**
     * @var string $moduleName
     */
    protected $moduleName = 'ZoneManagement';

    /**
     * @var string $moduleNameLower
     */
    protected $moduleNameLower = 'zonemanagement';
    ...
    public function register()
    {
        ...
        $helpers = module_path($this->moduleName, 'Lib/Zone.php');
