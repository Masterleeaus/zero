...
class RecurringSchedulesDataTable extends BaseDataTable
{
    ...
    public function query(WorkOrder $model)
    {
        ...
        //     $model = $model->where(DB::raw('DATE(workorders.`issue_date`)'), '>=', $startDate);
        // }

        // if ($request->endDate !== null && $request->endDate != 'null' && $request->endDate != '') {
        //     $endDate = Carbon::createFromFormat($this->company->date_format, $request->endDate)->toDateString();
        //     $model = $model->where(DB::raw('DATE(workorders.`issue_date`)'), '<=', $endDate);
        // }
    ...
    protected function getColumns()
    {
        ...
        $dsData = [
            ...
            __('engineerings::app.menu.workDesc') . '#'   => ['data' => 'work_description', 'name' => 'work_description', 'title' => __('engineerings::app.menu.workDesc')],
            __('engineerings::app.menu.issuedDate') . '#' => ['data' => 'issue_date', 'name' => 'issue_date', 'title' => __('engineerings::app.menu.issuedDate')],
            __('engineerings::app.menu.status')           => ['data' => 'status', 'name' => 'status', 'title' => __('engineerings::app.menu.status')],
            __('engineerings::app.menu.priority')         => ['data' => 'priority', 'name' => 'priority', 'title' => __('engineerings::app.menu.priority')],
