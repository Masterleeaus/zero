...
namespace Modules\Engineerings\Console;
...
use Modules\CleaningService\Entities\ScheduleItems;
use Modules\CleaningService\Entities\RecurringSchedule;
use Modules\CleaningService\Entities\Schedule;
...
class CreateWorkOrderCommand extends Command
{
            ...
            foreach ($recurringWorkOrder as $recurring) {
                ...
                if ($recurring->unlimited_recurring == 1 || ($totalExistingCount < $recurring->billing_cycle)) {
                    ...
                    if ($recurring->next_schedule_date->timezone($recurring->company->timezone)->isToday()) {
                        $this->workorderCreate($recurring);
    ...
    public function workorderCreate($recurringsData)
    {
