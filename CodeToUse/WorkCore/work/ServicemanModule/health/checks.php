...
return [
    [
        'id' => 'servicemanmodule:module_json',
    ...
    [
        'id' => 'servicemanmodule:service_provider',
    ...
    [
        'id' => 'servicemanmodule:routes_web',
    ...
    [
        'id' => 'servicemanmodule:migrations_dir',
