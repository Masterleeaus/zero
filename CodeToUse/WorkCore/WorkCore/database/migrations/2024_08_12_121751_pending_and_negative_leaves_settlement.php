...
return new class extends Migration
{
    ...
    {
        try {
        // cleaner leave quota remove negative vales for the current 
            ...
            foreach ($cleaners as $cleaner) {
                ...
                foreach ($cleaner->leaveTypes as $leaveQuota) {
                
                    $approvedLeavesCount = Leave::where('user_id', $cleaner->id)
                ...
                foreach ($cleaner->leaveQuotaHistory as $history) {
            ...
            Log::error('Error processing cleaner in company ID ' . $company->id . ': ' . $e->getMessage());
        }
    }
