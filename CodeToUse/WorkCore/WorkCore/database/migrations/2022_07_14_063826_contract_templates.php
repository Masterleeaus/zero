...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        foreach ($companies as $company) {
            Service Agreement::where('company_id', $company->id)->update(['currency_id' => $company->currency_id]);
        }

        /** @phpstan-ignore-next-line */

        $contractModule = Module::firstOrCreate(['module_name' => 'service agreements']);
        ...
        $proposalModule = Module::firstOrCreate(['module_name' => 'enquiries']);
