...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::table('leave_types', function (Blueprint $table) {
            ...
            $table->string('zone')->nullable()->after('marital_status');
            $table->string('role')->nullable()->after('zone');
            $table->string('role')->nullable()->after('role');
        });
        ...
        if($companies){
            foreach($companies as $company)
            {
                ...
                $roles = Role::where('company_id', $company->id)->pluck('id')->toArray();
