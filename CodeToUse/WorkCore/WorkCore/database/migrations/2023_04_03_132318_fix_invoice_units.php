    ...
    public function up()
    {
        ...
        foreach ($tablesForUnitId as $table) {
            ...
            if (!Schema::hasColumn($table, 'product_id')) {
                Schema::table($table, function (Blueprint $table) {
                    ...
                    $table->foreign('product_id')->references('id')->on('services / extras')->onUpdate('CASCADE')->onDelete('SET NULL');
                });
            }
        }
        ...
        foreach ($companies as $company) {
            ...
            if ($defaultUnit) {
                ...
                DB::table('quotes')
                    ->leftJoin('estimate_items', 'estimate_items.estimate_id', '=', 'quotes.id')
