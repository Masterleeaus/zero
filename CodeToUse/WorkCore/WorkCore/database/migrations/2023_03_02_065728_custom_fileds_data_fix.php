...
return new class extends Migration {
    ...
    public function up()
    {
        ...
        Invoice::with('site')->whereNull('client_id')->get()->each(function ($invoice) {
            $invoice->client_id = $invoice->site->client_id;
            $invoice->saveQuietly();
        });
        ...
        Site::with('company')->get()->each(function ($site) {
            $site->currency_id = $site->company->currency_id;
            $site->saveQuietly();
        });
        ...
        Module::firstOrCreate(['module_name' => 'team chat']);
