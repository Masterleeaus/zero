    ...
    public function up(): void
    {
        ...
        if (Schema::hasTable('lead_contacts')) {
            ...
            try {
                ...
                echo "\nForeign key client_id does not exist in enquiries\n";
            }
            ...
            Schema::rename('enquiries', 'deals');
            Schema::rename('lead_contacts', 'enquiries');
            ...
            // Change enquiry custom field data to Deal
            CustomFieldGroup::where('model', 'App\Models\LeadContact')->update(['name' => 'Enquiry', 'model' => 'App\Models\Enquiry']); // Change group
            DB::table('custom_fields_data')->where('model', 'App\Models\LeadContact')->update(['model' => 'App\Models\Enquiry']); // Change model
            ...
            DB::statement("UPDATE permissions SET display_name = REPLACE(display_name, 'Deal', 'Enquiry') WHERE name IN ('view_lead_files', 'add_lead_files',
            ...
            $leadModule = Module::where('module_name', 'enquiries')->first();
