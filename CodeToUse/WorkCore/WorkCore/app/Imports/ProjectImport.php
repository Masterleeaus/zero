...
class ProjectImport implements ToArray
{
    ...
    {
        return array(
            array('id' => 'project_name', 'name' => __('modules.sites.projectName'), 'required' => 'Yes'),
            array('id' => 'project_summary', 'name' => __('modules.sites.projectSummary'), 'required' => 'No'),
            array('id' => 'start_date', 'name' => __('modules.sites.startDate'), 'required' => 'Yes'),
            array('id' => 'deadline', 'name' => __('modules.sites.deadline'), 'required' => 'No'),
            array('id' => 'client_email', 'name' => __('app.customer') . ' ' . __('app.email'), 'required' => 'No'),
            array('id' => 'project_budget', 'name' => __('modules.sites.projectBudget'), 'required' => 'No'),
            array('id' => 'status', 'name' => __('app.status'), 'required' => 'No'),
            array('id' => 'notes', 'name' => __('modules.sites.note'), 'required' => 'No'),
            array('id' => 'project_members', 'name' => __('modules.sites.projectMembers'), 'required' => 'No'),
        );
    }
