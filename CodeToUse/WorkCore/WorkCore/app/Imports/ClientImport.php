...
class ClientImport implements ToArray
{
    ...
    {
        return array(
            array('id' => 'name', 'name' => __('modules.customer.clientName'), 'required' => 'Yes'),
            ...
            array('id' => 'company_name', 'name' => __('modules.customer.companyName'), 'required' => 'No'),
            ...
            array('id' => 'company_website', 'name' => __('modules.customer.website'), 'required' => 'No'),
