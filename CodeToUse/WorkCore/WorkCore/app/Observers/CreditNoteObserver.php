...
class CreditNoteObserver
{
    ...
    public function created(CreditNotes $creditNote)
    {
        if (!isRunningInConsoleOrSeeding()) {
            ...
            elseif ($creditNote->site && $creditNote->site->client_id != null) {
                $clientId = $creditNote->site->client_id;
            }
            elseif ($creditNote->invoice->site && $creditNote->invoice->site->client_id != null) {
                $clientId = $creditNote->invoice->site->client_id;
            }
