...
class PaymentObserver
{
    ...
    public function saved(Payment $payment)
    {
        ...
        if (($payment->project_id && $payment->site->client_id != null) || ($payment->invoice_id && $payment->invoice->client_id != null) && $payment->gateway != 'Offline') {
            // Notify customer
            $clientId = ($payment->project_id && $payment->site->client_id != null) ? $payment->site->client_id : $payment->invoice->client_id;
