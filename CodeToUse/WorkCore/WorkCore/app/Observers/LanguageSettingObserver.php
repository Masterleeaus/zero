...
class LanguageSettingObserver
{
    ...
    public function detail($languageId)
    {
        ...
        $trFrontDetail->task_management_title = 'Service Job Management';
        $trFrontDetail->task_management_detail = 'Manage your sites and talent in one system for empowered teams, satisfied customers, and increased profitability.';

        $trFrontDetail->manage_bills_title = 'Manage All Bills';
        $trFrontDetail->manage_bills_detail = 'Automate billing and revenue recognition to streamline the service agreement-to-cash cycle.';
        ...
        $trFrontDetail->client_detail = 'Over 700 people use our service / extra.';
        ...
        $trFrontDetail->header_title = 'HR, CRM, and Site Management System';
    ...
    public function features($languageId)
    {
        $features = [
            [
                ...
                'description' => '<p>Manage your sites and your talent in a single system, resulting in empowered teams, satisfied customers, and increased profitability.</p><ul class="list1 border-top pt-5 mt-5">
                            <li class="mb-3">
                                Keep a track of all your sites in most simple way.
                            </li>
                            <li class="mb-3">
                                Assign service jobs to site members and track the status.
                            </li>
                            <li class="mb-3">
                                Add members to your sites and keep them in sync  with the progress.
                            </li>
                        </ul>',
                'type' => 'image',
            ],
            [
                ...
                'description' => "<p>Reports section to analyse what's working and what's not for your business</p><ul class=\"list1 border-top pt-5 mt-5\">
                            ...
                            <li class=\"mb-3\">
                                It creates service job report to track completed vs pending service jobs.
                            </li>
                        </ul>",
                'type' => 'image',
            ],
            [
                ...
                'description' => '<p>Whether someone\'s internet is not working, someone is facing issue with housekeeping or need something regarding their work they can raise a ticket for all their problems.</p><ul class="list1 border-top pt-5 mt-5"><li class="mb-3">Admin can assign the tickets to respective zone agents.</li></ul>',
                'type' => 'image',
            ],
        ];
        ...
        $features = [
            ...
            [
                'title' => 'Track Sites',
                'language_setting_id' => $languageId,
                'description' => 'Keep a track of all your sites in the most simple way.',
                'icon' => 'fas fa-desktop',
                'type' => 'service job'
            ],
            [
                'title' => 'Add Members',
                'language_setting_id' => $languageId,
                'description' => 'Add members to your sites and keep them in sync with the progress.',
                'icon' => 'fas fa-users',
                'type' => 'service job'
            ],
            [
                'title' => 'Assign Service Jobs',
                'language_setting_id' => $languageId,
            ...
            [
                'title' => 'Quotes',
                'language_setting_id' => $languageId,
                'description' => 'Create quotes how much site can cost and send to your customers.',
            ...
            [
                'title' => 'Payments',
                'language_setting_id' => $languageId,
                'description' => 'Track payments done by customers in the payment section.',
            ...
            [
                'title' => 'Tickets',
                'language_setting_id' => $languageId,
                'description' => 'When someone is facing a problem, they can raise a ticket for their problems. Admin can assign the tickets to respective zone agents.',
            ...
            [
                'title' => 'Leaves',
                'language_setting_id' => $languageId,
                'description' => 'Cleaners can apply for the multiple leaves from their panel. Admin can approve or reject the leave applications.',
                'icon' => 'fas fa-ban',
                'type' => 'team',
            ],
            [
                'title' => 'Attendance',
                'language_setting_id' => $languageId,
                'description' => 'Attendance module allows cleaners to clock-in and clock-out, right from their dashboard. Admin can track the attendance of the team.',
    ...
    {
        $customers = [
            ['title' => 'Customer 1', 'language_setting_id' => $languageId],
            ['title' => 'Customer 2', 'language_setting_id' => $languageId],
            ['title' => 'Customer 3', 'language_setting_id' => $languageId],
            ['title' => 'Customer 4', 'language_setting_id' => $languageId]
        ];

        FrontClients::insert($customers);
    ...
    public function testimonials($languageId)
    {
        $testimonials = [
            ...
            [
                'name' => 'whatson angela',
                'language_setting_id' => $languageId,
                'comment' => 'The application has made my life much easier by automating my service jobs.',
                'rating' => 2
            ],
            [
                'name' => 'Megan Lee',
    ...
    public function frontFaq($languageId)
    {
        ...
        $customer = [
            [
                ...
                'language_setting_id' => $languageId,
                'answer' => '<span style="color: rgb(68, 68, 68); font-family: Lato, sans-serif; font-size: 16px;">Yes, definitely. We would be happy to demonstrate you Worksuite through a web conference at your convenience. Please submit a query on our contact us page or drop a mail to our mail id workcore@froiden.com.</span>'
            ],
            [
    ...
    public function seoDetail($languageId)
    {
        ...
        $defaultSeoDetails = [
            ...
            'seo_description' => $seoAuthor . ' saas is easy to use CRM software that is designed for B2B. It include  everything you need to run your businesses. like manage customers, sites, invoices, quotes, timelogs, service agreement and much more.'
        ];
