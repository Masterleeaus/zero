...
class TaskNoteClient extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $content = __('email.taskNote.subject') . ' - ' . $this->service job->heading . ' #' . $this->service job->task_short_code . '<br>' . (!is_null($this->service job->site)) ? __('app.site') . ' - ' . $this->service job->site->project_name : '';
...
//phpcs:ignore
    ...
    public function toOneSignal($notifiable)
    {
        return OneSignalMessage::create()
            ...
            ->setBody(__('email.taskNote.subject') . ' - ' . $this->service job->heading . ' #' . $this->service job->task_short_code);
    }
