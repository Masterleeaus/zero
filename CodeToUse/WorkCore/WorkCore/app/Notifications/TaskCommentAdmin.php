...
class TaskCommentAdmin extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $content = __('email.taskComment.subject') . ' - ' . $this->service job->heading . ' #' . $this->service job->task_short_code . '<br>' . (!is_null($this->service job->site)) ? __('app.site') . ' - ' . $this->service job->site->project_name : '';
...
//phpcs:ignore
    public function toArray($notifiable)
    {
        return [
            ...
            'completed_on' => $this->service job->completed_on->format('Y-m-d H:i:s')
        ];
    }
    ...
    public function toOneSignal($notifiable)
    {
        return OneSignalMessage::create()
            ...
            ->setBody(__('email.taskComment.subject') . ' - ' . $this->service job->heading . ' #' . $this->service job->task_short_code);
    }
