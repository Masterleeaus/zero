...
class LeadAgentAssigned extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $content = __('email.leadAgent.subject') . '<br>' .__('modules.deal.dealName') . ': '  . $this->deal->name . '<br>' .  __('modules.enquiry.clientName') . ': '  . $this->deal->contact->client_name_salutation . '<br>' . $clientEmail . $this->deal->contact->client_email;
