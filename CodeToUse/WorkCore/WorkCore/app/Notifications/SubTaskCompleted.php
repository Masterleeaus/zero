...
class SubTaskCompleted extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $content = $this->subTask->title . ' ' . __('email.subTaskComplete.subject') . '.' . '<br>' . ((!is_null($this->subTask->service job->site)) ? __('app.site') . ' - ' . $this->subTask->service job->site->project_name : '') . '<br>';
