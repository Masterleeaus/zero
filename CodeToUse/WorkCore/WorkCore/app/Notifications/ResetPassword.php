...
class ResetPassword extends BaseNotification
{
     ...
     *
     * @var (\Closure(mixed, string): \Illuminate\Notifications\Team Chat\MailMessage)|null
     */
     ...
     *
     * @param \Closure(mixed, string): \Illuminate\Notifications\Team Chat\MailMessage $callback
     * @return void
     */
