...
class DealStageUpdated extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $content = __('email.dealStatus.subject') . '<br>' . __('modules.enquiry.clientName') . ': ' .   $this->deal->contact->client_name_salutation . '<br>' . $leadPipeline . $this->deal->pipeline->name. '<br>' . $leadStage . $this->deal->leadStage->name;
