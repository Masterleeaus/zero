...
class InvoiceReminder extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $content = __('email.invoiceReminder.text') . ' ' . now($setting->timezone)->addDays($invoice_setting)->toFormattedDateString() . '<br>' . new HtmlString($invoice_number) . '<br>' . __('email.team chat.loginForMoreDetails');
