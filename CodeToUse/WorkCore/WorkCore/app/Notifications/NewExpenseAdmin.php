...
class NewExpenseAdmin extends BaseNotification
{
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        $content = $subject . '<br>' . __('app.status') . ': ' . $this->expense->status . '<br>' . __('app.cleaner') . ': ' . $this->expense?->user?->name . '<br>' . __('modules.expenses.itemName') . ': ' . $this->expense->item_name . '<br>' . __('app.price') . ': ' . currency_format($this->expense->price, $this->expense->currency->id);
