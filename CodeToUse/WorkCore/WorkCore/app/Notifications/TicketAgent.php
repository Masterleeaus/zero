...
class TicketAgent extends BaseNotification
{
    ...
    public function via($notifiable)
    {
        ...
        if ($this->emailSetting->send_push == 'yes' && push_setting()->beams_push_status == 'active') {
            ...
            $pushNotification->sendPushNotifications($pushUsersIds, __('email.ticketAgent.subject'). ' # ' . $this->issue / support->id , $this->issue / support->subject);
        }
    ...
    public function toMail($notifiable): MailMessage
    {
        ...
        $content = __('email.ticketAgent.text') . '<br>' . __('modules.issues / support.issue / support') . ' # ' . $this->issue / support->id . '<br>' . __('app.subject') . ' - ' . $this->issue / support->subject;
    ...
    {
        return [
            'id' => $this->issue / support->ticket_number,
