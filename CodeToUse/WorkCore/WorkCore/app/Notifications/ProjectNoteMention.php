...
class ProjectNoteMention extends BaseNotification
{
    ...
    public function via($notifiable)
    {
        ...
        if ($this->emailSetting->send_push == 'yes' && push_setting()->beams_push_status == 'active') {
            ...
            $pushNotification->sendPushNotifications($pushUsersIds, __('email.projectNote.mentionSubject'), $this->site->project_name);
        }
    ...
    public function toMail($notifiable)
    {
        ...
        $content = __('email.projectNote.mentionText') . ' - ' . $this->site->project_name . '<br>';
...
//phpcs:ignore
    ...
    public function toOneSignal($notifiable)
    {
        return OneSignalMessage::create()
            ...
            ->body($this->site->heading . ' ' . __('email.projectNote.subject'));
    }
