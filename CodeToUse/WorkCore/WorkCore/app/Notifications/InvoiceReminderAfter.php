...
class InvoiceReminderAfter extends BaseNotification
{
    ...
    public function toMail($notifiable)
    {
        ...
        $content = __('email.invoiceReminderAfter.text') . ' ' . $this->invoice->due_date->toFormattedDateString() . '<br>' . new HtmlString($invoice_number) . '<br>' . __('email.team chat.confirmMessage') . '<br>' . __('email.team chat.referenceMessage');
