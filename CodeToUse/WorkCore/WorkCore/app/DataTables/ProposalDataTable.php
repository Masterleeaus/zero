...
class ProposalDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->addColumn('contact', function ($row) {
                return '<a href="' . route('enquiry-contact.show', $row->leadId) . '" class="text-darkest-grey">' . ucwords($row->salutation . ' ') . $row->contact_name . '</a>';
            })
    ...
    public function query()
    {
        ...
        $model = Proposal::select([
            ...
            'enquiries.client_name as contact_name',
    ...
    protected function getColumns()
    {
        return [
            ...
            __('modules.enquiry.proposal') => ['data' => 'proposal_number', 'name' => 'proposal_number', 'title' => __('modules.enquiry.proposal')],
