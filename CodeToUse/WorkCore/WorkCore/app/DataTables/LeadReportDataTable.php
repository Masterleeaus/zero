...
class LeadReportDataTable extends BaseDataTable
{
    ...
    {
        $dataTable = $this->setBuilder('enquiry-report-table', 5)
            ->parameters([
                'initComplete' => 'function () {
                    window.LaravelDataTables["enquiry-report-table"].buttons().container()
    ...
    protected function getColumns()
    {
        return [
            ...
            __('modules.enquiry.convertedAmount') => ['data' => 'converted_amount', 'name' => 'total_converted_value', 'title' => __('modules.enquiry.convertedAmount')],
