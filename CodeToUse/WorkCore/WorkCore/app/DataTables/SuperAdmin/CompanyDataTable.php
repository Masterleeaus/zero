...
class CompanyDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $datatables->addColumn('details_export', function ($row) {
            ...
            $string .= __('app.menu.cleaners') . ": $totalEmployees" . "/" . "$maxEmployees ";
            $string .= __('app.menu.customers') . ": $totalClient ";
        ...
        $datatables->addColumn('details', function ($row) {
            ...
            $string .= '<li>' . __('app.menu.cleaners') . ': ' . $row->totalEmployees . '/' . $row->package->max_employees . '</li>';
            $string .= '<li>' . __('app.menu.customers') . ': ' . $row->totalClient . '</li>';
