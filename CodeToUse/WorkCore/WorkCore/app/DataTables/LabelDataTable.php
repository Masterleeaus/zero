        ...
        return datatables()
            ...
            ->addColumn('action', function ($row) {
                ...
                <ul role="menu" class="dropdown-menu pull-right">
                  <li><a href="' . route('admin.service job-label.edit', [$row->id]) . '"><i class="fa fa-pencil" aria-hidden="true"></i> ' . trans('app.edit') . '</a></li>
                  <li><a href="javascript:;"   data-service agreement-id="' . $row->id . '"  class="sa-params"><i class="fa fa-times" aria-hidden="true"></i> ' . trans('app.delete') . '</a></li>';
