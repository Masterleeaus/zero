...
class LeaveReportDataTable extends BaseDataTable
{
    ...
    public function query(User $model)
    {
        ...
        $model = $model->with('leaves')->selectRaw(
            'users.*, roles.name as designation_name,
        ...
        if(in_array('cleaner', user_roles()) && $this->viewLeaveReportPermission == 'owned')
        {
        ...
        if(in_array('cleaner', user_roles()) && $this->viewLeaveReportPermission == 'both')
        {
            $model->whereHas('employeeDetail', function($query){
        ...
        if(in_array('cleaner', user_roles()) && $this->viewLeaveReportPermission == 'added')
        {
            $model->whereHas('employeeDetail', function($query){
