...
class RecurringExpensesDataTable extends BaseDataTable
{
    ...
    public function query(ExpenseRecurring $model)
    {
        ...
        }, 'currency:id,currency_symbol,currency_code', 'site.customer', 'user'])
    ...
    protected function getColumns()
    {
        return [
            ...
            __('app.menu.cleaners') => ['data' => 'user_id', 'name' => 'user_id', 'title' => __('app.menu.cleaners'), 'exportable' => false],
