...
class ExpensesDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        ...
        $datatables->editColumn('user_id', fn($row) => view('components.cleaner', ['user' => $row->user]));
    ...
    public function query()
    {
        ...
        if ($request->cleaner != 'all' && !is_null($request->cleaner)) {
            $model = $model->where('expenses.user_id', '=', $request->cleaner);
        }
    ...
    protected function getColumns()
    {
        $data = [
            ...
            __('app.menu.cleaners') => ['data' => 'user_id', 'name' => 'user_id', 'exportable' => false, 'title' => __('app.menu.cleaners')],
            __('app.cleaner') => ['data' => 'employee_name', 'name' => 'user_id', 'visible' => false, 'title' => __('app.cleaner')],
