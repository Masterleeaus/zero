...
class FinanceReportDataTable extends BaseDataTable
{
    ...
    public function query()
    {
        ...
        $model = Payment::with(['site:id,project_name', 'currency:id,currency_symbol,currency_code', 'invoice'])
    ...
    protected function getColumns()
    {
        ...
        return [
            ...
            __('app.site') => ['data' => 'project_id', 'name' => 'project_id', 'title' => __('app.site')],
