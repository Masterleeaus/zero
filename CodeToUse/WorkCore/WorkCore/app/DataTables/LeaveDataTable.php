...
class LeaveDataTable extends BaseDataTable
{
    ...
    public function dataTable($query)
    {
        return datatables()
            ...
            ->editColumn('cleaner', function ($row) {
            ...
            ->addColumn('duration', function ($row) {
                ...
                if ($row->count_multiple_leaves != 0) {
                    $leave .= '<span class="badge badge-secondary">' . $row->count_multiple_leaves . ' ' . __('app.leaveDay') . '</span>';
                }
            ...
            ->addColumn('action', function ($row) {
                ...
                if (
                    $this->deleteLeavePermission == 'all'
            ...
            ->rawColumns(['status', 'leave_type', 'action', 'check', 'cleaner', 'duration', 'leave_paid']);
    }
    ...
    public function query(Leave $model)
    {
        ...
        $leavesList = $model->with('user', 'user.employeeDetail', 'user.employeeDetail.role', 'user.session', 'type')
    ...
    protected function getColumns()
    {
        return [
            ...
            __('app.cleaner') => ['data' => 'cleaner', 'name' => 'user.name', 'exportable' => false, 'title' => __('app.cleaner')],
            __('app.cleaner') . ' ' => ['data' => 'employee_name', 'name' => 'user.name', 'visible' => false, 'title' => __('app.cleaner')],
