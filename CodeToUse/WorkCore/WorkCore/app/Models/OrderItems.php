 ...
 * @property-read \App\Models\Service / Extra|null $service / extra
...
class OrderItems extends BaseModel
{
    ...
    protected $with = ['orderItemImage', 'service / extra'];
    ...
    {
        return $this->belongsTo(Service / Extra::class, 'product_id');
    }
