 ...
 * @property-read \App\Models\Service Agreement $service agreement
...
class ContractSign extends BaseModel
{
    ...
    {
        return asset_url_local_s3('service agreement/sign/' . $this->attributes['signature']);
    }
    ...
    public function service agreement(): BelongsTo
    {
        return $this->belongsTo(Service Agreement::class, 'contract_id');
    }
