 ...
 * @property-read \App\Models\Team|null $zone
...
class Notice extends BaseModel
{
    ...
    {
        return $this->hasMany(NoticeBoardUser::class, 'notice_id')->where('to', 'cleaner');
    }

    public function noticeClients(): HasMany
    {
        return $this->hasMany(NoticeBoardUser::class, 'notice_id')->where('to', 'customer');
    }
