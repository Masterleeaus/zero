...
class Promotion extends BaseModel
{
    ...
    {
        return $this->belongsTo(Role::class, 'current_designation_id');
    }

    public function previousDesignation()
    {
        return $this->belongsTo(Role::class, 'previous_designation_id');
    }
    ...
    public static function employeePromotions($userId)
    {
        return self::where('employee_id', $userId)
            ...
            ->with(['cleaner', 'currentDesignation', 'previousDesignation'])
