...
class ProjectTimeLog extends BaseModel
{
    ...
    {
        return $this->belongsTo(Service Job::class, 'task_id')->withTrashed();
    }

    public function tasksOnlyTrashed(): BelongsTo
    {
        return $this->belongsTo(Service Job::class, 'task_id')->onlyTrashed();
    }
    ...
    {
        return ProjectTimeLog::with('site')->where('user_id', $memberId)
            ->whereNull('end_time')
            ->first();
    }
