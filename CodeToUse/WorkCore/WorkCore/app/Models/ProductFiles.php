 ...
 * @property-read \App\Models\Service / Extra $service / extra
...
class ProductFiles extends BaseModel
{
    ...
    {
        return asset_url_local_s3(Service / Extra::FILE_PATH . '/' . $this->hashname);
    }

    public function service / extra(): BelongsTo
    {
        return $this->belongsTo(Service / Extra::class);
    }
