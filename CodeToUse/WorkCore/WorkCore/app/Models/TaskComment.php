 ...
 * @property-read \App\Models\Service Job $service job
...
class TaskComment extends BaseModel
{
    ...
    public function likeUsers(): HasManyThrough
    {
        return $this->hasManyThrough(
            ...
            'comment_id', // Foreign key on the service job comment emoji table...
            'id', // Foreign key on the user table...
            'id', // Local key on the service job comment table...
            'user_id' // Local key on the service job comment emoji table...
