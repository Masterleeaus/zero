...
class CustomFieldGroup extends BaseModel
{
    ...
    const ALL_FIELDS = [
        ['name' => 'Customer', 'model' => ClientDetails::CUSTOM_FIELD_MODEL],
        ['name' => 'Cleaner', 'model' => EmployeeDetails::CUSTOM_FIELD_MODEL],
        ['name' => 'Site', 'model' => Site::CUSTOM_FIELD_MODEL],
        ['name' => 'Invoice', 'model' => Invoice::CUSTOM_FIELD_MODEL],
        ['name' => 'Quote', 'model' => Quote::CUSTOM_FIELD_MODEL],
        ['name' => 'Service Job', 'model' => Service Job::CUSTOM_FIELD_MODEL],
        ['name' => 'Expense', 'model' => Expense::CUSTOM_FIELD_MODEL],
        ['name' => 'Enquiry', 'model' => Enquiry::CUSTOM_FIELD_MODEL],
        ['name' => 'Deal', 'model' => Deal::CUSTOM_FIELD_MODEL],
        ['name' => 'Service / Extra', 'model' => Service / Extra::CUSTOM_FIELD_MODEL],
        ...
        ['name' => 'Service Agreement', 'model' => Service Agreement::CUSTOM_FIELD_MODEL]
    ];
