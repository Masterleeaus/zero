 ...
 * @property-read \Illuminate\Database\Eloquent\Collection|\App\Models\ProjectTemplateTask[] $service jobs
...
class ProjectTemplate extends BaseModel
{
    ...
    {
        $site = ProjectTemplateMember::where('project_template_id', $this->id)
    ...
    {
        $site = ProjectTemplateMember::where('id', $this->id)
