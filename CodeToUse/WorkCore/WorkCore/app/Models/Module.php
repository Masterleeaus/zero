...
class Module extends BaseModel
{
    ...
    const MODULE_LIST = [
        ...
        [
            'module_name' => 'sites',
            'description' => 'User can view the basic details of sites assigned to him even without any permission.',
            'permissions' => [
                [
                    'allowed_permissions' => Permission::ALL_NONE,
                    'is_custom' => 0,
        ...
        [
            'module_name' => 'service jobs',
            'description' => 'User can view the service jobs assigned to him even without any permission.',
            'permissions' => [
                [
                    'allowed_permissions' => Permission::ALL_ADDED_NONE,
                    'is_custom' => 0,
        ...
        [
            ...
            'permissions' => [
                ...
                [
                    'allowed_permissions' => Permission::ALL_NONE,
                    'display_name' => 'Manage Enquiry Custom Forms',
                    'is_custom' => 1,
        ...
        [
            'module_name' => 'service agreements',
            'description' => 'User can view all service agreements',
            'permissions' => [
                [
                    'allowed_permissions' => Permission::ALL_NONE,
                    'is_custom' => 0,
    ...
    public static function validateVersion($module)
    {
        ...
        if ($parentMinVersion >= File::get('version.txt')) {
            ...
            $message = 'To activate <strong>' . $module . '</strong> module, minimum version of <b>workcore application</b> must be greater than equal to <b>' . $parentMinVersion . '</b> But your application version is <b>' . File::get('version.txt') . '</b>. Please upgrade the application to latest version';
