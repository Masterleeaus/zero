...
class DashboardWidget extends BaseModel
{
    ...
    const WIDGETS = [
        ...
        ['dashboard_type' => 'admin-dashboard', 'widget_name' => 'documents',  'status' => 1],
        ...
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'total_clients',  'status' => 1],
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'total_leads',  'status' => 1],
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'total_lead_conversions',  'status' => 1],
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'total_contracts_generated',  'status' => 1],
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'total_contracts_signed',  'status' => 1],
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'client_wise_earnings',  'status' => 1],
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'client_wise_timelogs',  'status' => 1],
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'lead_vs_status',  'status' => 1],
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'lead_vs_source',  'status' => 1],
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'latest_client',  'status' => 1],
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'recent_login_activities',  'status' => 1],
        ['dashboard_type' => 'admin-customer-dashboard', 'widget_name' => 'total_deals',  'status' => 1],
        ...
        ['dashboard_type' => 'admin-site-dashboard', 'widget_name' => 'total_project',  'status' => 1],
        ['dashboard_type' => 'admin-site-dashboard', 'widget_name' => 'total_hours_logged',  'status' => 1],
        ['dashboard_type' => 'admin-site-dashboard', 'widget_name' => 'total_overdue_project',  'status' => 1],
        ['dashboard_type' => 'admin-site-dashboard', 'widget_name' => 'status_wise_project',  'status' => 1],
        ['dashboard_type' => 'admin-site-dashboard', 'widget_name' => 'pending_milestone',  'status' => 1],
        ...
        ['dashboard_type' => 'private-dashboard', 'widget_name' => 'service jobs',  'status' => 1],
        ['dashboard_type' => 'private-dashboard', 'widget_name' => 'sites',  'status' => 1],
        ...
        ['dashboard_type' => 'private-dashboard', 'widget_name' => 'enquiry',  'status' => 1],
    ...
    const MODULE = [
        ...
        ['enquiries' => 'enquiry'],
        ['notices' => 'notices'],
        ['service jobs' => ['service jobs', 'my_task']],
        ['sites' => 'sites'],
        ['timelogs' => 'week_timelog'],
        ['leaves' => 'leave'],
        ['service agreements' => 'contract_date'],
    ];
