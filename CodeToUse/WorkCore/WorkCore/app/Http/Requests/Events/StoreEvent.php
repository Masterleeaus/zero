...
class StoreEvent extends CoreRequest
{
    ...
    {
        return [
            'user_id.0.required_unless' => __('team chat.atleastOneValidation'),
            'end_time.after_or_equal' => __('team chat.endTimeAfterOrEqual'),
            'repeat_cycles.required' => __('team chat.cyclesValidation'),
            'repeat_count.required' => __('team chat.repeatCyclesValidation'),
        ];
    }
