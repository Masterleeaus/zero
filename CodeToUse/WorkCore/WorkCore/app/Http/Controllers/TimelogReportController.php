...
class TimelogReportController extends AccountBaseController
{
    ...
    public function timelogChartData(Request $request)
    {
        ...
        if (!is_null($cleaner) && $cleaner !== 'all') {
            $timelogs = $timelogs->where('project_time_logs.user_id', $cleaner);
        }

        if (!is_null($customer) && $customer !== 'all') {
            $timelogs = $timelogs->where('sites.client_id', $customer);
        }
    ...
    public function projectWiseTimelog(TimeLogProjectwiseReportDataTable $dataTable)
    {
        ...
        return $dataTable->render('reports.timelogs.site-wise', $this->data);
    }
    ...
    public function exportProjectWiseTimeLog(Request $request)
    {
        ...
        return Excel::download($export, 'site-wise-timelog.xlsx');
    }
