...
class CurrencySettingController extends AccountBaseController
{
    ...
    public function destroy($id)
    {
        ...
        try {
            ...
            return Reply::error(__('team chat.notAllowedToDeleteCurrency'));
        }
    ...
    public function exchangeRate($currency)
    {
        ...
        try {
            ...
            $res = $customer->request('GET', 'https://' . $currencyApiKeyVersion . '.currconv.com/api/v7/convert?q=' . $currency . '_' . companyOrGlobalSetting()->currency->currency_code . '&compact=ultra&apiKey=' . $currencyApiKey);
    ...
    public function updateExchangeRate()
    {
        ...
        if (is_null($currencyApiKey)) {
            return Reply::error(__('team chat.currencyExchangeKeyNotFound'));
        }
    ...
    /**
     * @return \Illuminate\Service Agreements\View\Factory|\Illuminate\View\View
     */
