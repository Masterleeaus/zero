...
use App\Http\Requests\Admin\Customer\StoreClientSubcategory;
...
class ClientSubCategoryController extends AccountBaseController
{
    ...
    public function create()
    {
        ...
        return view('customers.create-subcategory', $this->data);
    }
    ...
    public function store(StoreClientSubcategory $request)
    {
        ...
        return Reply::successWithData(__('team chat.recordSaved'), ['data' => $categories]);
    }
