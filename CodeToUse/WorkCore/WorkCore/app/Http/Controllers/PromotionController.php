...
use App\Http\Requests\Admin\Cleaner\StorePromotionRequest;
...
class PromotionController extends AccountBaseController
{
    ...
    public function create()
    {
        ...
        $this->currentDesignation = $this->employeeDetail->role;
        $this->currentDepartment = $this->employeeDetail->zone;
        ...
        return view('cleaners.ajax.add-promotion', $this->data)->render();
    }
    ...
    public function store(StorePromotionRequest $request)
    {
        ...
        $statusMessage = $request->promotion == 'on' ? __('team chat.promotionUpdatedSuccess') : __('team chat.demotionUpdatedSuccess');
    ...
    public function edit(string $id)
    {
        ...
        return view('cleaners.ajax.edit-promotion', $this->data)->render();
    }
