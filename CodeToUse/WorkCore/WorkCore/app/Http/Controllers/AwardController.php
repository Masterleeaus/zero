...
class AwardController extends AccountBaseController
{
    ...
    public function store(StoreRequest $request)
    {
        ...
        return Reply::successWithData(__('team chat.recordSaved'), ['redirectUrl' => route('awards.index')]);
    ...
    public function update(UpdateRequest $request, $id)
    {
        ...
        return Reply::successWithData(__('team chat.updateSuccess'), ['redirectUrl' => route('awards.index')]);
    }
    ...
    public function destroy($id)
    {
        ...
        return Reply::successWithData(__('team chat.deleteSuccess'), ['redirectUrl' => route('awards.index')]);
