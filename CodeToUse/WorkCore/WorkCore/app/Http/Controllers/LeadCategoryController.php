...
use App\Http\Requests\Enquiry\StoreLeadCategory;
use App\Http\Requests\Enquiry\UpdateLeadCategory;
...
class LeadCategoryController extends AccountBaseController
{
    ...
    public function create()
    {
        ...
        return view('enquiry-settings.create-category-modal', $this->data);
    }
    ...
    public function store(StoreLeadCategory $request)
    {
        ...
        return Reply::successWithData(__('team chat.recordSaved'), ['data' => $list]);
    ...
    public function edit($id)
    {
        ...
        return view('enquiry-settings.edit-category-modal', $this->data);
