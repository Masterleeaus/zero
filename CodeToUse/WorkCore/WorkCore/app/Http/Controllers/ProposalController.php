...
class ProposalController extends AccountBaseController
{
    ...
    public function index(ProposalDataTable $dataTable)
    {
        ...
        if (!request()->ajax()) {
            $this->enquiries = Enquiry::allLeads();
        }
    ...
    public function create()
    {
        ...
        if (request('proposal') != '') {
            ...
            $this->type = 'proposal';
            $this->proposal = Proposal::with('items', 'items.proposalItemImage', 'enquiry', 'unit', 'deal')->findOrFail($this->proposalId);
        }
    ...
    public function store(StoreRequest $request)
    {
        ...
        return Reply::redirect($redirectUrl, __('team chat.recordSaved'));
    }
    ...
    public function show($id)
    {
        ...
        $this->invoice = Proposal::with('deal', 'items', 'unit', 'enquiry', 'items.proposalItemImage')->findOrFail($id);
    ...
    public function edit($id)
    {
        ...
        $this->taxes = Tax::all();
        $this->currencies = Currency::all();
        $this->proposal = Proposal::with('items', 'enquiry')->findOrFail($id);
    ...
    public function update(StoreRequest $request, $id)
    {
        ...
        return Reply::redirect(route('proposals.show', $proposal->id), __('team chat.updateSuccess'));
    }
    ...
    public function sendProposal($id)
    {
        ...
        if (request()->data_type == 'mark_as_send') {
            return Reply::success(__('team chat.proposalMarkAsSent'));
        }

        return Reply::success(__('team chat.proposalSendSuccess'));
    ...
    {
        $this->invoiceSetting = invoice_setting();
        $this->proposal = Proposal::with('items', 'enquiry', 'enquiry.contact', 'currency')->findOrFail($id);
        ...
        $filename = __('modules.enquiry.proposal') . '-' . $this->proposal->id;
