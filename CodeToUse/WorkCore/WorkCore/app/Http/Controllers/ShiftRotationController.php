...
class ShiftRotationController extends AccountBaseController
{
    ...
    public function store(StoreShiftRotationRequest $request)
    {
        if (!$request->has('shifts')) {
            return Reply::error(__('team chat.addShift'));
        }
    ...
    public function changeStatus(Request $request)
    {
        ...
        return Reply::success(__('team chat.rotationStatusChanged'));
    ...
    public function destroy($id)
    {
        ...
        if (!$rotation) {
            return Reply::error(__('team chat.rotationNotFound'));
        }
    ...
    public function manageEmployees($id)
    {
        ...
        $this->cleaners = User::whereIn('id', $rotationEmployees)->lazy();

        return view('attendance-settings.ajax.manage-cleaners', $this->data);
    }
    ...
    public function removeEmployee(Request $request)
    {
        ...
        return Reply::success(__('team chat.employeeRemoveSuccess'));
    }
    ...
    public function changeEmployeeRotation(Request $request)
    {
        ...
        return Reply::success(__('team chat.employeeRotationChanged'));
    }
    ...
    public function automateShift()
    {
        ...
        $this->cleaners = User::allEmployees(null, true, 'all')->whereNotIn('id', $otherEmployees);
        $this->zones = Team::all();
    ...
    public function storeAutomateShift(StoreAutomateShift $request)
    {
        ...
        return Reply::success(__('team chat.automateShiftAdded'));
    }
    ...
    public function runRotation(Request $request)
    {
        if ($request->isMethod('post')) {
            ...
            if (!$rotationIds) {
                return Reply::error(__('team chat.noShiftRotation'));
            }

                Artisan::call('assign-cleaner-shift-rotation', [
                   '--rotation_ids' => $rotationIds
                ]);
            return Reply::success(__('team chat.rotationRunSuccessfully'));
        }
