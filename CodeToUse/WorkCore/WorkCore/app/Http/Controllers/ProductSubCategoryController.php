...
use App\Http\Requests\Service / Extra\StoreProductSubCategory;
...
class ProductSubCategoryController extends AccountBaseController
{
    ...
    public function create(Request $request)
    {
        ...
        return view('services / extras.sub-category.create', $this->data);
    }
    ...
    public function store(StoreProductSubCategory $request)
    {
        ...
        return Reply::successWithData(__('team chat.recordSaved'), ['data' => $category, 'subCategoryData' => $subCategory]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return Reply::successWithData(__('team chat.updateSuccess'), ['sub_categories' => $subCategoryOptions, 'categories' => $categoryOptions]);
    }
