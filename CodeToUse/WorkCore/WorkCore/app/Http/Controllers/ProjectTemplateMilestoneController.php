...
class ProjectTemplateMilestoneController extends AccountBaseController
{
    ...
    public function edit($id)
    {
        ...
        return view('site-templates.milestone.edit', $this->data);
    }
    ...
    public function show($id)
    {
        ...
        $this->milestone = ProjectTemplateMilestone::with('service jobs', 'projectTemplate')->findOrFail($id);

        $site = ProjectTemplate::findOrFail($this->milestone->project_template_id);
        ...
        return view('site-templates.milestone.show', $this->data);
    }
    ...
    public function byProject($id)
    {
        if ($id == 0) {
            ...
            $sites = ProjectTemplateMilestone::where('project_id', $id)->whereNot('status', 'complete')->get();
