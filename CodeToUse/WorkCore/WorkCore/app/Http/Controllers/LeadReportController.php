...
class LeadReportController extends AccountBaseController
{
    ...
    public function index()
    {
        ...
        $this->view = 'reports.enquiry.profile';
        ...
        return view('reports.enquiry.index', $this->data);
    }

    public function profile()
    {
        $this->pageTitle = 'modules.enquiry.profile';
        ...
        return $dataTable->render('reports.enquiry.index', $this->data);
    }
    ...
    public function leadContact( )
    {
        ...
        $tab = request('tab');
        $this->activeTab = $tab ?: 'enquiry';

        return $dataTable->render('reports.enquiry.enquiry-report', $this->data);
    ...
    public function totalContact()
    {
        ...
        $totalCount = Enquiry::whereDate('created_at', '>=', $startDate)
    ...
    public function averageDealSizeReport()
    {
        ...
        if ($request->ajax()) {
            $html = view('reports.enquiry.deal-report', ['dealDatas' => $this->dealDatas])->render();
            return response()->json(['datasets' => $datasets, 'html' => $html]);

        } else {
            return view('reports.enquiry.report-chart', $this->data);
        }
    }
