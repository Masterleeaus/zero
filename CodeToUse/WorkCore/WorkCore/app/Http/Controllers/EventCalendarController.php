...
class EventCalendarController extends AccountBaseController
{
    ...
    public function store(StoreEvent $request)
    {
        ...
        return Reply::successWithData(__('team chat.recordSaved'), ['redirectUrl' => $redirectUrl, 'eventId' => $event->id]);
    }
    ...
    public function destroy($id)
    {
        ...
        Event::destroy($id);
        return Reply::successWithData(__('team chat.deleteSuccess'), ['redirectUrl' => route('events.index')]);
    }
