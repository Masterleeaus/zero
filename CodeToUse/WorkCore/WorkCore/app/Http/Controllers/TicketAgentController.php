...
class TicketAgentController extends AccountBaseController
{
    ...
    {
        $this->cleaners = User::join('role_user', 'role_user.user_id', '=', 'users.id')
    ...
    public function store(StoreAgentGroup $request)
    {
        ...
        if (request()->ajax()) {
            ...
            return Reply::successWithData(__('team chat.recordSaved'), ['teamData' => $agentList]);
        }
    ...
    public function destroy($id)
    {
        ...
        return Reply::success(__('team chat.agentRemoveSuccess'));
    }
