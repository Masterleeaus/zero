...
class BankAccountController extends AccountBaseController
{
    ...
    public function store(StoreAccount $request)
    {
        ...
        return Reply::successWithData(__('team chat.recordSaved'), ['redirectUrl' => route('bankaccounts.index')]);
    }
    ...
    public function update(StoreAccount $request, $id)
    {
        ...
        return Reply::successWithData(__('team chat.updateSuccess'), ['redirectUrl' => route('bankaccounts.index')]);
    }
    ...
    public function destroy($id)
    {
        ...
        return Reply::successWithData(__('team chat.deleteSuccess'), ['redirectUrl' => route('bankaccounts.index')]);
    ...
    public function storeTransaction(StoreTransaction $request)
    {
        ...
        return Reply::successWithData(__('team chat.bankTransactionSuccess'), ['redirectUrl' => route('bankaccounts.show', $id)]);
    }
    ...
    public function destroyTransaction(Request $request)
    {
        ...
        return Reply::successWithData(__('team chat.deleteSuccess'), ['redirectUrl' => route('bankaccounts.show', $bankTransaction->bank_account_id)]);
    }
