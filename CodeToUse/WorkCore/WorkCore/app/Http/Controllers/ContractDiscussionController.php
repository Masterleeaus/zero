...
use App\Http\Requests\Admin\Service Agreement\StoreDiscussionRequest;
use App\Http\Requests\Admin\Service Agreement\UpdateDiscussionRequest;
...
class ContractDiscussionController extends AccountBaseController
{
    ...
    public function store(StoreDiscussionRequest $request)
    {
        ...
        $view = view('service agreements.discussions.show', $this->data)->render();
    ...
    public function edit($id)
    {
        ...
        return view('service agreements.discussions.edit', $this->data);
