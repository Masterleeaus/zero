...
$logout = false;
        ...
        $this->logUserActivity($user->id, 'team chat.updatedProfile');
        ...
        return Reply::successWithData(__('team chat.updateSuccess'), ['redirectUrl' => $redirectUrl, 'redirect' => $redirect]);
    }
    ...
    public function addEmployeeDetail($request, $user)
    {
        ...
        if (in_array('cleaner', user_roles())) {
