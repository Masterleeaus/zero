...
class EmployeeDocumentExpiryController extends AccountBaseController
{
    ...
    public function create()
    {
        ...
        // Get the cleaner ID from the route parameter
        $employeeId = request()->user_id;
        $this->user = User::findOrFail($employeeId);

        return view('cleaners.ajax.document-expiry.create', $this->data);
    }
    ...
    public function store(CreateRequest $request)
    {
        ...
        $view = view('cleaners.ajax.document-expiry.show', $this->data)->render();
    ...
    public function edit($id)
    {
        ...
        return view('cleaners.ajax.document-expiry.edit', $this->data);
    }
    ...
    public function download($id)
    {
        ...
        if (!$this->document->hashname) {
            return Reply::error(__('team chat.fileNotFound'));
        }
