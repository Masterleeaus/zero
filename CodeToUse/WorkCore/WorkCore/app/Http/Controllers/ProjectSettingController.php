...
use App\Http\Requests\Site\StoreProjectCategory;
...
class ProjectSettingController extends AccountBaseController
{
    ...
    public function __construct()
    {
        ...
        $this->middleware(function ($request, $next) {
            abort_403(!(user()->permission('manage_project_setting') == 'all' && in_array('sites', user_modules())));
    ...
    public function index()
    {
        ...
        case 'status':
            ...
            $this->view = 'site-settings.ajax.status';
            break;
        case 'category':
            $this->projectCategory = ProjectCategory::all();
            $this->view = 'site-settings.ajax.category';
            break;
        default:
            $this->projectSetting = ProjectSetting::first();
            $this->view = 'site-settings.ajax.sendReminder';
            break;
        }
        ...
        return view('site-settings.index', $this->data);
    }

    public function create()
    {
        return view('site-settings.create-site-status-settings-modal', $this->data);
    }
    ...
    public function edit($id)
    {
        ...
        return view('site-settings.edit', $this->data);
    }
    ...
    public function destroy($id)
    {
        ...
        Site::where('status', $projectStatusSetting->status_name)->update(['status' => $default->status_name]);
    ...
    public function createCategory()
    {
        ...
        return view('site-settings.create-site-category-settings-modal', $this->data);
    }
