...
class LeadFileController extends AccountBaseController
{
    ...
    public function create()
    {
        ...
        return view('enquiries.enquiry-files.create', $this->data);
    }
    ...
    public function store(Request $request)
    {
        ...
        $this->enquiry = Deal::findOrFail($request->lead_id);
    ...
    public function layout(Request $request)
    {
        ...
        $layout = $request->layout == 'listview' ? 'enquiries.enquiry-files.ajax-list' : 'enquiries.enquiry-files.thumbnail-list';
