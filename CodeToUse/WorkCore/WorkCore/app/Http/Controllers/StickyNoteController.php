...
class StickyNoteController extends AccountBaseController
{
    ...
    public function store(StoreStickyNote $request)
    {
        ...
        return Reply::successWithData(__('team chat.recordSaved'), ['redirectUrl' => route('sticky-notes.index')]);
    }
    ...
    public function update(UpdateStickyNote $request, $id)
    {
        ...
        return Reply::successWithData(__('team chat.updateSuccess'), ['redirectUrl' => route('sticky-notes.index')]);
    }

    public function destroy($id)
    {
        StickyNote::destroy($id);
        return Reply::successWithData(__('team chat.deleteSuccess'), ['redirectUrl' => route('sticky-notes.index')]);
    }
