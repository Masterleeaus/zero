...
class EmployeeVisaController extends AccountBaseController
{
    ...
    {
        parent::__construct();
        $this->pageTitle = __('modules.cleaners.visaDetails');
    ...
    public function create()
    {
        ...
        return view('cleaners.ajax.create-visa-modal', $this->data);
    }
    ...
    public function edit($id)
    {
        $this->countries = countries();
        $this->visa = VisaDetail::findOrFail($id);
        return view('cleaners.ajax.edit-visa-modal', $this->data);
    }
