...
class LeadNoteController extends AccountBaseController
{
    ...
    public function index(LeadNotesDataTable $dataTable)
    {
        ...
        return $dataTable->render('enquiry-contact.notes.index', $this->data);
    }
    ...
    public function create()
    {
        ...
        $this->view = 'enquiry-contact.notes.create';
    ...
    public function show($id)
    {
        ...
        $this->pageTitle = __('app.enquiry') . ' ' . __('app.note');
        $this->view = 'enquiry-contact.notes.show';
    ...
    public function store(StoreLeadNote $request)
    {
        ...
        return Reply::successWithData(__('team chat.recordSaved'), ['redirectUrl' => route('enquiry-contact.show', $note->lead_id) . '?tab=notes']);
    }
    ...
    public function edit($id)
    {
        ...
        abort_403(!($editClientNotePermission == 'all'
            ...
            || ($editClientNotePermission == 'owned' && in_array(user()->id, $memberIds) && in_array('cleaner', user_roles()))
        ...
        $this->view = 'enquiry-contact.notes.edit';
    ...
    public function update(StoreLeadNote $request, $id)
    {
        ...
        return Reply::successWithData(__('team chat.updateSuccess'), ['redirectUrl' => route('enquiry-contact.show', $note->lead_id) . '?tab=notes']);
    }
    ...
    public function destroy($id)
    {
        ...
        abort_403(!($this->deletePermission == 'all'
            ...
            || ($this->deletePermission == 'owned' && in_array(user()->id, $memberIds) && in_array('cleaner', user_roles()))
    ...
    {
        $this->note = LeadNote::findOrFail($id);
        return view('enquiry-contact.notes.verify-password', $this->data);
    }
