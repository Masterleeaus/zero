...
use App\Http\Requests\Admin\Cleaner\StoreEmergencyContactRequest;
...
class EmergencyContactController extends AccountBaseController
{
    ...
    public function store(StoreEmergencyContactRequest $request)
    {
        ...
        return Reply::successWithData(__('team chat.employeeEmergencyContact'), ['html' => $html]);
    }
    ...
    public function destroy(EmergencyContact $emergencyContact)
    {
        ...
        return Reply::successWithData(__('team chat.deleteSuccess'), ['redirectUrl' => route('profile-settings.index').'?tab=emergency-contacts']);
    }
