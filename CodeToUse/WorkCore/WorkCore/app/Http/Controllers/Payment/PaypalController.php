...
class PaypalController extends Controller
{
     ...
     *
     * @return \Illuminate\Service Agreements\Foundation\Application|\Illuminate\Service Agreements\View\Factory|\Illuminate\Service Agreements\View\View|\Illuminate\Foundation\Application
     */
    ...
    private function makePaypalPayment($id, $redirectRoute, $type = null)
    {
        ...
        try {
            ...
            if (\Config::get('app.debug')) {
                ...
                Session::put('error', __('team chat.errorOccured'));

                return Redirect::to($redirectRoute);
                /** die(__('team chat.errorOccured')); **/
            }
        }
    ...
    public function getPaymentStatus(Request $request)
    {
        ...
        if (empty($request->PayerID) || empty($request->token)) {
            Session::put('error', __('team chat.paymentFailed'));
