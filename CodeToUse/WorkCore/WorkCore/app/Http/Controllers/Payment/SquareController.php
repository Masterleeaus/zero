...
class SquareController extends Controller
{
    ...
    public function paymentWithSquarePublic(Request $request)
    {
        ...
        default:
            return Reply::error(__('team chat.paymentTypeNotFound'));
        }
        ...
        try {
            $checkout_api = $customer->getCheckoutApi();

            // Set currency to the currency for the location
            $currency = $customer->getLocationsApi()->retrieveLocation($location_id)->getResult()->getLocation()->getCurrency();
    ...
    public function handleGatewayCallback(Request $request, $id, $type, $companyHash)
    {
        ...
        try {
            ...
            $order_api = $customer->getOrdersApi();
