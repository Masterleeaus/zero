...
class StripeWebhookController extends Controller
{
    ...
    public function verifyStripeWebhook(Request $request, $companyHash)
    {
        ...
        try {
            ...
            // Invalid payload
            return response(__('team chat.invalidPayload'), 400);
        } catch (SignatureVerificationException $e) {
            // Invalid signature
            return response(__('team chat.invalidSignature'), 400);
        }
        ...
        if ($payload['data']['object']['status'] != 'succeeded') {
            ...
            return response(__('team chat.paymentFailed'), 400);
        }
        ...
        return response(__('team chat.webhookHandled'), 200);
    }
