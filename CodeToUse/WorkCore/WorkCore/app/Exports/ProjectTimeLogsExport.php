...
use Carbon\Carbon;
use Illuminate\Service Agreements\Support\Responsable;
...
class ProjectTimeLogsExport implements FromCollection, WithHeadings, WithMapping, ShouldAutoSize, WithColumnFormatting, WithStyles, Responsable
{
     ...
     * @var string
     */
    public string $fileName = 'site-time-logs.xlsx';
    ...
    public function collection()
    {
        ...
        $query = ProjectTimeLog::query()
            ...
            ->with(['user', 'activeBreak', 'site', 'service job'])
    ...
    public function map($log): array
    {
        ...
        $row = [
            ...
            optional($log->site)->project_short_code,
            optional($log->service job)->heading,
            optional($log->site)->project_name,
            $start,
            $end,
