...
class BirthdayReminderCommand extends Command
{
     ...
     * all cleaners with an upcoming birthday and triggers the "BirthdayReminderEvent".
     */
    public function handle()
    {
        ...
        Company::active()->select('id')->chunk(50, function ($companies) use ($currentDay) {
            ...
            foreach ($companies as $company) {
                // Retrieve all active cleaners with an upcoming birthday for the current company
                ...
                // If there is any cleaner with an upcoming birthday, trigger the "BirthdayReminderEvent"
