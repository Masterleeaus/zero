...
class FixUpgradeCompanyCommand extends Command
{
    ...
    public function handle()
    {
        ...
        foreach ($companies as $company) {
            ...
            // Retrieve the first cleaner shift record with the company id
        ...
        // hash add all invoices, sites, etc
        $this->hashGenerate();
    ...
    private function logoUpdate()
    {
        ...
        if(!Schema::hasColumns('service agreements', ['contract_note', 'cell', 'office'])) {
            DB::statement('UPDATE `service agreements` SET contract_note=description,cell=mobile,office=office_phone');
        }
    ...
    {
        $tableNames = ['quotes', 'invoices', 'sites', 'enquiries', 'proposals', 'service agreements'];
