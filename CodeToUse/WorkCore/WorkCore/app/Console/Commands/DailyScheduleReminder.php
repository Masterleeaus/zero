...
class DailyScheduleReminder extends Command
{
     ...
     * @var string
     */
    protected $description = 'send the daily updates to cleaners about their service jobs, leaves, holidays, events and interviews';
    ...
    public function handle()
    {
        ...
        foreach ($companyIds as $companyId) {
            ...
            $users = User::withRole('cleaner')
                ->with([
                    'company',
                    'service jobs' => function ($query) use ($completedTaskColumn) {
            ...
            foreach ($users as $user) {
                ...
                $data[$user->id]['service jobs'] = $user->service jobs->count();
