...
class SendEmployeeDocumentExpiryAlert extends Command
{
     ...
     * @var string
     */
    protected $signature = 'send-cleaner-document-expiry-alert';
     ...
     * @var string
     */
    protected $description = 'Send alerts for cleaner documents that are expiring soon';
    ...
    {
        $this->info('Starting cleaner document expiry alert process...');
        ...
        $this->info('Cleaner document expiry alert process completed.');
