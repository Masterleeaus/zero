...
return array(
    ...
    'autoClockOut' => 'Enter no of hours from the end time after which cleaner will be auto clocked out. <br><br><b>Example:</b> If shift end time is 6 PM and auto clockout value is 1 then cleaner will be auto clocked out at 7 PM.<br><br><b>Note</b>: Auto clock out will not work if allow clock-in outside shift hours is checked in attendance settings.',
    'flexibleAutoClockOut' => 'Enter no of hours after which cleaner will be auto clocked out. <br><br><b>Example:</b> If total shift hours are 8 hours and auto clockout value is 1 then cleaner will be auto clocked out after 9 Hours.',
    ...
    'viewCleanerMenuTooltip' => 'This permission controls whether the Cleaner menu is visible or hidden. <br><b>All</b> = Show the menu (Visible) <br><b>None</b> = Hide the menu (Not visible)',
    'service jobTimerRunning' => 'Service Job timer is Active',
    'timerOkay' => 'Okay',
    'enterAtLeastOneHour' => 'Please enter at least one hour/min.',
    'stopTheTimer' => 'Service Jobs with active timer cannot be removed.',
    'confirm' => 'Confirm',
    'exitDateErrorForPast' => 'If you try to activate, you need to remove the exit date; otherwise, the cleaner will become inactive the next day (:date). Because the exit date is older than today.',
    'exitDateErrorForFuture' => 'If you will try to active, you need to remove the exit date; otherwise, the cleaner will become inactive the next day (:date).',
    'approvalmsgsent' => 'This service job requires approval from the site administrator before being marked as complete. Please send the service job for approval to the site administrator.',
    'youCannotMoveService Job' => 'You cannot move this service job to the selected status.',
    'markAsPaid' => 'Invoice amount is zero, it will be marked as paid.',
    'siteCodeRequired' => 'Site short code field is required.',
    'changeLeaveStatusConfirmation' => 'Do you want to change leave status.',
    'fristSignAndQrCodeError' => 'Auto clock-in cleaner by first sign in and QR Code cannot be turned ON at the same time.',
    'qrCodeAndFirstSignError' => '\'QR Code\' and \'Auto clock-in cleaner by first sign in\' cannot be enabled simultaneously. To enable QR Code, please first disable \'Auto Clock-In by First Sign-In\'.',
    'updateSuccess' => 'Updated successfully.',
    'siteService JobsNotCompleted' => 'Please complete the service jobs of site.',
    ...
    'customerContactMsg' => 'If customer Contact is selected then the issue / support is generated for customer contact not for the customer. If customer contact value is NULL, then issue / support will assign to the selected customer.',
    ...
    'newService JobAddedToTheSite' => 'New service job added to the site.',
    ...
    'leadCustomerChangeSuccess' => 'Enquiry changed in customer successfully.',
    ...
    'newFileUploadedToTheSite' => 'New file uploaded to the site.',
    'isAddedAsSiteMember' => 'is added as a site member.',
    'memberRemovedFromSite' => 'Member removed from site successfully.',
    'milestoneSuccess' => 'Milestone saved successfully.',
    'addedAsNewSite' => 'added as a new site.',
    'siteArchiveSuccessfully' => 'Site archived successfully.',
    'archiveSuccess' => 'Leave type archived successfully.',
    'restoreSuccess' => 'Leave type reverted successfully.',
    'siteRevertSuccessfully' => 'Site reverted successfully.',
    'noMemberAddedToSite' => 'No member added to this site.',
    'issue / supportReplySuccess' => 'Reply sent successfully.',
    ...
    'recurringExpenseBillingCycleMin' => 'Already :count recurring expense(s) have been created. Please enter :count or more.',
    'chooseSite' => 'Choose a site.',
    'noRecordFound' => 'No record found.',
    'noDocumentExpiries' => 'No upcoming document expiries.',
    ...
    'cleanerDocsAllowedFormat' => 'Allowed file formats: jpg, png, gif, doc, docx, xls, xlsx, pdf, txt.',
    'noFileUploaded' => 'No file uploaded.',
    'noLeadSourceAdded' => 'No enquiry source added.',
    'noLeadStatusAdded' => 'No enquiry status added.',
    'noCustomField' => 'No Custom Field added.',
    'selectMultipleDates' => 'You can select multiple dates.',
    'sweetAlertTitle' => 'Are you sure?',
    'unArchiveMessage' => 'Do you want to restore this site.',
    ...
    'confirmNo' => 'No, please!',
    'archiveMessage' => 'Do you want to archive this site.',
    'confirmArchive' => 'Yes, archive it!',
    'noInvoice' => 'No invoice created.',
    'noCustomerAddedToSite' => 'No customer assigned to the site.',
    'noAgentAdded' => 'No agent added.',
    'noPaymentAdded' => 'No payment added.',
    'noTemplateFound' => 'No template found.',
    'noIssue / SupportTypeAdded' => 'No issue / support type added.',
    'paymentTypeNotFound' => 'Payment Type Not Found',
    'noSubService JobFound' => 'Seems like no sub service job exists in the database. Please create the sub service job first',
    'noActivityByThisUser' => 'No activity by the user.',
    'noCustomerAdded' => 'No customer added.',
    ...
    'sitePin' => 'You want to pin this site!',
    ...
    'removeIssue / SupportText' => 'This will remove the issue / support type from the list.',
    'issue / supportText' => 'You will not be able to recover the deleted issue / support!',
    ...
    'removeLead' => 'This will remove the enquiry status from the list.',
    ...
    'deleteService / Extra' => 'You will not be able to recover the deleted service / extra!',
    'deleteService Job' => 'You will not be able to recover the deleted service job!',
    'markCompleteService Job' => 'There is an incomplete sub-service job in this service job do you want to mark complete!',
    'sendApprovalService Job' => 'Do you want to send approval for this service job to admin?',
    'approvalmsg' => 'You will not be able to make any changes to the service job till the service job is reviewed.',
    'sendReminder' => 'Do you want to send a reminder to the assigned cleaner?',
    ...
    'zoneUniq' => 'The zone name has already been taken.',
    'unitTypeAdded' => 'Unit Type Added Successfully',
    'quoteTemplateDeleted' => 'Quote Template Deleted',
    'quoteTemplateCreated' => 'Quote Template Created',
    'quoteTemplateUpdated' => 'Quote Template Updated',
    'customerFinanceCount' => 'This customer have :siteCount :site, :invoiceCount :invoice, :quoteCount :quote, :paymentCount :payment . ',
    ...
    'issue / supportCreateSuccess' => 'Issue / Support created successfully.',
    ...
    'customerFilterVerification' => 'Customer filter according verification',
    'fileMessage' => 'The Team Chat Item field is requried',
    ...
    'addDiscussion' => 'Team Chat Item sent successfully.',
    ...
    'noLeadAgentAdded' => 'No enquiry agent added.',
    'selectService / Extra' => 'Please select at least one service / extra.',
    'noLeadAgent' => 'No Enquiry Agent Found',
    ...
    'cleanerLeaveQuota' => 'No of leaves should be greater than or equal to Zero and should be greater than leaves taken',
    ...
    'service jobAfterDateValidation' => 'Service Job end date should not be less than the service job start date',
    'service jobBeforeDateValidation' => 'Service Job end date should not be greater than the milestones end date',
    'selectAnotherStatus' => 'The service job cannot be stored with this status when no site is selected. Please select another status.',
    'selectStatus' => 'The selected site does not require approval from admin or site admin, so you cannot select the this status. Please select another status.',
    'noService / ExtraSubCategoryAdded' => 'No service / extra sub-category added.',
    'pinnedSuccess' => 'Pinned successfully',
    'noInvoiceFound' => 'Seems like no invoice has been generated.',
    'noCustomerFound' => 'Seems like no customer exists. Please create the customer first',
    'noService JobFound' => 'Seems like no service job exists. Please create the service job first',
    'noService JobFilesFound' => 'Seems like no service job files uploaded.',
    'noCleanersFound' => 'Seems like no cleaners exist. Please create the cleaner first',
    'noQuotesFound' => 'Seems like no quotes exist. Please create the quote first',
    ...
    'noIssues / SupportFound' => 'Seems like no issues / support exist.',
    'noLeadFound' => 'Seems like no enquiries exist. Please create the enquiries first',
    'noNoticeFound' => 'Seems like no notice exists.',
    'noLeavesFound' => 'Seems like no leaves exist.',
    'noSiteAssigned' => 'No site assigned to you.',
    ...
    'quoteCancelText' => 'Do you want to cancel this quote!',
    ...
    'contractRenewSuccess' => 'Service Agreement renewed successfully.',
    'signatureRequired' => 'Signature is required.',
    'quoteSigned' => 'Quote accepted successfully.',
    'adminPermissionError' => 'Admin permissions cannot be changed.',
    'newCleanerInfo' => 'According to date of joining.',
    'leaveInfo' => 'According to date of leave.',
    'cleanerExitInfo' => 'According to date of exit.',
    'unresolveIssue / SupportInfo' => 'Issues / Support with status Pending or Open.',
    'unassignIssue / SupportInfo' => 'Issues / Support which are not assigned to an agent.',
    ...
    'inviteInfo' => 'Cleaners will receive an Email to log in and update their profile through the self-service portal.',
    'service jobDependentDate' => 'Dependent service job due date cannot be in future.',
    'assignCustomerFirst' => 'You need to assign a customer to the site.',
    ...
    'resolveIssue / SupportInfo' => 'Issues / Support with status Closed or Resolved.',
    ...
    'siteDetailsNotAdded' => 'Site details not added.',
    'inviteLinkCopied' => 'Invite Link Copied.',
    'unsentInvoiceInfo' => 'The Invoice cannot be paid until the invoice is sent to the customer.',
    'selectCustomerForBillingAddress' => 'Select the customer to show billing address.',
    'invoicesWidgetMessage' => 'Invoices are shown based on date of creation of invoices.',
    'quotesWidgetMessage' => 'Quotes are shown based on due date of quotes.',
    ...
    'proposalInfo' => 'Proposals are for Enquiries. If you want to create for existing customers, then create Quote.',
    ...
    'unitDeleteError' => 'You cannot delete this unit as it is associated with finance and service / extra items. Dissociate the unit from all items and try again.',
    'fileFormat' => array(
    ...
    'downloadable' => 'Downloadable service / extra gives access to a file upon purchase',
    'invalidData' => 'Invalid Data : ',
    'invalidDate' => 'Invalid Date Format : ',
    'duplicateEntryForEmail' => 'Duplicate Entry for Email : ',
    'duplicateEntryForCleanerId' => 'Duplicate Entry for Cleaner ID : ',
    ...
    'cleanerEmergencyContact' => 'Emergency contact saved successfully.',
    ...
    'cleanerShiftAdded' => 'Cleaner Shift Saved.',
    'removeShiftText' => 'All the cleaners related to this shift will be moved to the default shift.',
    ...
    'siteTimeExceeded' => 'Site time limit has been reached or you have not allocated any time to the site',
    'siteTimeLimitExceeded' => 'Time log exceeds remaining site time. Only :remaining remaining.',
    'siteTimeReached' => 'Site time limit has been reached. Timer stopped automatically.',
    'archivedService JobNotWork' => 'You will not be able to act on archived site service jobs.',
    'totalCleanerInfo' => 'Total cleaners in the company. Date filter not applied.',
    ...
    'recoverAwardRecord' => 'You have :cleanerCount cleaners awarded by this award. You will not be able to recover the deleted cleaners awarded record!',
    ...
    'contractMessage' => 'Service Agreement Ends On',
    'probationEndDate' => "Enter the end date when the cleaner's probation is going to end and he/she is going to be the part of company permanently",
    'noticePeriodStartDate' => 'Enter the start date when an cleaner is going to be in the notice period before leaving the company',
    'noticePeriodEndDate' => 'If the notice period date is in the future, the cleaner will automatically be marked as inactive on that date, and if the exit date is empty, it will be filled accordingly.',
    'lastDateTooltip' => 'If the exit date is in the future, the cleaner will be automatically marked inactive on that date. And if the exit date is in the past and the cleaner is set as active, they will be marked inactive by the next cron job.',
    ...
    'sendMonthlyReportTooltip' => 'The email will include the attendance details of all cleaners for the selected month.',
    ...
    'siteCopiedSuccessfully' => 'Site Copied Successfully',
    ...
    'leadStatusChangeSuccess' => 'Enquiry Status Change Successfully',
    'calculateService JobProgress' => 'We calculate progress on service job completion',
    ...
    'markSentInfo' => 'Customer will not receive any email.',
    'enableCustomerModule' => 'Enable Customer Module to access this section.',
    ...
    'leave' => array(
        'noOfYearlyLeaves' => 'This field is designated to set the number of leaves provided to cleaners annually. ',
        'noOfMonthlyLeaves' => ' This field is designated to set the number of leaves provided to cleaners for a month.',
        'allowedNotice' => 'Check this if you want to allow cleaners in the <b>Notice Period</b> to apply for leaves of this type.',
        'allowedProbation' => 'Check this if you want to allow cleaners in the <b>Probation</b> to apply for leaves of this type.',
        'unusedLeave' => 'Determines how the unused leaves are treated at the end of the year.<br><br><b>Carry Forward</b>: Unused leaves will be added to next year leaves.<br><br><b>Lapse</b>: Unused leaves will simply lapse and no action will be taken.<br><br><b>Paid</b>: Cleaner will be paid salary of the number of days equivalent of unused leaves.<br><br><b>Note</b>: This will not change after creating the leave type.',
        'effectiveAfter' => 'This leave type will be effective after the number of days or the number of month of cleaner\'s joining. <br><br>Leave blank to allow from date of joining.',
        'gender' => 'Leave Type can only be used by selected <b>Gender</b> cleaners and other cleaners will not be able to apply for leaves with this leave type',
        'maritalStatus' => 'Leave Type can only be used by selected <b>Marital Status</b> cleaners and other cleaners will not be able to apply for leaves with this leave type',
        'zone' => 'Leave Type can only be used by selected <b>Zone</b> cleaners and other cleaners will not be able to apply for leaves with this leave type',
        'role' => 'Leave Type can only be used by selected <b>Role</b> cleaners and other cleaners will not be able to apply for leaves with this leave type',
        ...
        'noOfLeaves' => 'Number of leaves of this type given to each cleaner per year. For example, your company may give 10 sick leaves per year',
        'monthlyLimit' => 'The maximum number of leaves of this type an cleaner can take per month.',
        'paidStatus' => 'This leave type will be paid or unpaid for all the cleaners',
    ...
    'noIssue / SupportChannelAdded' => 'No Issue / Support Channel Added',
    ...
    'customerSignUpDisabledByAdmin' => 'Customer sign up is disabled by admin.',
    'cantAddFollowup' => 'You can not add followup. If deal is win or lost.',
    'lowerValue' => 'Enter lower value than',
    'leaveTypeNotAllowed' => 'Leave type not allowed for this cleaner.',
    ...
    'unassignedService Job' => 'The site :has :unassigned unassigned :service job. To show unassigned :service job',
    'addShift' => 'Add at-least 1 shift in rotation sequence.',
    'rotationStatusChanged' => 'Rotation status changed successfully',
    'cleanerRotationChanged' => 'Rotation changed successfully',
    'cleanerRemoveSuccess' => 'Cleaner removed successfully from rotation.',
    'rotationNotFound' => 'Rotation not found',
    'fileNotFound' => 'File not found',
    'automateShiftAdded' => 'Automate Shift Saved.',
    'rotationEmpRemove' => 'Do you really want to remove cleaner from rotation!',
    ...
    'totalShiftHours' => 'These are the minimum hours required by cleaner to clockin in a day for full attendance.',
    'halfdayShiftHours' => 'These are the minimum hours required by cleaner to clockin in a day for half day attendance. If clocked hours are less than half day hours than absent will be marked.',
    ...
    'SelectaRole' => 'Select a current role.',
    'SelectaZone' => 'Select a current zone.',
