<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.sites.editMilestone')</h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
            aria-hidden="true">×</span></button>
</div>
<x-form id="addProjectMilestoneForm" method="PUT">
    <div class="modal-body">
        <input type="hidden" name="project_id" value="{{ $milestone->project_template_id }}">
...
$(document).ready(function() {
    ...
    $('#save-site-milestone').click(function() {
        var url = "{{ route('site-template-milestone.update', $milestone->id) }}";
        $.easyAjax({
            url: url,
