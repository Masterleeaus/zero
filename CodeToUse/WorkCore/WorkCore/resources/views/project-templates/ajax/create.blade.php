                        ...
                        <div class="form-group">
                            <div class="d-flex mt-3">
                                <x-forms.checkbox fieldId="manual_timelog"
                                                  :fieldLabel="__('modules.sites.manualTimelog')" fieldName="manual_timelog" />
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-site-form').click(function() {
            ...
            const url = "{{ route('site-template.store') }}";
            var data = $('#save-site-data-form').serialize();
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    window.location.href = "{{ route('site-template.index') }}";
                }
            });
        });
