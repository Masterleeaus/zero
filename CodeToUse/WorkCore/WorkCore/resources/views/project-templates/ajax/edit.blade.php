        ...
        <x-form id="save-site-data-form" method="PUT">
            <div class="add-customer bg-white rounded">
                ...
                <div class="row p-20">
                    <div class="col-md-4">
                        <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.sites.projectName')"
                            ...
                            :fieldValue="$template->project_name" :fieldPlaceholder="__('placeholders.site')" />
                    </div>
                    ...
                    <div class="col-md-4">
                        <x-forms.label class="mt-3" fieldId="sub_category_id"
                            :fieldLabel="__('modules.customer.projectSubCategory')"></x-forms.label>
                        <x-forms.input-group>
                        ...
                        <div class="form-group">
                            <div class="d-flex mt-3">
                                <x-forms.checkbox fieldId="manual_timelog"
                                                  :fieldLabel="__('modules.sites.manualTimelog')" :checked="($template->manual_timelog
                    ...
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            <x-forms.label class="my-3" fieldId="notes" :fieldLabel="__('modules.sites.note')">
                            </x-forms.label>
                ...
                <x-form-actions>
                    ...
                    <x-forms.button-cancel :link="route('site-template.index')" class="border-0">@lang('app.cancel')
...
<script>
    $(document).ready(function() {
        ...
        $('#save-site-form').click(function() {
            ...
            const url = "{{ route('site-template.update', $template->id) }}";
