...
@section('filter-section')
    <x-filters.filter-box>
        ...
        <div class="service job-search d-flex pr-lg-2 py-1 px-0 border-right-grey align-items-center">
        ...
        <x-filters.more-filter-box>
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 " for="usr">@lang('app.menu.role')</label>
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if ($addDesignationPermission == 'all' || $addDesignationPermission == 'added')
                    <x-forms.link-primary :link="route('roles.create')" class="mr-3 openRightModal float-left"
                                          icon="plus">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group" aria-label="Basic example">
                <a href="{{ route('roles.index') }}" class="btn btn-secondary f-14 btn-active"
                   data-toggle="tooltip"
                   data-original-title="@lang('modules.leaves.tableView')"><i class="side-icon bi bi-list-ul"></i></a>

                <a href="{{ route('role.hierarchy') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
...
@push('scripts')
    ...
    <script>
        $('#Role-table').on('preXhr.dt', function (e, settings, data) {
        ...
        const showTable = () => {
            window.LaravelDataTables["Role-table"].draw(true);
        }
        ...
        const applyQuickAction = () => {
            const rowdIds = $("#Role-table input:checkbox:checked").map(function () {
                return $(this).val();
            }).get();

            const url = "{{ route('roles.apply_quick_action') }}?row_ids=" + rowdIds;
