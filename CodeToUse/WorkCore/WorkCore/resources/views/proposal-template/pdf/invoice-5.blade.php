...
<head>
    ...
    <!-- Template CSS -->
    <title>@lang('modules.enquiry.proposalTemplate') - {{ $proposalTemplate->id }}</title>
        ...
        <tbody>
            ...
            <tr>
                <td><img src="{{ invoice_setting()->logo_url }}" alt="{{ $invoiceSetting->company->company_name }}"
                        id="logo" /></td>
                <td align="right" class="f-21 text-black font-weight-700 text-uppercase">@lang('modules.enquiry.proposalTemplate')
                </td>
            </tr>
            <!-- Table Row End -->
            <!-- Table Row Start -->
            <tr>
                ...
                <td>
                    <table class="text-black mt-1 f-13 b-collapse rightaligned">
                        <tr>
                            <td class="heading-table-left">@lang('modules.enquiry.proposalTemplate')</td>
