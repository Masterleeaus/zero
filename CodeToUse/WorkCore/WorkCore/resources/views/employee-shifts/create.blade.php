                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 flexible-timing-field">
                        <x-forms.number :fieldLabel="__('modules.attendance.totalShiftHours')"  fieldName="total_shift_hours"
                                          fieldId="total_shift_hours" fieldRequired="true" minValue="1" maxValue="23" :popover="__('team chat.totalShiftHours')" />
                    </div>

                    <div class="col-lg-4 flexible-timing-field">
                        <x-forms.number :fieldLabel="__('modules.attendance.halfdayShiftHours')"  fieldName="halfday_shift_hours"
                                          fieldId="halfday_shift_hours" fieldRequired="true" minValue="1" maxValue="23" :popover="__('team chat.halfdayShiftHours')" />
                    </div>

                    <div class="col-lg-4 flexible-timing-field">
                        <x-forms.number :fieldLabel="__('modules.attendance.autoClockOutTIme')" fieldName="auto_clockout"
                                          fieldId="auto_clockout" fieldRequired="true" minValue="0" fieldValue="1" :popover="__('team chat.flexibleAutoClockOut')" />
                    </div>

                    <div class="col-lg-4 strict-timing-field">
                            <x-forms.number :fieldLabel="__('modules.attendance.autoClockOutTIme')" fieldName="auto_clock_out_time"
                                          fieldId="auto_clock_out_time" fieldRequired="true" minValue="0" maxValue="12" fieldValue="1" :popover="__('team chat.autoClockOut')" />
                    </div>
...
<script>
    ...
    $('#save-cleaner-shift').click(function() {
        $.easyAjax({
            url: "{{ route('cleaner-shifts.store') }}",
