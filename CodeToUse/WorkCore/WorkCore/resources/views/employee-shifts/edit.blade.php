                ...
                <div class="row">
                    ...
                    <div class="col-lg-4 flexible-timing-field">
                        <x-forms.number :fieldLabel="__('modules.attendance.totalShiftHours')"  fieldName="total_shift_hours"
                                          fieldId="total_shift_hours" fieldRequired="true" minValue="1" maxValue="23" :fieldValue="$employeeShift->flexible_total_hours" :popover="__('team chat.totalShiftHours')" />
                    </div>

                    <div class="col-lg-4 flexible-timing-field">
                        <x-forms.number :fieldLabel="__('modules.attendance.halfdayShiftHours')"  fieldName="halfday_shift_hours"
                                          fieldId="halfday_shift_hours" fieldRequired="true" minValue="1" maxValue="23" :fieldValue="$employeeShift->flexible_half_day_hours" :popover="__('team chat.halfdayShiftHours')" />
                    </div>

                    <div class="col-lg-4 flexible-timing-field">
                        <x-forms.number :fieldLabel="__('modules.attendance.autoClockOutTIme')" fieldName="auto_clockout"
                                          fieldId="auto_clock_out_time" fieldRequired="true" minValue="0" :fieldValue="$employeeShift->flexible_auto_clockout" :popover="__('team chat.flexibleAutoClockOut')" />
                    </div>
                    ...
                    <div class="col-lg-4 strict-timing-field">
                        <div class="bootstrap-timepicker">
                            <x-forms.number :fieldLabel="__('modules.attendance.autoClockOutTIme')" :fieldPlaceholder="__('placeholders.hours')" fieldName="auto_clock_out_time"
                                          fieldId="auto_clock_out_time" fieldRequired="true" :fieldValue="$employeeShift->auto_clock_out_time"  minValue="1" maxValue="12" :popover="__('team chat.autoClockOut')" />
                        </div>
                    </div>
...
<div class="modal-footer">
    ...
    <x-forms.button-primary id="save-cleaner-shift" icon="check">@lang('app.save')</x-forms.button-primary>
</div>
...
<script>
    ...
    // save type
    $('#save-cleaner-shift').click(function() {
        $.easyAjax({
            url: "{{ route('cleaner-shifts.update', $employeeShift->id) }}",
            container: '#createTicket',
            type: "POST",
            blockUI: true,
            blockUI: '#save-cleaner-shift',
            disableButton: true,
