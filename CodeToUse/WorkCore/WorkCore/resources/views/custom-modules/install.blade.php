                ...
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <x-forms.file-multiple
                            ...
                            :fieldLabel=" __('team chat.downloadFilefromCodecanyon') " fieldName="file"
...
@push('scripts')
    <script>
        ...
        $('.install-files').click(function () {
            ...
            $('#install-process').html('<div class="alert alert-primary">@lang("team chat.installingUpdateMessage")</div>');
            ...
            $.easyAjax({
                ...
                success: function (response) {
                    ...
                    if (response.status === 'success') {
                        $.easyBlockUI('body')
                        $('#install-process').html(`<div class="alert alert-success">@lang('team chat.customModuleInstalled')</div>`);
