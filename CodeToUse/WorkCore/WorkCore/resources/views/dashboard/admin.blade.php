...
@section('filter-section')
    ...
    <div class="d-flex filter-box site-header bg-white dashboard-header">
        ...
        <div class="site-menu d-lg-flex" id="mob-customer-detail">
            ...
            @if ($viewOverviewDashboard == 'all')
                <x-tab :href="route('dashboard.advanced').'?tab=overview'" :text="__('modules.sites.overview')"
                       class="overview" ajax="false"/>
            @endif

            @if (in_array('sites', user_modules()) && $viewProjectDashboard == 'all')
                <x-tab :href="route('dashboard.advanced').'?tab=site'" :text="__('app.site')" class="site"
                       ajax="false"/>
            @endif

            @if (in_array('customers', user_modules()) && $viewClientDashboard == 'all')
                <x-tab :href="route('dashboard.advanced').'?tab=customer'" :text="__('app.customer')" class="customer"
                       ajax="false"/>
            @endif

            @if ($viewHRDashboard == 'all' && (in_array('cleaners', user_modules()) || in_array('leaves', user_modules()) || in_array('attendance', user_modules())))
                <x-tab :href="route('dashboard.advanced').'?tab=hr'" :text="__('app.menu.hr')" class="hr" ajax="false"/>
            @endif

            @if (in_array('issues / support', user_modules()) && $viewTicketDashboard == 'all')
                <x-tab :href="route('dashboard.advanced').'?tab=issue / support'" :text="__('app.menu.issue / support')" class="issue / support"
                       ajax="false"/>
            @endif

            @if ($viewFinanceDashboard == 'all' && (in_array('invoices', user_modules()) || in_array('quotes', user_modules()) || in_array('enquiries', user_modules())))
