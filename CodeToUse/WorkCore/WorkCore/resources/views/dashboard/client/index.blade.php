...
@section('content')
    ...
    <div class="px-4 py-0 py-lg-4  border-top-0 admin-dashboard">
        <div class="row">
            @if (in_array('sites', user_modules()))
                <div class="col-xl-4 col-lg-6 col-md-6 mb-4">
                    <a href="{{ route('sites.index') }}?status=all">
            ...
            @if (in_array('issues / support', user_modules()))
                <div class="col-xl-4 col-lg-6 col-md-6 mb-4">
                    <a href="{{ route('issues / support.index') }}">
                        <x-cards.widget :title="__('modules.dashboard.totalUnresolvedTickets')"
                                        :value="floor($counts->totalUnResolvedTickets)" icon="issue / support-alt"/>
                    </a>
                </div>
            @endif

            @if (in_array('service agreements', user_modules()))
                <div class="col-xl-4 col-lg-6 col-md-6 mb-4">
                    <a href="{{ route('service agreements.index') }}?signed=yes">
        ...
        <div class="row">
            ...
            @if (in_array('sites', user_modules()) && $viewMilestonePermission != 'none')
                <div class="col-sm-12 col-lg-6 mt-4">
