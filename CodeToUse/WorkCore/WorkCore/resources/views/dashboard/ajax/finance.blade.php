...
<div class="row">
    <div class="col-md-12">
        <x-alert type="secondary" icon="info-circle">
            @lang('team chat.earningChartNote') ({{ company()->currency->currency_code }})
        </x-alert>
    </div>
</div>
...
<div class="row">
    @if (in_array('invoices', user_modules()) && in_array('invoice_overview', $activeWidgets))
        <div class="col-sm-12 col-lg-6 mt-4">
            <x-cards.data
                :title="__('modules.dashboard.invoiceOverview').' <i class=\'fa fa-question-circle\' data-toggle=\'popover\' data-placement=\'top\' data-content=\''.__('team chat.invoicesWidgetMessage').'\' data-trigger=\'hover\'></i>'">
                @if (array_sum($invoiceOverviewChartData['values']) > 0)
                    <a href="javascript:;" class="text-darkest-grey f-w-500 piechart-full-screen" data-chart-id="service job-chart1" data-chart-data="{{ json_encode($invoiceOverviewChartData) }}"><i class="fas fa-expand float-right mr-3"></i></a>
                @endif
                <x-pie-chart id="service job-chart1" :labels="$invoiceOverviewChartData['labels']"
    ...
    @if (in_array('quotes', user_modules()) && in_array('estimate_overview', $activeWidgets))
        <div class="col-sm-12 col-lg-6 mt-4">
            <x-cards.data
                :title="__('modules.dashboard.estimateOverview').' <i class=\'fa fa-question-circle\' data-toggle=\'popover\' data-placement=\'top\' data-content=\''.__('team chat.estimatesWidgetMessage').'\' data-trigger=\'hover\'></i>'">
                @if (array_sum($estimateOverviewChartData['values']) > 0)
                    <a href="javascript:;" class="text-darkest-grey f-w-500 piechart-full-screen" data-chart-id="service job-chart2" data-chart-data="{{ json_encode($estimateOverviewChartData) }}"><i class="fas fa-expand float-right mr-3"></i></a>
                @endif
                <x-pie-chart id="service job-chart2" :labels="$estimateOverviewChartData['labels']"
    ...
    @if (in_array('enquiries', user_modules()) && in_array('proposal_overview', $activeWidgets))
        <div class="col-sm-12 col-lg-6 mt-4">
            <x-cards.data
                :title="__('modules.dashboard.proposalOverview').' <i class=\'fa fa-question-circle\' data-toggle=\'popover\' data-placement=\'top\' data-content=\''.__('team chat.proposalsWidgetMessage').'\' data-trigger=\'hover\'></i>'">
                @if (array_sum($proposalOverviewChartData['values']) > 0)
                    <a href="javascript:;" class="text-darkest-grey f-w-500 piechart-full-screen" data-chart-id="service job-chart3" data-chart-data="{{ json_encode($proposalOverviewChartData) }}"><i class="fas fa-expand float-right mr-3"></i></a>
                @endif
                <x-pie-chart id="service job-chart3" :labels="$proposalOverviewChartData['labels']"
    ...
    @if (in_array('payments', user_modules()) && in_array('earnings_by_client', $activeWidgets))
        <div class="col-sm-12 col-lg-6 mt-4">
            <x-cards.data
                ...
                <x-bar-chart id="service job-chart4" :chartData="$clientEarningChart" height="300" />
            </x-cards.data>
        </div>
    @endif

    @if (in_array('payments', user_modules()) && in_array('sites', user_modules()) && in_array('earnings_by_projects', $activeWidgets))
        <div class="col-sm-12 col-lg-6 mt-4">
            <x-cards.data
                :title="__('modules.dashboard.earningsByProjects').' <i class=\'fa fa-question-circle\' data-toggle=\'popover\' data-placement=\'top\' data-content=\''.__('team chat.earningChartNote').'\' data-trigger=\'hover\'></i>'">
                <x-bar-chart id="service job-chart5" :chartData="$projectEarningChartData" height="300" />
            </x-cards.data>
        </div>
    @endif
