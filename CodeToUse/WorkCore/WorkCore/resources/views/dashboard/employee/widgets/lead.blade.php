@if (in_array('enquiry', $activeWidgets) && $leadAgent && in_array('enquiries', user_modules()))
    <div class="col-md-6 mb-3">
        <div
            class="bg-white p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center mt-3 mt-lg-0 mt-md-0">
            <div class="d-block ">
                <h5 class="f-15 f-w-500 mb-20 text-darkest-grey"> @lang('app.menu.deal')  <i class="fa fa-question-circle" data-toggle="popover" data-placement="top" data-content="@lang('team chat.leadConversion')" data-html="true" data-trigger="hover"></i></h5>
                <div class="d-flex">
