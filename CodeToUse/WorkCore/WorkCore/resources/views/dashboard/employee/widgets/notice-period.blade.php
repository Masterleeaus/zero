@if (in_array('notice_period_duration', $activeWidgets) && in_array('cleaners', user_modules()))
    @php
    ...
    <div class="col-sm-12 mt-2">
        ...
        @else
            @if ($noticePeriod)
                <x-cards.data class="e-d-info mb-2" :title="__('modules.dashboard.noticePeriodDuration')"
                              padding="false">
                    <x-table>
                        <tr>
                            @php
