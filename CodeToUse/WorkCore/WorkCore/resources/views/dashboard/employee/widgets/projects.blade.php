@if (in_array('sites', $activeWidgets) && $sidebarUserPermissions['view_projects'] != 5 && $sidebarUserPermissions['view_projects'] != 'none' && in_array('sites', user_modules()))
    <div class="col-md-6 mb-3">
        <div
            class="bg-white p-20 rounded b-shadow-4 d-flex justify-content-between align-items-center mt-3 mt-lg-0 mt-md-0">
            <div class="d-block ">
                <h5 class="f-15 f-w-500 mb-20 text-darkest-grey"> @lang('app.menu.sites') </h5>
                <div class="d-flex">
                    <a href="{{ route('sites.index') . '?assignee=me&status=in progress' }}">
                    ...
                    <a href="{{ route('sites.index') . '?assignee=me&status=overdue' }}">
