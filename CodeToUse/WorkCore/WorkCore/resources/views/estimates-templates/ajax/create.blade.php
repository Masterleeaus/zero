                                                        ...
                                                        <td width="30%" align="left" class="c-inv-sub-padding">
                                                            <div
                                                                ...
                                                                <select class="form-control select-picker"
                                                                    ...
                                                                    <option
                                                                        @if (isset($quote) && $quote->discount_type == 'percent') selected @endif
                                                                        value="percent">%
                                                                    </option>
                                                                    <option
                                                                        @if (isset($quote) && $quote->discount_type == 'fixed') selected @endif
                                                                        value="fixed">
...
<script>
    $(document).ready(function() {
        ...
        function addProduct(id) {
            ...
            $.easyAjax({
                url: "{{ route('quote-template.add_item') }}",
                type: "GET",
                data: {
                    id: id,
        ...
        $('.save-form').click(function() {
            ...
            $.easyAjax({
                url: "{{ route('quote-template.store') }}",
                container: '#saveInvoiceForm',
                type: "POST",
                blockUI: true,
                redirect: true,
