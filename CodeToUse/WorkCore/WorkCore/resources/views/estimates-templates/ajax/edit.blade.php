...
<div class="bg-white rounded b-shadow-4 create-inv">
    ...
    <x-form class="c-inv-form" id="saveInvoiceForm">
                    ...
                    <div class="select-others height-35 rounded">
                        <select class="form-control select-picker" name="currency_id" id="currency_id">
                            @foreach ($currencies as $currency)
                                <option @if ($currency->id == $quote->currency_id) selected @endif value="{{ $currency->id }}">
                                ...
                                <tbody>
                                    ...
                                    <tr class="d-none d-md-block d-lg-table-row">
                                        ...
                                        <td class="border-left-0">
                                            ...
                                            @if ($item->EstimateTemplateItemImage && $item->EstimateTemplateItemImage->external_link)
                                                        ...
                                                        <td width="30%" align="left" class="c-inv-sub-padding">
                                                            <div
                                                                ...
                                                                <select class="form-control select-picker"
                                                                    ...
                                                                    <option @if (isset($quote) && $quote->discount_type == 'percent') selected @endif value="percent">%
                                                                    </option>
                                                                    <option @if (isset($quote) && $quote->discount_type == 'fixed') selected @endif value="fixed">
        ...
        <x-form-actions>
            ...
            <x-forms.button-cancel :link="route('quote-template.index')" class="border-0">@lang('app.cancel')
...
<script>
    $(document).ready(function() {
        ...
        file.on('dropify.beforeClear', function(event, element) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    var url = "{{ route('quote-template.delete_image') }}";
        ...
        $('.save-form').click(function() {
            ...
            $.easyAjax({
                url: "{{ route('quote-template.update', $quote->id) }}",
                container: '#saveInvoiceForm',
                type: "POST",
                blockUI: true,
                redirect: true,
