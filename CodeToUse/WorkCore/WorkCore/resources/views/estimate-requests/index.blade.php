        ...
        <div class="d-block d-lg-flex d-md-flex justify-content-between">
            <div id="table-actions" class="flex-grow-1 align-items-center mb-2 mb-lg-0 mb-md-0">
                @if ($addEstimateRequestPermission == 'all' || $addEstimateRequestPermission == 'added')
                    <x-forms.link-primary :link="route('quote-request.create')" class="mr-3 float-left mb-2 mb-lg-0 mb-md-0 openRightModal" icon="plus">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                @if (in_array($viewEstimatePermission, ['all', 'added', 'owned', 'both']))
                    <a href="{{ route('quotes.index') }}" class=" btn btn-secondary f-14"
                    data-toggle="tooltip" data-original-title="@lang('modules.module.quotes')">
...
@push('scripts')
    ...
    <script>
        $('#quote-request-table').on('preXhr.dt', function(e, settings, data) {
        ...
        const showTable = () => {
            window.LaravelDataTables["quote-request-table"].draw(true);
        }
        ...
        const applyQuickAction = () => {
            var rowdIds = $("#quote-request-table input:checkbox:checked").map(function() {
                return $(this).val();
            }).get();

            var url = "{{ route('quote-request.apply_quick_action') }}?row_ids=" + rowdIds;
        ...
        $('#sendEstimateRequest').click(function() {
            var url = "{{ route('quote-request.send_estimate_request') }}";
