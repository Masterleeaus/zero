        ...
        <div class="row">
            ...
            @if($type == 'add' && $checkTodayHoliday)
                <x-alert type="info" icon="info-circle">
                    @lang('team chat.holidayAlertMsg')
                </x-alert>
            @endif
                ...
                <x-form id="attendance-container">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6"  id="clock_out_otherPlace" @if ($row->clock_out_time_work_from_type != 'other') style="display:none" @endif >
                            <x-forms.text fieldId="clock_out_time_working_from" :popover="__('team chat.clockOutOtherLocation')" :fieldLabel="__('modules.attendance.otherPlace')" fieldName="clock_out_time_working_from" fieldRequired="true" :fieldValue="$row->clock_out_time_working_from" >
                            </x-forms.text>
                        </div>
                    </div>
                </x-form>
