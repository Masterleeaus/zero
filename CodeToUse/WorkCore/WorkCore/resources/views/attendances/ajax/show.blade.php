...
<div class="modal-body bg-grey">
                ...
                <div class="row">
                    <div class="col-12">
                        <h4 class="card-title f-15 f-w-500 text-darkest-grey mb-0">
                            <a href="{{ route('cleaners.show', [$attendance->user->id]) }}"
                        ...
                        <p class="mb-0 f-13 text-dark-grey">
                            {{ (!is_null($attendance->user->employeeDetail) && !is_null($attendance->user->employeeDetail->role)) ? $attendance->user->employeeDetail->role->name : ' ' }}
                        </p>
                    </div>
                </div>
            </x-cards.user>
    ...
    <div class="row">
        ...
        <div class="col-md-6">
            ...
            <x-cards.data :title="__('modules.cleaners.activity')">
