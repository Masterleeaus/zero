            ...
            <x-form id="attendance-container">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-6"  id="clock_out_otherPlace" @if ($attendance->clock_out_time_work_from_type != 'other') style="display:none" @endif >
                        <x-forms.text fieldId="clock_out_time_working_from" :popover="__('team chat.clockOutOtherLocation')" :fieldLabel="__('modules.attendance.otherPlace')" fieldName="clock_out_time_working_from" fieldRequired="true" :fieldValue="$attendance->clock_out_time_working_from">
                        </x-forms.text>
                    </div>
                </div>
