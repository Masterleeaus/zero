        ...
        <x-form id="save-expense-data-form">
            ...
            <div class="add-customer bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <x-forms.label class="mt-3" fieldId="project_id" :fieldLabel="__('app.site')">
                        </x-forms.label>
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="project_id" id="project_id"
                                ...
                                @foreach ($sites as $site)
                                    <option data-currency-id="{{ $site->currency_id }}" @selected($site->id == $expense->project_id) value="{{ $site->id }}">
                                        {{ $site->project_name }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="col-lg-12">
                        <x-forms.file :fieldLabel="__('app.bill')" fieldName="bill" fieldId="bill"
                            :fieldValue="$expense->bill_url" allowedFileExtensions="txt pdf doc xls xlsx docx rtf png jpg jpeg svg" :popover="__('team chat.fileFormat.multipleImageFile')" />
                    </div>
