    ...
    <div class="col-sm-12">
        <x-cards.data :title="__('app.menu.expenses') . ' ' . __('app.details')" class=" mt-4">
                ...
                <x-slot name="action">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                            ...
                            @php
                                $trashBtn = (!is_null($expense->site) && is_null($expense->site->deleted_at)) ? true : (is_null($expense->site) ? true : false) ;
                            @endphp
            ...
            <x-cards.data-row :label="__('app.site')"
                :value="(!is_null($expense->site) && !is_null($expense->site->withTrashed()) ? $expense->site->project_name : '--')" />
            ...
            @if ($expense->status == 'approved')
                <div class="col-12 px-0 pb-3 d-lg-flex d-md-flex d-block">
                    ...
                    <p class="mb-0 text-dark-grey f-14">
                        <x-cleaner :user="$expense->approver" />
                    </p>
                </div>
            @endif
