                            ...
                            <div class="select-others height-35 rounded">
                                <select class="form-control select-picker" name="currency_id" id="currency_id">
                                    @foreach ($currencies as $currency)
                                        <option @selected($quote->currency_id == $currency->id)
                                            value="{{ $currency->id }}">
                     ...
                     <div class="col-md-6">
                        <div class="form-group c-inv-select mb-4">
                            ...
                            <select class="form-control select-picker" name="status" id="status">
                                <option
                                    @selected($quote->status == 'accepted') value="accepted">@lang('modules.quotes.accepted')
                                </option>
                                <option
                                    @selected($quote->status == 'waiting') value="waiting">@lang('modules.quotes.waiting')
                                </option>
                                <option
                                    @selected($quote->status == 'declined') value="declined">@lang('modules.quotes.declined')
                                </option>
                                                                ...
                                                                <td width="50%" align="left" class="c-inv-sub-padding">
                                                                    <div
                                                                        ...
                                                                        <select class="form-control select-picker"
                                                                            ...
                                                                            <option @selected($quote->discount_type == 'percent')  value="percent">%</option>
                                                                            <option @selected($quote->discount_type == 'fixed')  value="fixed">
