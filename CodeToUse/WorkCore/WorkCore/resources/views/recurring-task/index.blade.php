        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                ...
                @if ($recurringTaskPermission == 'all')
                    <x-forms.link-primary :link="route('recurring-service job.create')" class="mr-3 openRightModal float-left" icon="plus">
                       @lang('app.add') @lang('app.menu.taskRecurring')
...
@push('scripts')
    ...
    <script>
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            if (activeRunning == 1) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        var url = "{{ route('recurring-service job.destroy', ':id') }}";
        ...
        const applyQuickAction = () => {
            ...
            var url = "{{ route('recurring-service job.apply_quick_action') }}?row_ids=" + rowdIds;
