        ...
        <x-form id="save-service job-data-form" method="PUT">
            <div class="add-customer bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-5 col-lg-4 dueDateBox" @if(is_null($service job->due_date)) style="display: none" @endif>
                        ...
                        <div class="col-lg-3 col-md-6">
                            ...
                            <x-forms.select fieldId="board_column_id" :fieldLabel="__('app.status')"
                                ...
                                @foreach ($taskboardColumns as $item)
                                    ...
                                    @endphp
                                    @if ($item->id !== $waitingApprovalTaskBoardColumn->id)
                                        <option @selected($service job->board_column_id == $item->id) value="{{ $item->id }}" data-item="{{ $item->column_name }}" data-content = "{{$icon}}">
                                        </option>
                                    @endif
                                @endforeach
                            </x-forms.select>
                    ...
                    <div class="col-md-6 col-lg-3 {{ $service job->estimate_hours == 0 && $service job->estimate_minutes == 0 ? 'd-none' : '' }}"
                        ...
                        <div class="form-group mt-5">
                            ...
                            <input type="number" min="0" name="estimate_minutes"
                                value="{{ $service job->estimate_minutes }}" class="w-25 height-35 f-14 border rounded p-2">
                            @lang('app.mins')
                        </div>
                    </div>

                    @if($service job->recurring_task_id == null && $service job->repeat == 1)
                    <div class="col-md-6">
                        <div class="form-group my-3">
                            <div class="d-flex">
