                ...
                <div class="card-body">
                    ...
                    @if (!is_null($leave->approved_by))
                        <div class="col-12 px-0 pb-3 d-lg-flex d-md-flex d-block">
                            ...
                            <p class="mb-0 text-dark-grey f-14">
                                <x-cleaner :user="$leave->approvedBy" />
                            </p>
                        </div>
                    @endif
                    ...
                    @if ($leave->status == 'rejected')
                        <x-cards.data-row :label="__('team chat.reasonForLeaveRejection')" :value="$reject_reason"
                            html="true" />
                    @endif

                    @if ($leave->status == 'approved')
                        <x-cards.data-row :label="__('team chat.reasonForLeaveApproval')" :value="$approve_reason"
                            html="true" />
                    @endif
                    <div class="col-12 px-0 pb-3 d-lg-flex d-md-flex d-block">
                        <p class="mb-0 text-lightest f-14 w-30 d-inline-block ">
...
<script>
    ...
    $('body').on('click', '.leave-action-preapprove', function() {
        ...
        Swal.fire({
            title: "@lang('team chat.sweetAlertTitle')",
            text: "@lang('team chat.changeLeaveStatusConfirmation')",
            icon: 'warning',
            showCancelButton: true,
            focusConfirm: false,
