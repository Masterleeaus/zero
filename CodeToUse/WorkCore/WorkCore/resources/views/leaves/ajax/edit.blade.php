...
<div class="row">
    <div class="col-sm-12">
        <x-form id="save-enquiry-data-form" method="PUT">
            <div class="add-customer bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        @else
                            <x-forms.label class="my-3" fieldId="" :fieldLabel="__('modules.team chat.chooseMember')"
                                fieldRequired="true">
                            </x-forms.label>
                            <select class="form-control select-picker" name="user_id" id="user_id"
                                ...
                                @foreach ($cleaners as $cleaner)
                                    <x-user-option :user="$cleaner"
                                                   :selected="(request()->has('default_assign') && request('default_assign') == $cleaner->id) || ($leave->user_id == $cleaner->id)">
                                    </x-user-option>
                                @endforeach
                            </select>
                        @endif
                    ...
                    <div class="col-lg-3 col-md-6">
                        ...
                        <x-forms.input-group>
                            ...
                            @if ($addLeadAgentPermission == 'all' || $addLeadAgentPermission == 'added')
                                <x-slot name="append">
                                    <button type="button"
                                        class="btn btn-outline-secondary border-grey add-enquiry-type"
                    ...
                    <div class="col-md-12 d-none" id="leave-file">
                        ...
                        fieldId="file-upload-dropzone" :popover="__('team chat.leaveFileMessage')" />
...
<script>
    $(document).ready(function() {
        ...
        // Get initial cleaner ID (from leave or selected)
        ...
        // Set min date on page load if cleaner is selected
        ...
        $('#save-leave-form').click(function() {
            ...
            function sendeditAjaxRequest(){
                $.easyAjax({
                    ...
                    data: $('#save-enquiry-data-form').serialize()+ '&markLeave='+markleave,
                    success: function(response) {
        ...
        $('body').on('click', '.add-enquiry-type', function() {
