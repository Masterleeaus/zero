...
@section('filter-section')
    <x-filters.filter-box>
        ...
        <div class="service job-search d-flex  py-1 px-lg-2 px-0 border-right-grey align-items-center">
        ...
        <x-filters.more-filter-box>
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 " for="usr">@lang('app.cleaner')</label>
