    ...
    <div id="container">
        <div class="right-invoice description">
            <section id="memo" class="description">
                <div class="customer-logo description">
                    <div>
            ...
            <section id="invoice-title-number">
                ...
                <div id="title">{{ $quote->estimate_number }}</div>
            ...
            <section id="customer-info" class="description">
                @if (
                    ...
                    <div>
                        <span class="bold">{{ $quote->customer->name_salutation }}</span>
                    </div>
                    @endif
                    ...
                    <div>
                        <span>{{ $quote->customer->mobile_with_phonecode }}</span>
                    </div>
                    @endif
            ...
            <section id="invoice-info">
                @if ($quote->status == 'unpaid')
                    <div>
                        ...
                        <span>{{ $quote->due_date ? $quote->due_date->translatedFormat($company->date_format) : '--' }}</span>
                    </div>
                @endif
                <div>
            ...
            <section id="items">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <th class="description">@lang("modules.invoices.price") ({!! htmlentities($quote->currency->currency_code) !!})</th>
                    </tr>
            ...
            <section id="sums">
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    <tr class="amount-total">
                        ...
                        <td>{{ currency_format($quote->total, $quote->currency_id, false) }}</td>
                    </tr>
                </table>
            ...
            <section class="terms description">
                <div class="notes description">
                    @if (!is_null($quote->note))
                        <br>@lang('app.note') <br> {!! nl2br($quote->note) !!}
                    @endif
            ...
            @if(isset($fields) && count($fields) > 0)
                ...
                <div id="container">
                    <div class="invoice-body right-invoice b-all m-b-20">
                        <h3 class="m-t-20 text-center h3-border"> @lang('modules.sites.otherInfo')</h3>
