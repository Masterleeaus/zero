        ...
        <div class="invoice-top">
            ...
            <div class="company-info">
                ...
                @if($invoiceSetting->show_gst == 'yes' && !is_null($invoiceSetting->gst_number))
                    <br><br><div>{{ $quote->customer->clientDetails->tax_name }}: {{ $invoiceSetting->gst_number }}</div><br><br>
                @endif
            </div>
        ...
        <section id="invoice-info" class="description">
            <table>
                <tr>
                    ...
                    <td>{{ $quote->valid_till ? $quote->valid_till->translatedFormat($company->date_format) : '--' }}</td>
                </tr>
                <tr>
                    <td>@lang('app.createdOn'):</td>
                    <td>{{ $quote->created_at ? $quote->created_at->translatedFormat($company->date_format) : '--' }}</td>
                </tr>
                <tr>
            ...
            <section id="invoice-title-number">
                <span id="number">{{ $quote->estimate_number }}</span>
    ...
    <div class="invoice-body">
        ...
        <section id="items" class="description">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                <tr>
                    ...
                    <th>@lang("modules.invoices.price") ({!! htmlentities($quote->currency->currency_code)  !!})</th>
                </tr>
        ...
        <section id="terms">
            @if(!is_null($quote->note))
                <div class="word-break item-summary description">@lang('app.note') <br>{!! nl2br($quote->note) !!}</div>
            @endif
