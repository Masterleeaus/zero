        ...
        <div class="row px-lg-4 px-md-4 px-3 py-3">
            ...
            <div class="col-md-6 col-lg-4">
                <div class="form-group mb-4">
                    <label class="f-14 text-dark-grey mb-12 " for="usr">@lang('modules.quotes.estimatesNumber')</label>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="form-group mb-4">
                    <x-forms.label fieldId="due_date" :fieldLabel="__('modules.quotes.validTill')" fieldRequired="true">
                    </x-forms.label>
                    <div class="input-group">
                    ...
                    <div class="select-others height-35 rounded">
                        <select class="form-control select-picker" name="currency_id" id="currency_id">
                            @foreach ($currencies as $currency)
                                <option
                                    @if (isset($quote)) @selected ($currency->id == $quote->currency_id)
            ...
            @if (isset($quote))
                <input type="hidden" name="estimate_id" value="{{ $quote->id ?? '' }}">
            @endif
            ...
            <div class="col-md-6 col-lg-4">
                ...
                :customers="$customers"
                :selected="isset($quote) ? $quote->client_id : (request()->has('default_client') ? request()->input('default_client') : $estimateTemplate->client_id ?? null)"
            />
                @endif
            </div>
            <!-- CLIENT END -->
            ...
            <div class="col-md-12 my-3">
                <div class="form-group">
                    ...
                    <div id="description">{!! isset($quote) ? $quote->description : ($estimateTemplate ? $estimateTemplate->description : '') !!}</div>
                                    ...
                                    <tr class="d-none d-md-table-row d-lg-table-row">
                                        ...
                                        <td class="border-left-0">
                                            ...
                                            <input type="file" class="dropify" name="invoice_item_image[]"
                                                data-allowed-file-extensions="png jpg jpeg bmp"
                                                data-team chat-default="test" data-height="70"
                            ...
                            <table width="100%">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><span
                                                id="discount_amount">@if(isset($quote)) {{ number_format((float) $quote->discount, 2, '.', '') }} @else 0.00 @endif </span>
                                        </td>
                                    </tr>
                                    <tr>
...
$       ('#client_list_id').change(function() {
        ...
        $(document).on('click', '#add-item', function() {
            ...
            '<input type="file" class="dropify" id="dropify' + i +
                '" name="invoice_item_image[]" data-allowed-file-extensions="png jpg jpeg bmp" data-team chat-default="test" data-height="70" /><input type="hidden" name="invoice_item_image_url[]">' +
                '</td>' +
                '</tr>' +
                '</tbody>' +
                '</table>' +
        ...
        $('.save-form').click(function() {
            ...
            $.easyAjax({
                url: "{{ route('quotes.store') }}?type=" + type,
                container: '#saveInvoiceForm',
                type: "POST",
                blockUI: true,
                file: true,
