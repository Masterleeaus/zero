        ...
        <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
            ...
            <div class="select-status">
                <select class="form-control select-picker" id="filter-status">
                    ...
                    <option value="waiting">@lang('modules.quotes.waiting')</option>
                    <option value="accepted">@lang('modules.quotes.accepted')</option>
                    <option value="declined">@lang('modules.quotes.declined')</option>
                    <option value="draft">@lang('modules.quotes.draft')</option>
                </select>
            </div>
        </div>
        <!-- CLIENT END -->
        ...
        <div class="d-block d-lg-flex d-md-flex justify-content-between">
            <div id="table-actions" class="flex-grow-1 align-items-center mb-2 mb-lg-0 mb-md-0">
                @if ($addEstimatePermission == 'all' || $addEstimatePermission == 'added')
                    <x-forms.link-primary :link="route('quotes.create')" class="mr-3 float-left mb-2 mb-lg-0 mb-md-0" icon="plus">
                        @lang('modules.quotes.createEstimate')
                    </x-forms.link-primary>

                    <x-forms.link-secondary :link="route('quote-template.index')"
                    class="mr-3 mb-2 mb-lg-0 mb-md-0 float-left mb-2 mb-lg-0 mb-md-0" icon="layer-group">
                    @lang('modules.quotes.estimateTemplate')
                    </x-forms.link-secondary>
                @endif
                @if (in_array('customer', user_roles()) && ($addEstimateRequestPermission == 'all' || $addEstimateRequestPermission == 'added'))
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                @if (in_array($viewEstimateRequestPermission, ['all', 'added', 'owned', 'both']))
                    <a href="{{ route('quote-request.index') }}" class=" btn btn-secondary f-14"
                ...
                data-image-url="{{ asset('img/quote-lc.png') }}" data-toggle="tooltip"
