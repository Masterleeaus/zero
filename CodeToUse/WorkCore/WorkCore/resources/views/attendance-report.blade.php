...
<table class="content">
    <thead>
    <tr>
        <th style="vertical-align: middle; text-align: left; max-width: 150px;">@lang('app.cleaner')</th>
...
<table class="content">
    ...
    <tr>
        ...
        <td>
            <span>L</span> &rightarrow; @lang('app.menu.leaves')
        </td>
    </tr>
</table>
...
<table class="content">
    ...
    @foreach ($employeeAttendence as $key => $attendance)
        ...
        <tr>
            ...
            @endphp
            <td>{!! $totalAbsent . ' / ' . (count($attendance) - 1) !!}</td>
        </tr>
    @endforeach
    </tbody>
</table>
