...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.service agreements.contractType')</h5>
...
<div class="modal-footer">
    ...
    <x-forms.button-primary id="save-service agreement-type" icon="check">@lang('app.save')</x-forms.button-primary>
</div>
...
<script>
    ...
    $('#save-service agreement-type').click(function() {
