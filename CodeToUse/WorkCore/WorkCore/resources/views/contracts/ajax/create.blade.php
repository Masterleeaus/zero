...
@if (!in_array('customers', user_modules()))
    <x-alert class="mb-3" type="danger" icon="exclamation-circle"><span>@lang('team chat.enableClientModule')</span>
        <x-forms.link-secondary icon="arrow-left" :link="route('service agreements.index')">@lang('app.back')</x-forms.link-secondary>
    </x-alert>
@else
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <x-forms.datepicker fieldId="start_date" fieldRequired="true"
                                            ...
                                            :fieldValue="($service agreement ? $service agreement->start_date->timezone(company()->timezone)->format(company()->date_format) : '')"
                                            :fieldPlaceholder="__('placeholders.date')"/>
                    </div>

                    <div class="col-md-6 col-lg-3 due-date-box"
                         @if($service agreement && is_null($service agreement->end_date)) style="display: none" @endif>
                    ...
                    <div class="col-md-2 col-lg-2 pt-5">
                        <x-forms.checkbox class="mr-0 mr-lg-2 mr-md-2"
                                          :checked="$service agreement ? is_null($service agreement->end_date) : ''"
                    ...
                    <div class="col-md-6 col-lg-3">
                        <x-forms.label class="mt-3" fieldId="contractType"
                                       :fieldLabel="__('modules.service agreements.contractType')"
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <x-forms.text fieldId="cell" :fieldLabel="__('modules.customer.cell')"
                                      :fieldValue="($service agreement ? $service agreement->cell: '')" fieldName="cell">
                        </x-forms.text>
                    </div>

                    <div class="col-md-6 col-lg-4">
                        <x-forms.text fieldId="office" :fieldPlaceholder="__('placeholders.mobileWithPlus')"
                                      :fieldValue="($service agreement ? $service agreement->office: '')"
                                      :fieldLabel="__('modules.customer.officePhoneNumber')" fieldName="office">
                        </x-forms.text>
                    </div>

                    <div class="col-md-6 col-lg-3">
                        <x-forms.text fieldId="city" :fieldValue="($service agreement ? $service agreement->city: '')"
                    ...
                    <div class="col-md-6 col-lg-3">
                        <x-forms.text fieldId="state" :fieldValue="($service agreement ? $service agreement->state: '')"
                    ...
                    <div class="col-md-6 col-lg-3">
                        <x-forms.text fieldId="country" :fieldValue="($service agreement ? $service agreement->country: '')"
                                      :fieldLabel="__('modules.stripeCustomerAddress.country')" fieldName="country">
                        </x-forms.text>
                    </div>

                    <div class="col-md-6 col-lg-3">
                        <x-forms.text fieldId="postal_code" :fieldValue="($service agreement ? $service agreement->postal_code: '')"
                    ...
                    <div class="col-md-6">
                        <x-forms.textarea class="mr-0 mr-lg-2 mr-md-2"
                                          :fieldLabel="__('modules.service agreements.alternateAddress')"
                                          fieldName="alternate_address"
                                          fieldId="alternate_address" :fieldPlaceholder="__('placeholders.address')">
                            {{ $service agreement ? $service agreement->alternate_address : '' }}
                        </x-forms.textarea>
                    </div>
                    <div class="col-md-6">
...
<script>
    $(document).ready(function () {
        ...
        $('#save-service agreement-form').click(function () {
            ...
            const url = "{{ route('service agreements.store') }}";
        ...
        $('#contract_client_id').change(function () {
            const id = $(this).val();
            let url = "{{ route('customers.ajax_details', ':id') }}";
        ...
        $('#client_list_id').change(function() {
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    if (response.status == 'success') {
                        const customer = response.clientDetails;

                        $('#cell').val(customer.mobile);
                        $('#office').val(customer.office_mobile);
                        $('#city').val(customer.city);
                        
                        $('#state').val(customer.state);
                        $('#country').val(customer.countryName);
