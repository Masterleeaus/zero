<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.quotes.signature')</h5>
    ...
    <x-form id="acceptEstimates">
        <div class="row">
            <div class="col-sm-12 bg-grey p-4 signature">
                <x-forms.label fieldId="sign-pad" fieldRequired="true" :fieldLabel="__('modules.quotes.signature')" />
            ...
            <div class="col-sm-12 p-4 d-none upload-img">
                <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.quotes.signature')"
                    fieldName="image" fieldId="sign_image" :popover="__('team chat.fileFormat.ImageFile')" fieldRequired="true" />
            </div>
            <div class="col-sm-12 mt-3">
                <x-forms.button-secondary id="undo-sign" class="signature">@lang('modules.quotes.undo')</x-forms.button-secondary>
                <x-forms.button-secondary class="ml-2 signature" id="clear-sign">@lang('modules.quotes.clear')
                </x-forms.button-secondary>
                <x-forms.button-secondary class="ml-2 " id="toggle-pad-upload">@lang('modules.quotes.uploadSignature')
                </x-forms.button-secondary>
            </div>
...
<script>
    ...
    $('#save-sign').click(function() {
        ...
        if(signature_type == 'upload')
            {
                $.easyAjax({
                    url: "{{ route('companySign.sign', $service agreement->id) }}",
