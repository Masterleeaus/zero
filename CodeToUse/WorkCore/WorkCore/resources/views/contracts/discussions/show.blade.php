                ...
                <div class="d-flex flex-grow-1">
                    ...
                    <div class="dropdown ml-auto comment-action">
                        ...
                        <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                            ...
                            @if ($editContractDiscussionPermission == 'all' || ($editContractDiscussionPermission == 'added' && ($discussion->added_by == user()->id || $discussion->added_by == $userId || in_array($discussion->added_by, $cId))))
                            ...
                            @if ($deleteContractDiscussionPermission == 'all' || ($deleteContractDiscussionPermission == 'added' && ($discussion->added_by == user()->id || $discussion->added_by == $userId || in_array($discussion->added_by, $cId))))
