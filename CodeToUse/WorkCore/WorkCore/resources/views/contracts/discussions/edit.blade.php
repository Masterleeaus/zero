                ...
                <div class="media">
                    ...
                    <div class="media-body bg-white">
                        <div class="form-group">
                            <div id="service job-edit-comment">{!! $comment->message !!}</div>
                            <textarea name="comment" class="form-control invisible d-none"
                                id="service job-edit-comment-text">{!! $comment->message !!}</textarea>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    var edit_task_comments = "{{ user()->permission('edit_contract_discussion') }}";

    $(document).ready(function() {
        if (edit_task_comments == "all" || edit_task_comments == "added") {
            quillMention(null, '#service job-edit-comment');
