            ...
            <div class="row">
                ...
                <div class="col-sm-12 col-lg-6 regular-currency">
                    <x-forms.number class="mr-0 mr-lg-2 mr-md-2"
                                    ...
                                    fieldId="exchange_rate" fieldRequired="true" fieldHelp="( {{company()->currency->currency_code}} {{__('app.to')}} {{company()->currency->currency_code}} )">
                    </x-forms.number>
                    ...
                    @else
                        @lang('team chat.configureCurrencyConverterKey',['link'=> '<a href="javascript:;" class="fetch-exchange-rate" icon="key"><i class="fa fa-key"></i> '.__("app.clickHere").'</a>'])
                    @endif
                </div>
            ...
            <div class="row pt-3">
                <div class="col-lg-6">
                    <x-forms.select fieldId="currency_position"
                                    ...
                                    :popover="__('team chat.currency.currencyPosition')">
                        <option
                ...
                <div class="col-lg-6">
                    <x-forms.text class="mr-0 mr-lg-2 mr-md-2"
                                    ...
                                    :popover="__('team chat.currency.thousandSeparator')"
                ...
                <div class="col-lg-6">
                    <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.currencySettings.decimalSeparator')"
                                    ...
                                    :popover="__('team chat.currency.decimalSeparator')"
                ...
                <div class="col-lg-6">
                    <x-forms.number class="mr-0 mr-lg-2 mr-md-2"
                                    ...
                                    fieldId="no_of_decimal" :popover="__('team chat.currency.numberOfdecimals')"
