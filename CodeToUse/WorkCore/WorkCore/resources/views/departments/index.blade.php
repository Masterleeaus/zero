...
@section('filter-section')
    <x-filters.filter-box>
        ...
        <div class="service job-search d-flex py-1 pr-lg-2 px-0 border-right-grey align-items-center">
        ...
        <x-filters.more-filter-box>
            ...
            <div class="more-filter-items">
                <label class="f-14 text-dark-grey mb-12 "
                       for="usr">@lang('modules.zone.title')</label>
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if ($addDepartmentPermission == 'all')
                    <x-forms.link-primary :link="route('zones.create')" class="mr-3 openRightModal float-left"
                                          icon="plus">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group" aria-label="Basic example">
                <a href="{{ route('zones.index') }}" class="btn btn-secondary f-14 btn-active"
                   data-toggle="tooltip"
                   data-original-title="@lang('modules.leaves.tableView')"><i class="side-icon bi bi-list-ul"></i></a>

                <a href="{{ route('zone.hierarchy') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
...
@push('scripts')
    ...
    <script>
        $('#zones-table').on('preXhr.dt', function (e, settings, data) {
        ...
        const showTable = () => {
            window.LaravelDataTables["zones-table"].draw(true);
        }
        ...
        $('body').on('click', '.delete-table-row', function () {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('zones.destroy', ':id') }}";
        ...
        const applyQuickAction = () => {
            const rowdIds = $("#zones-table input:checkbox:checked").map(function () {
                return $(this).val();
            }).get();


            const url = "{{ route('zones.apply_quick_action') }}?row_ids=" + rowdIds;
