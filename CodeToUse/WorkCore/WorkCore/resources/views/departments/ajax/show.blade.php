    ...
    <div class="row">
        <div class="col-sm-12">
            <div class="card bg-white border-0 b-shadow-4">
                            ...
                            <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                        ...
                                        @if($editDepartmentPermission == 'all')
                                            ...
                                            href="{{ route('zones.edit', $zone->id) }}">@lang('app.edit')</a>
                                        @endif
                                        @if($deleteDepartmentPermission == 'all')
                                            <a class="dropdown-item delete-zone">@lang('app.delete')</a>
                                        @endif
                                    </div>
                            </div>
                        </div>
                ...
                <div class="card-body">
                    <x-cards.data-row :label="__('app.name')" :value="$zone->team_name"
                        html="true" />
...
<script>
    $('body').on('click', '.delete-zone', function() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                var url = "{{ route('zones.destroy', $zone->id) }}";
