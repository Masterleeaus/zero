    ...
    <div class="portlet-body">
        <x-form id="save-visa-data-form" method="PUT" class="ajax-form">
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <x-forms.text :fieldLabel="__('modules.cleaners.visaNumber')"
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <x-forms.datepicker fieldId="issue_date" fieldRequired="true"
                                        :fieldLabel="__('modules.cleaners.issueDate')" fieldName="issue_date"
                ...
                <div class="col-lg-4">
                    <x-forms.datepicker fieldId="expiry_date" fieldRequired="true"
                                        :fieldLabel="__('modules.cleaners.expiryDate')" fieldName="expiry_date"
                                        :fieldValue="$visa ? $visa->expiry_date->format(company()->date_format) :  now(company()->timezone)->format(company()->date_format)"
                                        :fieldPlaceholder="__('placeholders.date')"/>
                </div>

                <div class="col-lg-4">
                    <x-forms.select fieldId="alert_before_months" :fieldLabel="__('modules.cleaners.alertBeforeMonths')" fieldName="alert_before_months"
                        :fieldRequired="false">
            ...
            <div class="row">
                ...
                <div class="col-lg-12">
                    <x-forms.file allowedFileExtensions="png jpg jpeg svg pdf doc docx" class="mr-0 mr-lg-2 mr-md-2"
                        :fieldLabel="__('modules.cleaners.scanCopy')" fieldName="file"
...
<script>
    ...
    $('#save-visa-form').click(function(){
        $.easyAjax({
            url: "{{ route('cleaner-visa.update', $visa->id) }}",
