<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('app.edit') @lang('modules.cleaners.employeeDocumentExpiry')</h5>
...
<x-form id="update-document-expiry-form" method="POST" class="ajax-form">
    <div class="modal-body">
        ...
        <div class="row">
            <div class="col-md-6">
                <x-forms.text 
                    :fieldLabel="__('modules.cleaners.documentName')" 
                    fieldName="document_name"
                    fieldRequired="true" 
                    fieldId="document_name"
                    :fieldPlaceholder="__('modules.cleaners.documentName')"
                    :fieldValue="$document->document_name"
                />
            </div>
            <div class="col-md-6">
                <x-forms.text 
                    :fieldLabel="__('modules.cleaners.documentNumber')" 
                    fieldName="document_number"
                    fieldRequired="false" 
                    fieldId="document_number"
                    :fieldPlaceholder="__('modules.cleaners.documentNumber')"
        ...
        <div class="row">
            <div class="col-md-6">
                <x-forms.datepicker 
                    :fieldLabel="__('modules.cleaners.issueDate')" 
                    fieldName="issue_date"
                    fieldRequired="true" 
                    fieldId="issue_date"
                    :fieldPlaceholder="__('modules.cleaners.issueDate')"
                    :fieldValue="$document->issue_date->format('Y-m-d')"
                />
            </div>
            <div class="col-md-6">
                <x-forms.datepicker 
                    :fieldLabel="__('modules.cleaners.expiryDate')" 
                    fieldName="expiry_date"
                    fieldRequired="true" 
                    fieldId="expiry_date"
                    :fieldPlaceholder="__('modules.cleaners.expiryDate')"
        ...
        <div class="row">
            <div class="col-md-6">
                <x-forms.number 
                    :fieldLabel="__('modules.cleaners.alertBefore')" 
                    fieldName="alert_before_days"
                    fieldRequired="true" 
                    fieldId="alert_before_days"
                    :fieldPlaceholder="__('modules.cleaners.days')"
                    :fieldValue="$document->alert_before_days"
                />
            </div>
            <div class="col-md-6">
                <x-forms.select 
                    :fieldLabel="__('modules.cleaners.alertEnabled')" 
        ...
        <div class="row">
            <div class="col-md-12">
                <x-forms.file 
                    :fieldLabel="__('modules.sites.uploadFile')" 
                    fieldName="file"
                    fieldRequired="false" 
                ...
                @if($document->filename)
                    <div class="mt-2">
                        <small class="text-muted">
                            @lang('modules.cleaners.currentFile'): {{ $document->filename }}
                        </small>
                    </div>
                @endif
            </div>
