...
<div class="tab-pane fade show active mt-5" role="tabpanel" aria-labelledby="nav-email-tab">
    ...
    <x-alert type="info" icon="info-circle">
        @lang('team chat.leaveQuotaShowing', ['start_date' => $leaveStartDate, 'end_date' => $leaveEndDate])
    </x-alert>
                    ...
                    <div class="col-md-12">
                        <x-table class="table-bordered mb-3 rounded">
                            ...
                            @foreach ($employeeLeavesQuotas as $key => $leavesQuota)
                                @if($leavesQuota->leaveType && $leavesQuota->leaveType->leaveTypeCondition($leavesQuota->leaveType,  $cleaner)
...
<script>
    $(document).ready(function() {
        ...
        $('.update-category').click(function() {
            ...
            var url = "{{ route('cleaner-leaves.update', ':id') }}";
