                ...
                <tr>
                    <td>
                        <h6 class="heading-h6">
                            ...
                            @if ($permission->name == 'view_employee_menu')
                                <i class="fa fa-question-circle" data-toggle="popover" data-placement="top" data-content="@lang('team chat.viewEmployeeMenuTooltip')" data-html="true" data-trigger="hover"></i>
                            @endif
                        </h6>
                    </td>
                    @php
                        $permissionType = $cleaner->permissionTypeId($permission->name);
