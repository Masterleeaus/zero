...
<div class="row">
    ...
    <div class="col-xl-12 col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4 mb-md-0 mt-3">
        <x-cards.data :title="__('modules.cleaners.visaDetails')">
                ...
                <x-cards.data-row :label="__('modules.cleaners.visaNumber')" :value="$visa->visa_number ?? '--'" />
                ...
                <x-cards.data-row :label="__('modules.cleaners.issueDate')" :value=" $visa ? $visa->issue_date->format(company()->date_format) : '--'" />
                <x-cards.data-row :label="__('modules.cleaners.expiryDate')" :value=" $visa  ? $visa->expiry_date->format(company()->date_format) : '--'" />
                <div class="col-12 px-0 pb-3 d-block d-lg-flex d-md-flex">
                    <p class="mb-0 text-lightest f-14 w-30 d-inline-block ">
                ...
                $.easyAjax({
                    ...
                    success: function(response) {
                        if (response.status == "success") {
                            var url = " {{ route('cleaners.show', $visa->user_id).'?tab=immigration' }}";
