...
<script>
    $('#recurring-invoices-table').on('preXhr.dt', function(e, settings, data) {
        ...
        // Don't filter by projectID - show all child invoices regardless of site
        // Some invoices may have been created before site was added to recurring invoice
        data['projectID'] = 'all';
    ...
    $('body').on('click', '.unpaidAndPartialPaidCreditNote', function(){
        ...
        Swal.fire({
            ...
            showCancelButton: true,
            focusConfirm: false,
            confirmButtonText: "@lang('team chat.confirmCreate')",
            cancelButtonText: "@lang('app.cancel')",
            customClass: {
                confirmButton: 'btn btn-primary mr-3',
                cancelButton: 'btn btn-secondary'
