                        ...
                        <tr class="inv-unpaid">
                            <td class="f-14 text-dark">
                                <p class="mb-0 text-left"><span
                                    ...
                                    @php
                                        if ($invoice->site && $invoice->site->customer) {
                                            $customer = $invoice->site->customer;
                                        } elseif ($invoice->client_id != '') {
                                            $customer = $invoice->customer;
                                        } elseif ($invoice->quote && $invoice->quote->customer) {
                                    ...
                                    {!! nl2br($customer->clientDetails->address) !!}</p>
                            </td>
                                            ...
                                            <table width="100%">
                                                ...
                                                @if ($hasDeducted)
                                                    ...
                                                    <tr class="text-dark-grey font-weight-semibold" align="right">
                                                        ...
                                                        <td class="border-top-0 border-right-0">
                                                            {{ number_format((float) $totalPaymentAmount, 2, '.', '') }}</td>
                                                    </tr>
                                                    @foreach ($taxesDeducted as $key => $tax)
                                                        <tr class="text-dark-grey" align="right">
                                                            <td class="w-50 border-top-0 border-left-0">
                                                                {{ $key }} (Deducted)</td>
                                                            <td class="border-top-0 border-right-0">
                                                                -{{ number_format((float) abs($tax), 2, '.', '') }}</td>
                                                        </tr>
                                                    @endforeach
