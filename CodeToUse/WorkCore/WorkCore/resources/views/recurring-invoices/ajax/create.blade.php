    ...
    <x-form class="c-inv-form" id="saveInvoiceForm">
        ...
        <div class="row px-lg-4 px-md-4 px-3 pt-3">
            ...
            <div class="col-md-3 mb-4">
                ...
                @else
                    <x-customer-selection-dropdown :customers="$customers" />
                @endif
                        ...
                        <select class="form-control select-picker" name="currency_id" id="currency_id">
                            @foreach ($currencies as $currency)
                                <option @if (isset($quote))
                                        @if ($currency->id==$quote->currency_id) selected @endif
                                        @else
                                ...
                                <tr class="d-none d-md-block d-lg-table-row">
                                    ...
                                    <td class="border-left-0">
                                        <input type="file" class="dropify" name="invoice_item_image[]"
                                               data-allowed-file-extensions="png jpg jpeg bmp" data-team chat-default="test"
                                               data-height="70"/>
                                            ...
                                            <td width="30%" align="left" class="c-inv-sub-padding">
                                                <div
                                                    ...
                                                    <select class="form-control select-picker"
                                                        ...
                                                        <option
                                                            @if (isset($quote) && $quote->discount_type == 'percent') selected
                                                            @endif
                                                            value="percent">%
                                                        </option>
                                                        <option
                                                            @if (isset($quote) && $quote->discount_type == 'fixed') selected
                                                            @endif
                                                            value="fixed">
