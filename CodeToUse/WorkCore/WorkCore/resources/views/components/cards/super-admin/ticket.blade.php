<div class="card issue / support-message rounded-0 border-0  @if (user()->id == $user->id) bg-white-shade @endif" id="message-{{ $message->id }}">
    <div class="card-horizontal">
        ...
        <div class="card-body border-0 pl-0">
            <div class="d-flex">
                <a href="{{ $user->is_superadmin ? 'javascript:;' : (user()->is_superadmin ? route('superadmin.companies.show', $user->company_id) : route('cleaners.show', $user->id)) }}">
                        ...
                        <x-slot name="action">
                            <div class="dropdown ml-auto file-action">
                                ...
                                <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                    ...
                                    <a class="dropdown-item"
                                        href="{{ route('superadmin.support-issue / support-files.download', md5($file->id)) }}">@lang('app.download')</a>
