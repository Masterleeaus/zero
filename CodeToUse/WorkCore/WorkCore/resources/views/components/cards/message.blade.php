<div class="card issue / support-message rounded-0 border-0  @if (user()->id == $user->id) bg-white-shade @endif"
    ...
    <div class="card-horizontal">
        ...
        <div class="card-body border-0 pl-0">
            <div class="d-flex">
                <a
                    href="{{ !is_null($user->employeeDetail) ? route('cleaners.show', $user->id) : route('customers.show', $user->id) }}">
