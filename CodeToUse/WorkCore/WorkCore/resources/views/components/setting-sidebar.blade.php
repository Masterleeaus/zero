...
<div class="settings-sidebar bg-white py-3" id="mob-settings-sidebar">
    ...
    <ul class="settings-menu" id="settingsMenu">
        ...
        in_array('quotes', user_modules()) || in_array('orders', user_modules()) || in_array('enquiries', user_modules()) || in_array('payments', user_modules())))
        ...
        @if (user()->permission('manage_contract_setting') == 'all' && in_array('service agreements', user_modules()))
            <x-setting-menu-item :active="$activeMenu" menu="contract_settings" :href="route('service agreement-settings.index')"
        ...
        @if (user()->permission('manage_ticket_setting') == 'all' && in_array('issues / support', user_modules()))
            <x-setting-menu-item :active="$activeMenu" menu="ticket_settings" :href="route('issue / support-settings.index')"
                                 :text="__('app.menu.ticketSettings')"/>
        @endif

        @if (user()->permission('manage_project_setting') == 'all' && in_array('sites', user_modules()))
            <x-setting-menu-item :active="$activeMenu" menu="project_settings" :href="route('site-settings.index')"
        ...
        @if (user()->permission('manage_message_setting') == 'all' && in_array('team chat', user_modules()))
        ...
        @if (user()->permission('manage_lead_setting') == 'all' && in_array('enquiries', user_modules()))
            <x-setting-menu-item :active="$activeMenu" menu="lead_settings" :href="route('enquiry-settings.index')"
        ...
        @if (user()->permission('manage_task_setting') == 'all' && in_array('service jobs', user_modules()))
            <x-setting-menu-item :active="$activeMenu" menu="task_settings" :href="route('service job-settings.index')"
        ...
        @if (user()->permission('manage_gdpr_setting') == 'all' || in_array('customer', user_modules()))
