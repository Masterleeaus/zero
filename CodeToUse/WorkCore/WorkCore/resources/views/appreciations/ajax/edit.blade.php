                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6">
                                <x-forms.select fieldId="award_to" :fieldLabel="__('modules.appreciations.awardTo')"
                                    ...
                                    @foreach ($cleaners as $cleaner)
                                        <x-user-option :user="$cleaner" :selected="($appreciation->award_to == $cleaner->id)"/>
                                    @endforeach
                                </x-forms.select>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group my-3">
                                    <x-forms.label class="my-3" fieldId="summery"
                                                   :fieldLabel="__('modules.service agreements.summery')">
                                    </x-forms.label>
                            ...
                            <div class="col-md-12">
                                <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2 cropper"
                                              ...
                                              fieldHeight="119" :popover="__('team chat.appreciationPhoto')" />
                            </div>
