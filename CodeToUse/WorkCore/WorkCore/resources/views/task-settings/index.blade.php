            ...
            <div class="col-lg-12 col-md-12 ntfcn-tab-content-left w-100 p-4 ">
                <div class="row">
                    ...
                    <div class="col-sm-12 mt-3">
                        <h4>@lang('modules.service jobs.reminder')</h4>
                    </div>

                    <div class="col-lg-6">
                        <x-forms.number :fieldLabel="__('modules.service jobs.preDeadlineReminder')"
                    ...
                    <div class="col-lg-3">
                        <div class="form-group my-3">
                            <label class="f-14 text-dark-grey mb-12 w-100"
                                for="usr">@lang('modules.service jobs.onDeadlineReminder')</label>
                            <div class="d-flex">
                    ...
                    <div class="col-lg-3">
                        <div class="form-group my-3">
                            <label class="f-14 text-dark-grey mb-12 w-100"
                                for="usr">@lang('modules.service jobs.isProjectRequired')</label>
                            <div class="d-flex">
                    ...
                    <div class="col-lg-6">
                        <x-forms.number :fieldLabel="__('modules.service jobs.postDeadlineReminder')"
                    ...
                    <div class="col-lg-3">
                        <x-forms.number :fieldLabel="__('modules.service jobs.taskboardDefaultLength')" fieldName="taskboard_length"
            ...
            <div class="col-lg-12 col-md-12 border-top-grey p-20">
                <div class="row">
                    <div class="col-sm-12 mt-3 p-20">
                        <h4>@lang('modules.service jobs.sectionVisibleClient')</h4>
                    </div>
                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.service jobs.taskCategory')" fieldName="task_category" fieldValue="yes"  fieldId="task_category"
                        fieldRequired="true" :checked="($taskSetting->task_category == 'yes') ? $taskSetting->task_category : ''" />
                    </div>

                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('app.site')" fieldName="site" fieldId="site" fieldValue="yes" fieldRequired="true" :checked="($taskSetting->site == 'yes') ? $taskSetting->site : ''"/>
                    </div>

                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.sites.startDate')" fieldName="start_date" fieldValue="yes" fieldId="start_date"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.service jobs.assignTo')" fieldName="assigned_to" fieldValue="yes" fieldId="assigned_to"
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.service jobs.assignBy')" fieldName="assigned_by" fieldId="assigned_by" fieldValue="yes"
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.service jobs.priority')" fieldName="priority" fieldId="priority" fieldValue="yes"
                        fieldRequired="true" :checked="($taskSetting->priority == 'yes') ? $taskSetting->priority : ''"/>
                    </div>

                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.service jobs.makePrivate')" fieldName="make_private" fieldId="make_private" fieldValue="yes"
                        fieldRequired="true" :checked="($taskSetting->make_private == 'yes') ? $taskSetting->priority : ''"/>
                    </div>

                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.service jobs.setTimeEstimate')" fieldName="time_estimate" fieldId="time_estimate" fieldValue="yes"
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.service jobs.comment')" fieldName="comments" fieldId="comments" fieldValue="yes"
                    ...
                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.service jobs.subTask')" fieldName="sub_task" fieldId="sub_task" fieldValue="yes" fieldRequired="true" :checked="($taskSetting->sub_task == 'yes') ?$taskSetting->sub_task : ''"/>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.sites.note')" fieldName="notes" fieldId="notes" fieldRequired="true" fieldValue="yes" :checked="($taskSetting->notes == 'yes') ? $taskSetting->notes : ''"/>
                    </div>

                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.service jobs.history')" fieldName="history" fieldId="history" fieldRequired="true" fieldValue="yes" :checked="($taskSetting->history == 'yes') ? $taskSetting->history : ''"/>
                    </div>

                </div>
                <div class="row">
                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.cleaners.hoursLogged')" fieldName="hours_logged" fieldId="hours_logged" fieldValue="yes"
                    ...
                    <div class="col-lg-4">
                        <x-forms.checkbox :fieldLabel="__('modules.service jobs.copyTaskLink')" fieldName="copy_task_link" fieldId="copy_task_link" fieldValue="yes"
...
@push('scripts')
    <script>
        $('#save-form').click(function() {
            ...
            $.easyAjax({
                url: "{{ route('service job-settings.store') }}",
