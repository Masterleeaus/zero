        ...
        <x-form id="save-attendance-data-form">
            <div class="add-customer bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-md-12">
                        <x-alert type="info" icon="info-circle">@lang('team chat.existingShiftOverride')</x-alert>
                    </div>

                    <div class="col-lg-3 col-md-6">
                        <x-forms.select fieldId="department_id" :fieldLabel="__('app.zone')" fieldName="department_id"
                            search="true">
                    ...
                    <div class="col-md-9">
                        <div class="form-group my-3">
                            <x-forms.label fieldId="selectEmployee" :fieldLabel="__('app.menu.cleaners')" fieldRequired="true">
                            </x-forms.label>
                            <x-forms.input-group>
                ...
                <div class="row px-4 pb-4">
                    ...
                    <div class="col-lg-4 col-md-6 single_date_div">
                        <x-forms.text :fieldLabel="__('team chat.selectMultipleDates')" fieldName="single_date" fieldId="single_date" :fieldPlaceholder="__('team chat.selectDate')"
