                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.select fieldId="payment_project_id" :fieldLabel="__('app.site')"
                            ...
                            @foreach ($sites as $site)
                                <option @if ($site->id == $payment->project_id) selected @endif value="{{ $site->id }}" data-currency-id="{{ $site->currency_id }}"
                                    data-currency-code="{{ $site->currency->currency_code }}">
                    ...
                    <div class="col-lg-12">
                        <x-forms.file allowedFileExtensions="txt pdf doc xls xlsx docx rtf png jpg jpeg svg" class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('app.receipt')" fieldName="bill"
                            fieldId="bill" :fieldValue="($payment->bill ? $payment->file_url : '')" :popover="__('team chat.fileFormat.multipleImageFile')" />
                    </div>
