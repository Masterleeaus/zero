                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.profile.profilePicture')"
                                ...
                                fieldId="profile-image" :popover="__('modules.themeSettings.logoSize')" :popover="__('team chat.fileFormat.ImageFile')">
                            </x-forms.file>
                        </div>
                        ...
                        <div class="col-lg-6">
                            <x-forms.password class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.profile.yourPassword')"
                                fieldName="password" fieldId="password" :fieldHelp="__('modules.customer.passwordUpdateNote')"
