                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group my-3">
                                        ...
                                        @if($consent->enquiry)
                                            <div class="d-flex">
                                                @if($consent->enquiry->status == 'agree')
                                ...
                                @empty
                                    <p class="text-center">
                                        <strong>@lang('team chat.noConsentFound')</strong>
                                        <x-cards.no-record icon="list" :message="__('team chat.noConsentFound')" />
                                    </p>
                                @endforelse
    ...
    <script>
        document.loading = '@lang('app.loading')';
         $(body).on('click', '#save-form', function() {
            $.easyAjax({
                url: "{{ route('front.gdpr.consent.update', [md5($enquiry->id)]) }}",
