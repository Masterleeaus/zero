...
@section('filter-section')
    <x-filters.filter-box>
        ...
        <div class="service job-search d-flex  py-1 pr-lg-3 px-0 border-right-grey align-items-center">
            <form class="w-100 mr-1 mr-lg-0 mr-md-1 ml-md-1 ml-0 ml-lg-0">
                <div class="input-group bg-grey rounded">
                    ...
                    <input type="text" class="form-control f-14 p-1 border-additional-grey" id="search-text-field"
                        placeholder="@lang('modules.zone.searchValidation')">
                </div>
            </form>
        </div>
        <!-- SEARCH BY TASK END -->
    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                ...
                <x-forms.link-primary :link="route('zones.create')" class="mr-3 openRightModal float-left" icon="plus" data-redirect-url="{{ route('zone.hierarchy') }}">
                    @lang('modules.zone.addTitle')
                </x-forms.link-primary>
                @endif
            </div>

            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                <a href="{{ route('zones.index') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
                data-original-title="@lang('modules.leaves.tableView')"><i class="side-icon bi bi-list-ul"></i></a>

                <a href="{{ route('zone.hierarchy') }}" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
                    data-original-title="@lang('modules.zone.hierarchy')"><i class="bi bi-diagram-3"></i></a>
            </div>
        </div>
            ...
            <div class="col-12 chart-section">
                <div class="row">
                    <div class="col-md-6" id="chartTree">
                        @include('zones-hierarchy.chart_tree')
                    </div>
                    <div class="col-md-6" id="chartOrganization">
                        @include('zones-hierarchy.chart_organization')
                    </div>
                </div>
            </div>
        </div>
...
<script>
    ...
    function searchText() {
        ...
        const url = "{{ route('zones.search') }}";

        $.easyAjax({
            url: url,
            container: '#search-zones',
            type: "GET",
            data: {
