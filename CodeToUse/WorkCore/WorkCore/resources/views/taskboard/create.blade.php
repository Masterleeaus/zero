<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.service jobs.addBoardColumn')</h5>
...
<div class="modal-body">
    <x-form id="createTaskBoardColumn">
        <div class="row">
            <div class="col-md-6">
                <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.service jobs.columnName')"
