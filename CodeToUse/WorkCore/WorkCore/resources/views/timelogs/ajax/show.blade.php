        ...
        <div class="col-sm-12 col-lg-7">
            <div class="card bg-white border-0 b-shadow-4">
                            ...
                            @if (
                                ...
                                <div class="dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right border-grey rounded b-shadow-4 p-0"
                                        ...
                                        @if (!is_null($timeLog->end_time) && (is_null($timeLog->project_id) || (!is_null($timeLog->site) && is_null($timeLog->site->deleted_at))))
                ...
                <div class="card-body">
                    ...
                    <x-cards.data-row :label="__('app.site')" :value="$timeLog->site->project_name ?? '--'" />
                    <x-cards.data-row :label="__('app.service job')" :value="$timeLog->service job->heading ?? '--'" />
                    ...
                    <div class="col-12 px-0 pb-3 d-flex">
                        ...
                        <p class="mb-0 text-dark-grey f-14">
                            ...
                            @endphp
                            <x-cleaner :user="$timeLog->user" :disabledLink="$isClient" />
                        </p>
                    </div>
        ...
        <div class="col-sm-12 col-lg-5">
            <div class="card bg-white border-0 b-shadow-4">
                <div class="card-header bg-white  border-bottom-grey  justify-content-between p-20">
                    <div class="row">
                        <div class="col-12">
                            <h3 class="heading-h1 mb-3">@lang('modules.service jobs.history')</h3>
                        </div>
                    </div>
                </div>
                <div class="card-body">
