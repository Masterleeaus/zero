<div class="row">
    <div class="col-sm-12">
        <x-form id="save-enquiry-note-data-form" method="PUT">
            <div class="add-customer bg-white rounded">
                ...
                <div class="row px-4">
                    <div class="col-md-12 col-lg-12">
                        <div class="form-group">
                            <x-forms.label class="my-3" fieldId="notes" fieldRequired="true" :fieldLabel="__('modules.customer.noteDetail')">
                            </x-forms.label>
                ...
                <x-form-actions>
                    <x-forms.button-primary id="save-enquiry-note-form" class="mr-3" icon="check">@lang('app.save')
...
<script>
    $(document).ready(function() {
        ...
        $('#save-enquiry-note-form').click(function() {
            ...
            $.easyAjax({
                url: url,
                container: '#save-enquiry-note-data-form',
                type: "POST",
                disableButton: true,
                blockUI: true,
                buttonSelector: "#save-enquiry-note-form",
                data: $('#save-enquiry-note-data-form').serialize(),
