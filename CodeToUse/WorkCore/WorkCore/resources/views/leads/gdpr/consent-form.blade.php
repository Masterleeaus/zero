...
<div class="modal-body">
    <x-form id="saveLeadConsentForm" method="POST" class="form-horizontal">
        ...
        <input type="hidden" name="status" value="@if($consent->enquiry && $consent->enquiry->status == 'agree') disagree @else agree @endif">
        <div class="row">
            <div class="col-md-12">
            ...
            @if(($consent->enquiry && $consent->enquiry->status == 'disagree') || !$consent->enquiry)
                <div class="col-md-12">
...
<div class="modal-footer">
    ...
    @if ($consent->enquiry && $consent->enquiry->status == 'agree')
