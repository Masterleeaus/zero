...
<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.enquiry.addFollowUp')</h5>
        ...
        <x-form id="followUpForm" method="POST" class="ajax-form">
            <div class="form-body">
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <x-cards.data-row :label="__('modules.enquiry.clientName')" :value="$deal->contact->client_name_salutation ?? '--'"
