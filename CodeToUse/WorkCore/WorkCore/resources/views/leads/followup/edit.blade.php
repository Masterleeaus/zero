    ...
    <h5 class="modal-title" id="modelHeading">@lang('modules.enquiry.editFollowUp')</h5>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <x-forms.datepicker fieldId="next_follow_up_date" fieldRequired="true"
                            :fieldLabel="__('modules.enquiry.leadFollowUp')" fieldName="next_follow_up_date"
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-6 mb-2">
                                <x-forms.select fieldId="status" :fieldLabel="__('modules.cleaners.status')" fieldName="status" search="true">
                    ...
                    <div class="col-md-12">
                        <div class="form-group my-3">
                            <x-forms.textarea class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.enquiry.remark')"
