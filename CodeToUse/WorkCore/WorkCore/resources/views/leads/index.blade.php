    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                ...
                <a href="{{ route('leadboards.index') }}" class="btn btn-secondary f-14" data-toggle="tooltip" data-original-title="@lang('modules.enquiry.kanbanboard')"><i class="side-icon bi bi-kanban"></i></a>
            </div>
        </div>
...
@push('scripts')
    ...
    <script>
        $('#enquiries-table').on('preXhr.dt', function(e, settings, data) {
            ...
            data['service / extra'] = service / extra;
        });
        const showTable = () => {
            window.LaravelDataTables["enquiries-table"].draw(true);
        }
        ...
        const applyQuickAction = () => {
            var rowdIds = $("#enquiries-table input:checkbox:checked").map(function() {
                return $(this).val();
            }).get();
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    if (response.status == "success") {
                        ...
                        $.easyBlockUI('#enquiries-table');
                        $.easyUnblockUI('#enquiries-table');
                        showTable();
                        resetActionButtons();
                        deSelectAll();
                    }
