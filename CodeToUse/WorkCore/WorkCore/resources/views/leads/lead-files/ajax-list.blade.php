...
<x-table class="table-hover bg-white rounded">
    <x-slot name="thead">
        <th>@lang('modules.sites.fileName')</th>
        <th>@lang('app.date')</th>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu dropdown-menu-right">
                                ...
                                @if ($deleteLeadFilePermission == 'all' || ($deleteLeadFilePermission == 'added' && $file->added_by == user()->id))
                                    <a class="dropdown-item delete-enquiry-file" href="javascript:;"
    ...
    @empty
        <tr>
            <td colspan="3" class="shadow-none">
                <x-cards.no-record icon="file-excel" :message="__('team chat.noFileUploaded')" />
            </td>
        </tr>
    @endforelse
</x-table>
