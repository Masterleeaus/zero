            ...
            <div class="tab-content" id="tab-content">
                    <div class="tab-pane active" id="personal">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4" id="yearly-leave-field" style="display: none;">
                                <x-forms.number :fieldLabel="__('modules.leaves.noOfYearlyLeaves')" fieldRequired="true"
                                                fieldName="yearly_leave_number" fieldId="yearly_leave_number" fieldValue="0" minValue="0" :popover="__('team chat.leave.noOfYearlyLeaves')"/>
                            </div>

                            <div class="col-lg-4" id="monthly-leave-field">
                                <x-forms.number :fieldLabel="__('modules.leaves.noOfMonthlyLeaves')" fieldRequired="true"
                                                fieldName="monthly_leave_number" fieldId="monthly_leave_number" fieldValue="0" minValue="0" :popover="__('team chat.leave.noOfMonthlyLeaves')"/>
                            </div>

                            <div class="col-lg-4">
                                <x-forms.select fieldId="paid" :fieldLabel="__('modules.leaves.leavePaidStatus')" fieldName="paid" search="true" :popover="__('team chat.leave.paidStatus')">
                            ...
                            <div class="col-lg-4" id="monthly-leave-limit">
                                <x-forms.number :fieldLabel="__('modules.leaves.monthLimit')" fieldRequired="true"
                                    fieldName="monthly_limit" fieldId="monthly_limit" fieldValue="0"
                                    :fieldHelp="__('modules.leaves.monthLimitInfo')" minValue="0"
                                    :popover="__('team chat.leave.monthlyLimit')"/>
                            </div>
                                ...
                                <div class="form-group my-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                                data-content="{{__('team chat.leave.effectiveAfter')}}" data-trigger="hover"></i>
                                ...
                                <div class="form-group">
                                    <div class="d-flex mt-3">
                                        <x-forms.checkbox :fieldLabel="__('modules.leaves.allowedProbation')"
                                                ...
                                                :popover="__('team chat.leave.allowedProbation')"/>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4">
                                <div class="form-group my-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                                data-content="{{__('team chat.leave.unusedLeave')}}" data-trigger="hover"></i>
                                        <div class="col-md-6">
                                            <x-forms.input-group>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group my-3">
                                    <div class="d-flex align-items-center">
                                        ...
                                        &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                                data-content="{{__('team chat.leave.overutilization')}}" data-trigger="hover"></i>
                                        <div class="col-md-7">
                                            <x-forms.input-group>
                                ...
                                <div class="form-group">
                                    <div class="d-flex mt-3">
                                        <x-forms.checkbox :fieldLabel="__('modules.leaves.allowedNotice')"
                                                ...
                                                :popover="__('team chat.leave.allowedNotice')"/>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-pane" id="vacation">
                        ...
                        <div class="row">
                            <div class="col-lg-4">
                                <div class="form-group my-3">
                                    <x-forms.label fieldId="gender" :fieldLabel="__('modules.cleaners.gender')" fieldRequired="true">
                                    </x-forms.label>
                                    &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                            data-content="{{__('team chat.leave.gender')}}" data-trigger="hover"></i>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group my-3">
                                    <x-forms.label fieldId="marital_status" :fieldLabel="__('modules.cleaners.maritalStatus')" fieldRequired="true">
                                    </x-forms.label>
                                    &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                            data-content="{{__('team chat.leave.maritalStatus')}}" data-trigger="hover"></i>
                            ...
                            <div class="col-lg-4">
                                <div class="form-group my-3">
                                    <x-forms.label fieldId="zone" :fieldLabel="__('app.zone')" fieldRequired="true">
                                    </x-forms.label>
                                    &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                            data-content="{{__('team chat.leave.zone')}}" data-trigger="hover"></i>
                                    <select class="form-control multiple-option" multiple name="zone[]"
                                            id="zone" data-live-search="true" data-size="8">
                            ...
                            <div class="col-lg-4">
                                <div class="form-group my-3">
                                    ...
                                    &nbsp;<i class="fa fa-question-circle text-dark-grey" data-toggle="popover" data-placement="top" data-html="true"
                                            data-content="{{__('team chat.leave.role')}}" data-trigger="hover"></i>
