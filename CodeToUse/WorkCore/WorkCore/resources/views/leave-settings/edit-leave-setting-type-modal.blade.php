                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4" id="yearly-leave-field" style="display: none;">
                            <x-forms.number :fieldLabel="__('modules.leaves.noOfYearlyLeaves')"
                                fieldName="yearly_leave_number" fieldId="yearly_leave_number" fieldValue="$leaveType->no_of_leaves" minValue="0" :popover="__('team chat.leave.noOfYearlyLeaves')"/>
                        </div>

                        <div class="col-lg-4" id="monthly-leave-field">
                            <x-forms.number :fieldLabel="__('modules.leaves.noOfMonthlyLeaves')"
                                fieldName="monthly_leave_number" fieldId="monthly_leave_number" fieldValue="$leaveType->no_of_leaves" minValue="0" :popover="__('team chat.leave.noOfMonthlyLeaves')"/>
                        </div>
                        ...
                        <div class="col-lg-4" id="monthly-leave-limit">
                            <x-forms.number :fieldLabel="__('modules.leaves.monthLimit')"
                                ...
                                fieldRequired="true" :fieldHelp="__('modules.leaves.monthLimitInfo')" minValue="0" :popover="__('team chat.leave.monthlyLimit')"/>
                        </div>

                        <div class="col-lg-4">
                            <x-forms.select fieldId="paid" fieldLabel="Leave Paid Status" fieldName="paid" search="true" :popover="__('team chat.leave.paidStatus')">
                                ...
                                <select class="form-control multiple-option" multiple name="zone[]"
                                    ...
                                    @foreach ($allTeams as $allTeam)
                                        <option value="{{ $allTeam->id }}"
                                            @if (is_array($zone) && in_array($allTeam->id, $zone))
                                                selected
                                            @endif
                                ...
                                <select class="form-control multiple-option" multiple name="role[]"
                                    ...
                                    @foreach ($allDesignations as $allDesignation)
                                        <option value="{{ $allDesignation->id }}"
                                            @if (is_array($role) && in_array($allDesignation->id, $role))
                                                selected
                                            @endif
