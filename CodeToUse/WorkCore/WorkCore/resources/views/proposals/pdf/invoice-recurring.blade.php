            ...
            <td>
                <div id="invoiced_to">
                    @if(!is_null($invoice->site) && !is_null($invoice->site->customer) && !is_null($invoice->site->customer->clientDetails))
                        ...
                        <h3 class="name">{{ $invoice->site->customer->clientDetails->company_name }}</h3>
                        <div class="mb-3">
                        ...
                        @if($invoiceSetting->show_gst == 'yes' && !is_null($invoice->site->customer->clientDetails->gst_number))
                            <div> @lang('app.gstIn'): {{ $invoice->site->customer->clientDetails->gst_number }} </div>
                        @endif
                    ...
                    @if(is_null($invoice->site) && !is_null($invoice->quote) && !is_null($invoice->quote->customer->clientDetails))
                        <small>@lang("modules.invoices.billedTo"):</small>
                        <h3 class="name">{{ $invoice->quote->customer->clientDetails->company_name }}</h3>
                        <div class="mb-3">
                            <b>@lang('app.address') :</b>
                        ...
                        @if($invoiceSetting->show_gst == 'yes' && !is_null($invoice->quote->customer->clientDetails->gst_number))
                            <div> @lang('app.gstIn'): {{ $invoice->quote->customer->clientDetails->gst_number }} </div>
                        @endif
                    @endif
                </div>
            </td>
