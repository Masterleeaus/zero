...
<div id="container">
    ...
    <div class="right-invoice description">
        ...
        <section id="invoice-info" class="description">
            <div>
                <span>@lang('modules.enquiry.proposal'):</span>
            ...
            <div>
                <span>@lang('modules.quotes.validTill'):</span>
