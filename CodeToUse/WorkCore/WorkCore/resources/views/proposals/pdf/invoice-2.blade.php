    ...
    <div class="invoice-top">
        ...
        <section id="invoice-info" class="descriptionFont">
            <table class="descriptionFont">
                ...
                <tr>
                    <td>@lang('modules.quotes.validTill'):</td>
            ...
            <section id="customer-info">
                ...
                <div class="descriptionFont">
                    ...
                    @if ($proposal->enquiry->contact && $proposal->enquiry->contact->client_name && $invoiceSetting->show_client_name == 'yes')
                        <span class="bold descriptionFont">{{ $proposal->enquiry->contact->client_name_salutation }}</span>
                    @endif
                    @if ($proposal->enquiry->contact && $proposal->enquiry->email && $invoiceSetting->show_client_email == 'yes')
                        <div class="descriptionFont">{{ $proposal->enquiry->contact->client_email }}</div>
                    @endif
                    @if ($proposal->enquiry->contact && $proposal->enquiry->contact->mobile && $invoiceSetting->show_client_phone == 'yes')
                        <div class="descriptionFont">{{ $proposal->enquiry->contact->mobile }}</div>
                    @endif
                    @if ($proposal->enquiry->contact && $proposal->enquiry->contact->company_name && $invoiceSetting->show_client_company_name == 'yes')
                        <div class="descriptionFont">{{ $proposal->enquiry->contact->company_name }}</div>
                    @endif
                    @if ($proposal->enquiry->contact && $proposal->enquiry->contact->address && $invoiceSetting->show_client_company_address == 'yes')
                        <div class="descriptionFont">{!! nl2br($proposal->enquiry->contact->address) !!}</div>
                    @endif
                </div>
            </section>
        @endif
        ...
        <section>
            @if ($proposal->signature)
                @if (!is_null($proposal->signature->signature))
                    ...
                    <h6 class="descriptionFont">@lang('modules.quotes.signature')</h6>
                @else
                    <h6 class="descriptionFont">@lang('modules.quotes.signedBy')</h6>
                @endif
