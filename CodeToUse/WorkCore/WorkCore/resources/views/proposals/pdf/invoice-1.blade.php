                    ...
                    <div>
                        ...
                        <div class="mb-3 description">
                            ...
                            @if ($proposal->enquiry->contact && $proposal->enquiry->contact->client_name && $invoiceSetting->show_client_name == 'yes')
                                <b>{{ $proposal->enquiry->contact->client_name_salutation }}</b>
                            @endif
                            @if ($proposal->enquiry && $proposal->enquiry->contact->client_email && $invoiceSetting->show_client_email == 'yes')
...
<main>
    <div id="details">
        ...
        <div id="invoice" class="description">
            ...
            <div class="description">@lang('modules.quotes.validTill'):
        ...
        @if ($proposal->signature)
            ...
            <span>
                @if (!is_null($proposal->signature->signature))
                    ...
                    <h6 class="description">@lang('modules.quotes.signature')</h6>
                @else
