            ...
            <tbody>
                ...
                <tr class="d-none d-md-table-row d-lg-table-row">
                    ...
                    <td class="border-left-0">
                        <input type="file" class="dropify" id="dropify" name="invoice_item_image[]" data-allowed-file-extensions="png jpg jpeg bmp" data-team chat-default="test" data-height="70"
