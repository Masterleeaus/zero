<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.quotes.signatureAndConfirmation')</h5>
    ...
    <x-form id="acceptEstimate">
        ...
        <div class="row">
            ...
            <div class="col-sm-12 bg-grey p-4 signature">
                <x-forms.label fieldId="signature-pad" :fieldLabel="__('modules.quotes.signature')" :fieldRequired="$proposal->signature_approval ? true : false" />
            ...
            <div class="col-sm-12 p-4 d-none upload-image">
                <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.quotes.signature')" fieldName="image"
                    fieldId="image" :popover="__('team chat.fileFormat.ImageFile')" :fieldRequired="$proposal->signature_approval ? true : false" />
            </div>
            <div class="col-sm-12 mt-3">
                <x-forms.button-secondary id="undo-signature" class="signature">@lang('modules.quotes.undo')</x-forms.button-secondary>
                <x-forms.button-secondary class="ml-2 signature" id="clear-signature">@lang('modules.quotes.clear')
