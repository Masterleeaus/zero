 ...
 <div class="d-flex justify-content-between action-bar">
    <div id="table-actions" class="flex-grow-1 align-items-center">
        @if ($addTicketPermission == 'all' || $addTicketPermission == 'added')
            <x-forms.link-primary :link="route('issues / support.create').'?default_client='.$customer->id" class="mr-3 openRightModal float-left"
                icon="plus" data-redirect-url="{{ route('customers.show', $customer->id) . '?tab=issues / support' }}">
