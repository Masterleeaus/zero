<div class="row">
    <div class="col-sm-12">
        <x-form id="save-customer-note-data-form">
                ...
                <div class="row px-4 d-none" id="private-note-details">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            <x-forms.label class="my-3" fieldId="selectEmployee" :fieldRequired="(!in_array('customer', user_roles())) ? true : false" :fieldLabel="__('app.cleaner')">
                            </x-forms.label>
                            <x-forms.input-group>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-customer-note-form').click(function() {
            ...
            const url = "{{ route('customer-notes.store') }}";
