        ...
        <x-form id="save-customer-data-form">
            ...
            <div class="add-customer bg-white rounded">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <x-forms.label class="mt-3" fieldId="password" :fieldLabel="__('app.password')"
                                    :popover="__('team chat.requiredForLogin')">
                                </x-forms.label>
                                <x-forms.input-group>
                                    ...
                                    <x-slot name="append">
                                        <button id="random_password" type="button" data-toggle="tooltip"
                                            data-original-title="@lang('modules.customer.generateRandomPassword')"
                ...
                <x-form-actions>
                    ...
                    <x-forms.button-cancel :link="route('customers.show', $clientId) . '?tab=contacts'" class="border-0">
                        @lang('app.cancel')
