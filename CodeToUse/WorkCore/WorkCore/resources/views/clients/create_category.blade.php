<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.customer.clientCategory')</h5>
    <button type="button"  class="close" data-dismiss="modal" aria-label="Close"><span
            aria-hidden="true">×</span></button>
</div>
<div class="modal-body">
    <x-table class="table-bordered customer-cat-table" headType="thead-light">
        <x-slot name="thead">
            <th>#</th>
...
<script>
    ...
    $('.customer-cat-table [contenteditable=true]').focus(function() {
