...
<div class="modal-body">
    <x-alert type="warning" class="">
        @lang('team chat.selectRunRotation')
    </x-alert>
                    ...
                    @else
                        @foreach($rotations as $rotation)
                            <tr>
                                ...
                                <td>
                                    <a href="javascript:;" class="text-darkest-grey" id="manageEmployees" data-rotation-id="{{ $rotation->id }}" data-toggle="tooltip" data-original-title="@lang('Manage Cleaners')">
