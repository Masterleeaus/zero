    ...
    <div class="row">
        ...
        <div class="col-lg-12">
            <div class="row mt-3">
                ...
                <div class="col-lg-12 mb-1">
                    <x-forms.checkbox :fieldLabel="__('modules.attendance.sendMonthlyReport')" :popover="__('team chat.sendMonthlyReportTooltip')" fieldName="monthly_report" fieldId="monthly_report" fieldValue="1"
