                ...
                @endif
                    ...
                    <div class="col-lg-2 my-3">
                        <x-forms.checkbox :fieldLabel="__('modules.events.repeat')" fieldName="repeat"
                            fieldId="repeat-event" fieldValue="yes" fieldRequired="true" :checked="true"/>
                    </div>
                    ...
                    <div class="col-lg-12 repeat-event-div">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4">
                                <x-forms.number class="mr-0 mr-lg-2 mr-md-2 mt-0" :fieldLabel="__('modules.events.cycles')" fieldName="repeat_cycles"
                                    fieldRequired="true" fieldId="repeat_cycles" fieldPlaceholder="" minValue="1"/>
                            </div>
                        </div>
                    </div>
...
<script>
        ...
        $.easyAjax({
            ...
            success: function (data) {
                ...
                $('#selectAssignee').html(data.data);
                    ...
                    $('#selectAssignee').html('<option>No cleaners found</option>');
                }
    ...
    $(document).ready(function() {
        ...
        $('#save-event-form').click(function() {
            ...
            const url = "{{ route('recurring-event.store') }}";
