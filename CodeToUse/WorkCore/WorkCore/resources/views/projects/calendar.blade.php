    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar mb-2">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                <a href="{{ route('sites.index') }}" class="btn btn-secondary f-14 sites" data-toggle="tooltip"
                    ...
                    @endif
                    <a href="{{ route('site-calendar.index') }}" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
