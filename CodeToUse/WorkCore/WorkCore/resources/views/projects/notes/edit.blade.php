<div class="row">
    <div class="col-sm-12">
        <x-form id="save-site-note-data-form" method="PUT">
                            ...
                            <x-forms.input-group>
                                <select class="form-control multiple-users" multiple name="user_id[]"
                                    ...
                                    @foreach ($cleaners as $cleaner)
                                        <x-user-option :user="$cleaner" :pill="true" :selected="in_array($cleaner->id, $noteMembers)" />
                                    @endforeach
                                </select>
                            </x-forms.input-group>
                        </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-site-note-form').click(function() {
            ...
            const url = "{{ route('site-notes.update', $note->id) }}";
