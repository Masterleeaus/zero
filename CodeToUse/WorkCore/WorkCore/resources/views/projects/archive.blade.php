...
@section('filter-section')
    ...
    <x-filters.filter-box>
        ...
        <div class="select-box d-flex py-2 {{ !in_array('customer', user_roles()) ? 'px-lg-2 px-md-2 px-0' : '' }}  border-right-grey border-right-grey-sm-0">
    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                <a href="{{ route('sites.index') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
                    data-original-title="@lang('app.menu.sites')"><i class="side-icon bi bi-list-ul"></i></a>

                    <a href="{{ route('sites.archive') }}" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
    ...
    <script>
        ...
        $('body').on('click', '.restore-site', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('sites.archive_restore', ':id') }}";
                    url = url.replace(':id', id);
