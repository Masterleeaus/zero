    ...
    <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
        ...
        <div class="d-flex justify-content-between">
            <div id="table-actions" class="align-items-center">
                @if (($addPaymentPermission == 'all' || $addPaymentPermission == 'added') && !$site->trashed())
                    <x-forms.link-primary :link="route('payments.create').'?site='.$site->id" class="mr-3 float-left openRightModal"
