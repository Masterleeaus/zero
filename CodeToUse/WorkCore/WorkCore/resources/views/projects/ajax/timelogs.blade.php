...
<div class="row py-3 py-lg-5 py-md-5">
    <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
        ...
        <div class="d-flex" id="table-actions">
            @if (($addTimelogPermission == 'all' || $addTimelogPermission == 'added') && !$site->trashed())
                <x-forms.link-primary :link="route('timelogs.create').'?default_project='.$site->id"
            ...
            <form action="" class="flex-grow-1 " id="filter-form">
                <div class="d-block d-lg-flex d-md-flex my-3">
                    ...
                    <div class="select-box py-2 px-0 mr-3">
                        <x-forms.label :fieldLabel="__('app.cleaner')" fieldId="cleaner" />
