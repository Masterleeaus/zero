...
<div class="tab-pane fade show active mt-5" role="tabpanel" aria-labelledby="nav-email-tab">
    ...
    <x-cards.data :title="__('modules.sites.files')">

        @if (($addFilePermission == 'all' || $addFilePermission == 'added' || $site->project_admin == user()->id) && !$site->trashed())
            ...
            <x-form id="save-taskfile-data-form" class="d-none">
                ...
                <div class="row">
                    <div class="col-md-12">
                        <x-forms.file-multiple :fieldLabel="__('modules.sites.uploadFile')" fieldName="file" fieldId="employee_file" />
                    </div>
                    <div class="col-md-12">
        ...
        @if ($viewFilePermission == 'all' || ($viewFilePermission == 'added' && user()->id == $site->added_by) || ($viewFilePermission == 'owned' && user()->id == $site->client_id))
...
<script>
    $(document).ready(function () {
        ...
        var trashed = "{{ $site->trashed() }}";
        var isProjectAdmin = {{ ($site->project_admin == user()->id) ? 1 : 0 }};
