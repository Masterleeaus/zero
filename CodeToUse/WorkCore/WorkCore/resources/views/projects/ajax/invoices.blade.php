    ...
    @else
        <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
            ...
            <div class="d-flex" id="table-actions">
                @if (($addInvoicePermission == 'all' || $addInvoicePermission == 'added') && !$site->trashed())
                    <x-forms.link-primary
                        :link="route('invoices.create').'?project_id='.$site->id.'&client_id='.$site->client_id"
                    ...
                    @if (in_array('timelogs', user_modules()))
                        <x-forms.link-secondary class="mr-3 float-left mb-2 mb-lg-0 mb-md-0 openRightModal" icon="plus" :link="route('invoices.create', ['type' => 'timelog', 'project_id' => $site->id])">
