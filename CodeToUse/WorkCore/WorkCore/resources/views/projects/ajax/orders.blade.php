...
<div class="row py-5">
    ...
    @if (is_null($site->client_id))
        <div class="col-lg-12 col-md-12">
            <x-cards.no-record icon="user" :message="__('team chat.assignClientFirst')" />
        </div>
    @else
        <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4">
            ...
            <div class="d-flex" id="table-actions">
                @if (!in_array('customer', user_roles()) && in_array('customers', user_modules()) && ($addOrderPermission == 'all' || $addOrderPermission == 'added') && !$site->trashed())
                    <x-forms.link-primary :link="route('orders.create').'?project_id='.$site->id.'&client_id='.$site->client_id"
