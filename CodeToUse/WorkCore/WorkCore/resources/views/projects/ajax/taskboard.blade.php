...
<div class="w-service job-board-box px-4 py-2 pt-3 bg-white">
    ...
    <div class="d-block d-lg-flex d-md-flex my-3">
        ...
        <div id="table-actions" class="flex-grow-1 align-items-center">
            ...
            @endif
            @if (user()->permission('change_status') == 'all' && !$site->trashed())
...
<script>
    $(document).ready(function() {
        function loadData() {
            ...
            var startDate = null;
            var endDate = null;
            var projectAdmin = "{{ ($site->project_admin == user()->id) ? 1 : 0 }}";
