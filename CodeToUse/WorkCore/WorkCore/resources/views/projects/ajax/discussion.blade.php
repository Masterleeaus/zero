...
<div class="row pb-5">
    <div class="col-lg-12 col-md-12 mb-4 mb-xl-0 mb-lg-4 mt-3 mt-lg-5 mt-md-5">
        ...
        <div class="d-flex" id="table-actions">
            @if (($addDiscussionPermission == 'all' || $addDiscussionPermission == 'added' || $site->project_admin == user()->id) && !$site->trashed())
                <x-forms.button-primary class="mr-3 float-left" id="add-discussion" icon="plus" data-redirect-url="{{ route('sites.show', $site->id) . '?tab=discussion' }}">
...
<script>
    ...
    $('body').on('click', '#add-discussion', function() {
        ...
        var url = "{{ route('discussion.create') }}?id="+"{{ $site->id }}&redirectUrl="+redirectUrl;
