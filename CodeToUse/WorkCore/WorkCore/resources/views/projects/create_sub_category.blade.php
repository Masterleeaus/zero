<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.customer.projectSubCategory')</h5>
    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
            aria-hidden="true">×</span></button>
</div>
<div class="modal-body">
    <x-table class="table-bordered customer-subcat-table" headType="thead-light">
        <x-slot name="thead">
            <th>#</th>
    ...
    <x-form id="createProjectCategory">
        <div class="row border-top-grey ">
            <div class="col-sm-12 col-md-6">
                <x-forms.select fieldId="create_category_id" :fieldLabel="__('modules.customer.clientCategory')"
...
<script>
    ...
    $('.customer-subcat-table [contenteditable=true]').focus(function() {
