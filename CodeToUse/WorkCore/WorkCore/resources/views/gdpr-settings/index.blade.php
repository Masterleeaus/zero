...
@section('content')
    ...
    <div class="w-100 d-flex ">
        ...
        <x-setting-card>
            ...
            <div class="s-b-n-header" id="tabs">
                <nav class="gdpr-tabs tabs border-bottom-grey">
                    <ul class="nav -primary" id="nav-tab" role="tablist">
                        ...
                        <li>
                            <a class="nav-item nav-link f-15 removal-requests-enquiry"
                                href="{{ route('gdpr-settings.index') }}?tab=removal-requests-enquiry" role="tab"
                                aria-controls="nav-removalRequests"
            ...
            @else
            <!-- Team Chat Item when GDPR is disabled -->
            <div class="col-lg-12">
