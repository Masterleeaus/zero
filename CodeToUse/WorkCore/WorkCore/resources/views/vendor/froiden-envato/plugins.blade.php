                    ...
                    <a href="{{ $module['product_link'] }}" target="_blank" class="block h-full">
                        ...
                        >
                            ...
                            <h3 class="text-sm font-bold text-amber-600 text-center mb-2 leading-tight">
                                {{ ucwords(str_replace(['for workcore saas','for workcore', 'workcore', 'crm','advanced reporting sites'], '', strtolower($module['product_name']))) }}
                    ...
                    <a href="{{ $module['product_link'] }}" target="_blank" class="block h-full">
                        ...
                        >
                            ...
                            <h3 class="text-sm font-bold text-gray-900 text-center mb-2 leading-tight">
                                {{ ucwords(str_replace(['for workcore saas crm', 'for workcore saas','- advanced reporting  sites'], '', strtolower($module['product_name']))) }}
                            </h3>
