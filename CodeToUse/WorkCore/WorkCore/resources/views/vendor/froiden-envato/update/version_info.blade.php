    ...
    <table class="table table-bordered">
        ...
        <td>
            ...
            @if (version_compare(PHP_VERSION, '8.2.0') >= 0)
                 <i class="fa fa-check-circle text-success"></i>
            @else
                <i data-toggle="tooltip" data-original-title="@lang('team chat.phpUpdateRequired')" class="fa fa-warning text-danger"></i>
            @endif
        </td>
            ...
            <tr>
                ...
                <td>
                    ...
                    <span class="show-hide-purchase-code" data-toggle="tooltip"
                          data-original-title="{{__('team chat.showHidePurchaseCode')}}">
