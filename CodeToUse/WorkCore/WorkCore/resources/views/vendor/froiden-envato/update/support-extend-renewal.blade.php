...
<div class="support-div mb-2">
            ...
            <div class="row">
                ...
                <div class="col-md-12 mt-3">
                    ...
                    @if($expired)
                        ...
                        <x-forms.link-secondary class="mr-2 e-btn--3d -color-primary -size-m -width-full h-mt"
                                                link="https://froiden.freshdesk.com/support/issues / support/new"
                                                target="_blank"
                                                data-toggle="tooltip"
                                                data-original-title="Contact Author for any query"
                                                icon="external-link-alt">Contact Author Support
                        </x-forms.link-secondary>
                        <x-forms.link-secondary class="mr-2 e-btn--3d -color-primary -size-m -width-full h-mt"
                                                link="https://bit.ly/workcore-amc-offer"
                                                target="_blank"
                                                data-toggle="tooltip"
                                                data-original-title="Tired of long waits for issue / support resolutions? Save 50% and get lots of features with our amc plans"
                                                icon="external-link-alt">Check AMC Offer
                        </x-forms.link-secondary>
    ...
    @if(!$expired && $support->diffInDays()>91)
            @includeIf('vendor.froiden-envato.update.amc')
        @endif
    @else
        @includeIf('vendor.froiden-envato.update.amc')
    @endif
