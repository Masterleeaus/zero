        ...
        <x-form id="save-holiday-data-form" method="PUT">
            <div class="add-customer bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-6">
                        <x-forms.label class="my-3" fieldId="employee_department" :fieldLabel="__('app.zone')">
                        </x-forms.label>
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="zone[]" id="employee_department"
                    ...
                    <div class="col-lg-6">
                        <x-forms.label class="my-3" fieldId="employee_designation" :fieldLabel="__('app.role')">
                        </x-forms.label>
                        <x-forms.input-group>
                            <select class="form-control select-picker" name="role[]" id="employee_designation"
                                data-live-search="true" multiple data-size="4">

                                @foreach ($roles as $role)
                                    <option {{ in_array($role->id, $designationArray) ? 'selected' : '' }} value="{{ $role->id }}">
                                        {{ $role->name }}</option>
                                @endforeach
                            </select>
                        </x-forms.input-group>
                    ...
                    <div class="col-lg-6">
                        <x-forms.select fieldId="employment_type" :fieldLabel="__('modules.cleaners.employmentType')" fieldName="employment_type[]"
