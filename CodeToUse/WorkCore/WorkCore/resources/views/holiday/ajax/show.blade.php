            ...
            <div class="bg-white border-0 card b-shadow-4">
                ...
                <div class="card-body">
                    ...
                    <x-cards.data-row :label="__('modules.holiday.occasion')" :value="$holiday->occassion" html="true" />
                        {{-- @dd($zone) --}}
                    <x-cards.data-row :label="__('app.zone')" :value="$zone ? $zone : '--'" html="true" />
                    <x-cards.data-row :label="__('app.role')" :value="$role ? $role : '--'" html="true" />

                    <x-cards.data-row :label="__('modules.cleaners.employmentType')" :value="$employment_type ? $employment_type : '--'" />
