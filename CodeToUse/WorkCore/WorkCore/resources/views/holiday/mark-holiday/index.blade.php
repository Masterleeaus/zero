                ...
                <div class="col-lg-5">
                    <div class="form-group my-3">
                        <x-forms.text :fieldLabel="__('modules.holiday.occasion')" fieldName="occassion"
                            ...
                            fieldValue="" data-toggle="tooltip" data-original-title="{{ __('team chat.selectOccassion')}}" />
                    </div>
                </div>
...
<script>
    ...
    $('body').on('click', '#save-mark-holiday', function() {
            Swal.fire({
                title: "@lang('team chat.markHolidayTitle')",
                text: "@lang('team chat.noteHolidayText')",
                icon: 'warning',
                showCancelButton: true,
                focusConfirm: false,
                confirmButtonText: "@lang('team chat.confirmSave')",
