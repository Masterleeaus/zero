        ...
        @if (in_array('customers', user_modules()))
            <div class="select-box d-flex  py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
                ...
                <div class="select-status">
                    <select class="form-control select-picker" name="cleaner" id="clientID" data-live-search="true"
                        data-size="8">
...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex flex-column">
            <!-- TASK STATUS START -->
            <x-cards.data id="service job-chart-card" :title="__($pageTitle)">
            </x-cards.data>
            <!-- TASK STATUS END -->
        ...
        function pieChart() {
            ...
            $.easyAjax({
                ...
                success: function(response) {
                    $('#service job-chart-card .card-body').html(response.html);
