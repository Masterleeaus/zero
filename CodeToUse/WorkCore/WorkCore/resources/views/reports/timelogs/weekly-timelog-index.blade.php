        ...
        <div class="d-flex flex-column">
            ...
            <div id="table-actions" class="flex-grow-1 align-items-center">
                ...
                <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                    <a href="{{ route('time-log-weekly-report.index') }}" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
                        data-original-title="@lang('app.menu.weeklyTimehsheet')"><i class="side-icon bi bi-list-ul"></i></a>

                    <a href="{{ route('weekly-pending-time-log-report.report') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
