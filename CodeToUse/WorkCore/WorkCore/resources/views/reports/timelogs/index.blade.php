...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex flex-column">
            <!-- TASK STATUS START -->
            <x-cards.data id="service job-chart-card" :title="__($pageTitle)" padding="false">
            </x-cards.data>
            <!-- TASK STATUS END -->
            ...
            <div id="table-actions" class="flex-grow-1 align-items-center">
                ...
                <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                    ...
                    <a href="{{ route('site-wise-timelog.report') }}" class="btn btn-secondary f-14" data-toggle="tooltip"
...
@push('scripts')
    ...
    <script>
        ...
        $('#project_id, #cleaner, #customer, #status, #invoice_generate').on('change keyup',
            function() {
                if ($('#status').val() != "all") {
