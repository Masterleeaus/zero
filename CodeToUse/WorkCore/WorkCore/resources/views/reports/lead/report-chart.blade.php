...
@section('filter-section')
    <div class="d-flex filter-box site-header bg-white border-bottom">
        ...
        <div class="site-menu d-lg-flex" id="mob-customer-detail">
            ...
            <x-tab :href="route('enquiry-report.index') . '?tab=profile'" :text="__('modules.deal.profile')" class="profile" />
            <x-tab :href="route('enquiry-report.chart') . '?tab=chart'" :text="__('modules.leadContact.leadReport')" class="chart" />
...
@section('content')
    <div class="content-wrapper">
        ...
        <x-alert type="info" icon="info-circle">
            @lang('team chat.dealCloseDateMsg')
        </x-alert>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#pipeline, #year, #category').on('change', function() {
                ...
                $.easyAjax({
                    url: "{{ route('enquiry-report.chart') }}",
                    type: "GET",
                    data: {
                        year: year,
                        pipeline: pipeline,
