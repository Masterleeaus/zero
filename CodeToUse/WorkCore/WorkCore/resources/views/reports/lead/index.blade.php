...
@section('filter-section')
    ...
    <div class="d-flex filter-box site-header bg-white">
        ...
        <div class="site-menu d-lg-flex" id="mob-customer-detail">
            ...
            <x-tab :href="route('enquiry-report.profile') . '?tab=profile'" :text="__('modules.deal.profile')" class="profile" />
            <x-tab :href="route('enquiry-report.chart') . '?tab=chart'" :text="__('modules.leadContact.leadReport')" class="files active-tab" ajax="false" />
        </div>
