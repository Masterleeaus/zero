...
<div class="bg-white rounded b-shadow-4 create-inv">
    ...
    <div class="px-lg-4 px-md-4 px-3 py-3">
        <h4 class="mb-0 f-21 font-weight-normal ">@lang('modules.orders.createOrder')</h4>
    </div>
    <!-- HEADING END -->
    ...
    <x-form class="c-inv-form" id="saveInvoiceForm">
        ...
        <div class="row px-lg-4 px-md-4 px-3 pt-3">
            ...
            <div class="col-md-4 mb-4">
                ...
                @else
                    <x-customer-selection-dropdown :customers="$customers" :selected="null" />
                @endif
            </div>
            <!-- CLIENT END -->
            ...
            <div class="col-md-4">
                <div class="form-group c-inv-select mb-lg-0 mb-md-0 mb-4">
                    ...
                    <p class="f-15" id="client_shipping_address">
                        @if (isset($quote) && $quote->customer && $quote->customer->clientDetails->shipping_address)
                            {!! nl2br($quote->customer->clientDetails->shipping_address) !!}
                        @elseif(isset($customer) && $customer->clientDetails && $customer->clientDetails->shipping_address)
                    ...
                    <p class="d-none" id="add-shipping-field">
                        <textarea class="form-control f-14 pt-2" rows="3" placeholder="@lang('placeholders.address')"
                            ...
                            id="shipping_address">@if (isset($quote) && $quote->customer) {!! nl2br($quote->customer->clientDetails->shipping_address) !!} @endif</textarea>
                    </p>
                </div>
            </div>
        ...
        <x-alert class="my-4 mx-4" id="alertMessage" type="danger">@lang('team chat.addItem')</x-alert>
        <div id="sortable">
        </div>
                            ...
                            <table width="100%">
                                <tbody>
                                    ...
                                    <tr>
                                                    ...
                                                    <tr>
                                                        <td width="70%" class="c-inv-sub-padding">
                                                            <input type="number" min="0" name="discount_value"
                                                                ...
                                                                placeholder="0"
                                                                value="{{ isset($quote) ? $quote->discount : '0' }}">
                                                        </td>
                                                        <td width="30%" align="left" class="c-inv-sub-padding">
                                                            <div
                                                                ...
                                                                <select class="form-control select-picker"
                                                                    ...
                                                                    <option @selected(isset($quote) && $quote->discount_type == 'percent') value="percent">%
                                                                    </option>
                                                                    <option @selected(isset($quote) && $quote->discount_type == 'fixed') value="fixed">
                                        ...
                                        <td><span
                                                id="discount_amount">{{ isset($quote) ? number_format((float) $quote->discount, 2, '.', '') : '0.00' }}</span>
                                        </td>
                                    </tr>
                                    <tr>
