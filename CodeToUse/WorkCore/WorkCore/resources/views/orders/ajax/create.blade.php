                    ...
                    <div class="form-group c-inv-select mb-4">
                        <select class="form-control select-picker" data-live-search="true" data-size="8"
                            ...
                            @foreach ($customers as $item)
                                <x-user-option :user="$clientOpt" :selected="isset($quote) && $item->id == $quote->client_id"/>
                            @endforeach
                        </select>
                    </div>
                @endif
                                                        ...
                                                        <td width="50%" align="left" class="c-inv-sub-padding">
                                                            <div
                                                                ...
                                                                <select class="form-control select-picker"
                                                                    ...
                                                                    <option
                                                                        @selected (isset($quote) && $quote->discount_type == 'percent')
                                                                        value="percent">%
                                                                    </option>
                                                                    <option
                                                                        @selected (isset($quote) && $quote->discount_type == 'fixed')
                                                                        value="fixed">
