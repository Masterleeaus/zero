                        ...
                        <td width="50%" class="p-0 border-0 c-inv-total-right">
                            <table width="100%">
                                <tbody>
                                    ...
                                    {{-- {{in_array('customer', user_roles()) ? 'd-none' : ''}} --}}
                                    <tr class="">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td width="50%" class="c-inv-sub-padding">
                                                            <input type="number" min="0" name="discount_value" {{in_array('customer', user_roles()) ? 'readonly' : ''}}
                                                        ...
                                                        <td width="50%" align="left" class="c-inv-sub-padding">
                                                            @if (in_array('customer', user_roles()))
                                                                ...
                                                                @endif
                                                            @endif
                                                            <div class="select-others select-tax height-35 rounded border-0 {{in_array('customer', user_roles()) ? 'd-none' : ''}}">
