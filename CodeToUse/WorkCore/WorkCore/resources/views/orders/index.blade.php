    ...
    <div class="content-wrapper">
        ...
        <div class="d-flex">
            <div id="table-actions" class="flex-grow-1 align-items-center">
                @if (in_array('customer', user_roles()) && in_array('orders', $user->modules) && ($addOrderPermission == 'all' ))
                    <x-forms.link-primary :link="route('services / extras.index')" class="mr-3 float-left"
                        icon="plus">
                        @lang('app.addNewOrder')
                    </x-forms.link-primary>
                @endif

                @if (!in_array('customer', user_roles()) && in_array('customers', user_modules()) && ($addOrderPermission == 'all' || $addOrderPermission == 'added'))
