                ...
                <td colspan="2">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                                ...
                                <td class="f-14 text-black">
                                    <p class="line-height mb-0">
                                        <span class="text-grey ">
                                            @lang('modules.invoices.site')</span><br>
                                        @if ($order->site)
                        ...
                        <tr>
                            ...
                            <td class="f-14 text-black">
                                @if ($order->show_shipping_address == 'yes' && $customer->clientDetails->shipping_address && $invoiceSetting->show_client_company_address == 'yes')
