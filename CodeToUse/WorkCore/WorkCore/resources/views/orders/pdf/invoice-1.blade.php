                    ...
                    <div>
                        @if($order->customer && $order->clientDetails)
                            ...
                            && ($invoiceSetting->show_client_name == 'yes' || $invoiceSetting->show_client_email == 'yes' || $invoiceSetting->show_client_phone == 'yes' || $invoiceSetting->show_client_company_name == 'yes' || $invoiceSetting->show_client_company_address == 'yes'))
                                @if ($order->site)
                                <small>@lang('modules.invoices.site'):</small>
                                <div>
                                ...
                                @if ($order->customer->name && $invoiceSetting->show_client_name == 'yes')
                                    <div>{{ $order->customer->name_salutation }}</div>
                                @endif
                                ...
                                @if ($order->customer->mobile && $invoiceSetting->show_client_phone == 'yes')
                                    <div>{{ $order->customer->mobile_with_phonecode }}</div>
                                @endif
        ...
        <table cellspacing="0" cellpadding="0" id="invoice-table">
            <thead>
                <tr>
                    ...
                    <th class="qty"> </th>
                    @endif
                    {{-- <th class="qty">{{ $order->unit->unit_type ?? $service / extra->unit->unit_type }}</th> --}}
