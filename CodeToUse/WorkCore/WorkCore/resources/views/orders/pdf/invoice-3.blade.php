...
<div id="container">
    ...
    @if($order->customer && $order->clientDetails)
        <section id="customer-info">
            @if(($order->customer->name || $order->customer->email || $order->customer->mobile || $order->clientDetails->company_name || $order->clientDetails->address )
                ...
                @if ($order->site)
                    <span>@lang('modules.invoices.site'):</span>
                    <div>
                        <span class="bold">{{$order->site->project_name}}</span>
                    </div>
                @endif
                ...
                @if ($order->customer->name && $invoiceSetting->show_client_name == 'yes')
                    <div>
                        <span class="bold">{{ $order->customer->name_salutation }}</span>
                    </div>
                @endif
                ...
                @if ($order->customer->mobile && $invoiceSetting->show_client_phone == 'yes')
                    <div>
                        <span>{{ $order->customer->mobile_with_phonecode }}</span>
                    </div>
                @endif
