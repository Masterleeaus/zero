            ...
            <div class="row">
                ...
                <div class="col-sm-12">
                    <x-forms.text :fieldLabel="__('app.name')"
                                  ...
                                  fieldRequired="true"
                                  :fieldValue="$projectStatusSetting->status_name == 'finished' ? $projectStatusSetting->alias : $projectStatusSetting->status_name"/>
                </div>

                <div class="col-sm-6">
                    <div id="colorpickeredit" class="input-group">
                        <div class="form-group my-3 text-left">
                            <x-forms.label fieldId="statusColorSelector" :fieldLabel="__('modules.service jobs.labelColor')"
                                           fieldRequired="true">
                            </x-forms.label>
                            <x-forms.input-group>
...
<script>
    ...
    $('#edit-status-setting').click(function () {
        $.easyAjax({
            ...
            url: "{{ route('site-settings.statusUpdate', $projectStatusSetting->id) }}",
