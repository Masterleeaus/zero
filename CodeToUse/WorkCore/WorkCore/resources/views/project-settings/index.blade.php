                    ...
                    <nav class="tabs px-4 border-bottom-grey">
                        <div class="nav" id="nav-tab" role="tablist">
                            <a class="nav-item nav-link f-15 active sendReminder"
                               href="{{ route('site-settings.index') }}" role="tab"
                               aria-controls="nav-sendReminder" aria-selected="true">@lang($pageTitle)
                            </a>

                            <a class="nav-item nav-link f-15 status"
                               href="{{ route('site-settings.index') }}?tab=status" role="tab"
                               aria-controls="nav-status"
                               aria-selected="true">@lang('modules.sites.projectStatusSettings')
                            </a>

                            <a class="nav-item nav-link f-15 category"
                               href="{{ route('site-settings.index') }}?tab=category" role="tab"
                               aria-controls="nav-category"
                               aria-selected="true">@lang('modules.sites.projectCategory')
                            </a>
