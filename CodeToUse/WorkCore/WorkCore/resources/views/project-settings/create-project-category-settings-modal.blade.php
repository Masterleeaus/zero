...
<x-form id="createProjectCategory" method="POST" class="ajax-form">
    ...
    <div class="modal-footer">
        ...
        <x-forms.button-primary id="save-site-category" icon="check">@lang('app.save')</x-forms.button-primary>
    </div>
</x-form>
...
<script>
    ...
    $('#save-site-category').click(function () {
        $.easyAjax({
            container: '#createProjectCategory',
            type: "POST",
            disableButton: true,
            blockUI: true,
            buttonSelector: "#save-site-category",
            url: "{{ route('site-settings.saveProjectCategory') }}",
