                ...
                <tr id="category-{{ $category->id }}">
                    ...
                    <td class="text-right">
                        ...
                        <div class="task_view mt-1 mt-lg-0 mt-md-0 ml-1">
                            <a href="javascript:;" data-category-id="{{ $category->id }}"
                               class="delete-site-category task_view_more d-flex align-items-center justify-content-center">
...
<script>
    ...
    $('#addProjectCategory').click(function () {
        var url = "{{ route('site-settings.createCategory') }}";
        console.log(url);
    ...
    $('body').on('click', '.delete-site-category', function () {
