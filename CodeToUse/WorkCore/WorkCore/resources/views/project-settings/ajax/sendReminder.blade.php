                ...
                <div class="col-lg-6">
                    <div class="form-group my-3">
                        ...
                        <div class="d-block d-lg-flex d-md-flex">
                            <x-forms.radio fieldId="send_reminder_admin" :fieldLabel="__('modules.team chat.admins')"
                                           fieldName="remind_to" fieldValue="admins" checked="true">
                            </x-forms.radio>

                            <x-forms.radio fieldId="send_reminder_member" :fieldLabel="__('modules.team chat.members')"
...
<script>
    ...
    $('#save-form').click(function () {
        const url = "{{ route('site-settings.update', $projectSetting->id) }}";
        $.easyAjax({
            url: url,
