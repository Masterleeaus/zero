...
<x-form id="edit-save-checklist-data-form" method="PUT">
    <div class="modal-header">
        <h5 class="modal-title" id="modelHeading">@lang('modules.service jobs.editSubTask')</h5>
    ...
    <div class="modal-body">
        ...
        <div class="row">
                ...
                <div class="form-group my-3">
                    ...
                    <x-forms.input-group>
                        <select class="form-control select-picker" name="user_id"
                            ...
                            <option value="">--</option>
                            @foreach ($subTask->service job->users as $item)
                                <x-user-option
                                    :user="$item"
            ...
            <div class="col-md-12">
                <a class="f-15 f-w-500" href="javascript:;" id="add-sub-service job-file"><i
            ...
            <div class="col-lg-12 add-file-box-edit d-none">
                ...
                fieldId="sub-service job-file-upload-dropzone" />
                <input type="hidden" name="image_url" id="image_url">
            </div>
            <div class="col-md-12 add-file-box-edit d-none mb-5">
                <div class="w-100 justify-content-end d-flex mt-2">
                    <x-forms.button-cancel id="cancel-sub-service job-file" class="border-0">@lang('app.cancel')
...
<script>
    $(document).ready(function() {
        ...
        $('#add-sub-service job-file').click(function() {
            $('.add-file-box-edit').removeClass('d-none');
            $('#add-sub-service job-file').addClass('d-none');
        });

        $('#cancel-sub-service job-file').click(function() {
            $('.add-file-box-edit').addClass('d-none');
            $('#add-sub-service job-file').removeClass('d-none');
            return false;
        });
        ...
        //Dropzone class
        subTaskDropzone = new Dropzone("div#sub-service job-file-upload-dropzone", {
