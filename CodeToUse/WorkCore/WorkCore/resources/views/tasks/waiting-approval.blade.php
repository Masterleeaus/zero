    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group">
                <a href="{{ route('service jobs.index') }}" class="btn btn-secondary f-14 service job" data-toggle="tooltip"
                ...
                @if(in_array('admin', user_roles()) || in_array('cleaner', user_roles()))
                    <a href="{{ route('service jobs.waiting-approval') }}" class="btn btn-secondary btn-active f-14 show-waiting-approval-service job" data-toggle="tooltip"
        ...
        $('#allTasks-table').on('change', '.change-status', function() {
            ...
            if (id != "" && status != "") {
                if (status !== 'completed') {
                    ...
                    let url = "{{ route('service jobs.show_status_reason_modal') }}" + searchQuery;
