                    ...
                    <div class="col-md-6 col-lg-3 d-none" id="set-time-quote-fields">
                        <div class="form-group mt-5">
                            ...
                            <input type="number" min="0" name="estimate_minutes"
                                   ...
                                   class="form-control d-inline-block w-25 height-35 f-14 border rounded p-2">
                            @lang('app.mins')
                        </div>
                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#save-more-service job-form').click(function () {
            ...
            const url = "{{ route('service jobs.store') }}?taskId={{$service job ? $service job->id : ''}}&add_more=true";
        ...
        $('#save-service job-form').click(function () {
            ...
            const url = "{{ route('service jobs.store') }}?taskId={{$service job ? $service job->id : ''}}";
