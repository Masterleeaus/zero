    ...
    <div class="content-wrapper">
        ...
        <div class="d-grid d-lg-flex d-md-flex action-bar my-3">
            ...
            <div class="btn-group mt-2 mt-lg-0 mt-md-0 ml-0 ml-lg-3 ml-md-3" role="group" >
                ...
                <a href="{{ route('service job-calendar.index') }}" class="btn btn-secondary f-14 btn-active" data-toggle="tooltip"
...
@push('scripts')
    ...
    <script>
        ...
        var calendar = new FullCalendar.Calendar(calendarEl, {
            ...
            // events: "{{ route('service job-calendar.index') }}"
            events: {
                url: "{{ route('service job-calendar.index') }}",
