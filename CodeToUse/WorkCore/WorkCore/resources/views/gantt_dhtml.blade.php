...
@push('styles')
    ...
    <link rel="stylesheet" href="https://workcore-test.test/vendor/css/daterangepicker.css">
        <style>
...
<script>
    ...
    gantt.attachEvent("onTaskDblClick", function(id, e){
        ...
        url = url.replace(':id', service job.hash);
    ...
    {{-- $('#hide_completed_tasks').change(function () {
        if($(this).is(':checked')){
            window.location.href = "{{ url()->temporarySignedRoute('front.gantt', now()->addDays(\App\Models\GlobalSetting::SIGNED_ROUTE_EXPIRY), $site->hash) }}" + '&hide_completed=1';
        } else {
            window.location.href = "{{ url()->temporarySignedRoute('front.gantt', now()->addDays(\App\Models\GlobalSetting::SIGNED_ROUTE_EXPIRY), $site->hash) }}";
        }
    }); --}}
</script>
@endsection