<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.issues / support.manageGroups')</h5>
    ...
    <div class="portlet-body">
        <div class="table-responsive">
            <x-table class="table-bordered">
                <x-slot name="thead">
                    <th>#</th>
                    <th>@lang('modules.issues / support.group')</th>
                ...
                @empty
                    <tr>
                        <td colspan="3">@lang('team chat.noGroupAdded')</td>
                    </tr>
                @endforelse
            </x-table>
        ...
        <x-form id="createTicketGroup" method="POST" class="ajax-form">
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.issues / support.groupName')"
                            :fieldPlaceholder="__('placeholders.issues / support.ticketGroup')" fieldRequired="true" fieldName="group_name"
                            fieldId="group_name"/>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $('#save-group').click(function () {
        $.easyAjax({
            url: "{{route('issue / support-groups.store')}}",
