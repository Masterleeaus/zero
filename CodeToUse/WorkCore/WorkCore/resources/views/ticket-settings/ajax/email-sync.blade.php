            ...
            <div class="row mt-3">
                <div class="col-md-12">
                    <h4 class="f-16 font-weight-500 ">
                        @lang('modules.issues / support.imapSettings')</h4>
                </div>
                ...
                <div class="col-md-4">
                    <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.issues / support.imapHost')"
                        :fieldPlaceholder="__('modules.issues / support.imapHost')" fieldName="imap_host" fieldId="imap_host"
                        :fieldValue="$ticketEmailSetting->imap_host" :fieldRequired="true" />
                </div>

                <div class="col-md-4">
                    <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.issues / support.imapPort')"
                        :fieldPlaceholder="__('modules.issues / support.imapPort')" fieldName="imap_port" fieldId="imap_port"
                        :fieldValue="$ticketEmailSetting->imap_port" :fieldRequired="true" />
                </div>

                <div class="col-md-4">
                    <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.issues / support.imapEncryption')"
                        :fieldPlaceholder="__('modules.issues / support.imapEncryption')" fieldName="imap_encryption"
                ...
                <div class="col-md-4">
                    <x-forms.label class="my-3" fieldId="sync_interval"
                        :fieldLabel="__('modules.issues / support.syncIntervals')">
                    </x-forms.label>
                    <x-forms.input-group>
...
<script>
    ...
    $('body').on('click', '#save-email-form', function() {
        var url = "{{ route('issue / support-email-settings.update', $ticketEmailSetting) }}";
