    ...
    <div class="portlet-body">
        <x-form id="createTicket" method="POST" class="ajax-form">
            <div class="form-group">
                <div class="row">
                    <div class="col-lg-12 ">
                        <x-forms.text fieldId="type" :fieldLabel="__('modules.issues / support.ticketType')" fieldName="type"
...
<div class="modal-footer">
    ...
    <x-forms.button-primary id="save-issue / support-type" icon="check">@lang('app.save')</x-forms.button-primary>
</div>

<script>
    // save type
    $('#save-issue / support-type').click(function() {
        $.easyAjax({
