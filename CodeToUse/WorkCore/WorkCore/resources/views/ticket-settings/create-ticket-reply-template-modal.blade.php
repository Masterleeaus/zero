    ...
    <div class="portlet-body">
        <x-form id="addTicketTemplate" method="POST" class="ajax-form">
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <x-forms.text fieldId="reply_heading" :fieldLabel="__('modules.issues / support.templateHeading')"
                            fieldName="reply_heading" fieldRequired="true" :fieldPlaceholder="__('placeholders.issue / support.replyTicket')">
                        </x-forms.text>
                    </div>

                    <div class="col-md-12">
                        <div class="form-group my-3">
                            <x-forms.label fieldId="description" fieldRequired="true" :fieldLabel="__('modules.issues / support.templateText')">
                            </x-forms.label>
