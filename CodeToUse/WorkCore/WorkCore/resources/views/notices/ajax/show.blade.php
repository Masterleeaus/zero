            ...
            <div class="card bg-white border-0 b-shadow-4">
                ...
                <div class="card-body">
                    ...
                    <div class="col-12 px-0 pb-2 d-lg-flex d-md-flex d-block">
                        ...
                        {{$notice->to == 'cleaner' ? __('app.cleaner') : __('app.customer')}}</p>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">@lang('modules.service jobs.assignTo') - {{ $notice->heading }}</h5>
            ...
            <div class="modal-body">
                <div class="row">
                    @if ($notice->to == 'cleaner' && count($noticeEmployees) > 0)
                        ...
                        @endforeach
                    @elseif($notice->to == 'customer' && count($noticeClients) > 0)
