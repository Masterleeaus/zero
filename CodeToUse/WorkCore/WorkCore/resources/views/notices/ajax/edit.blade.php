                ...
                <div class="row p-20">
                    <div class="col-lg-12">
                        <div class="row">
                                ...
                                <div class="form-group my-3">
                                    ...
                                    <div class="d-flex">
                                        <x-forms.radio fieldId="toEmployee"
                                            ...
                                            fieldValue="cleaner" :checked="$notice->to == 'cleaner'">
                                        </x-forms.radio>
                                        @if (in_array('customers', user_modules()) || $notice->to == 'customer')
                                            <x-forms.radio fieldId="toClient" :fieldLabel="__('modules.notices.toClients')"
                                                fieldValue="customer" fieldName="to" :checked="$notice->to == 'customer'">
                                            </x-forms.radio>
                                        @endif
                                    </div>
                                </div>
                            ...
                            <div class="col-lg-4 col-md-6 zone @if ($notice->to == 'customer' || !in_array('customers', user_modules())) d-none @endif">
                                <x-forms.select fieldId="team_id" :fieldLabel="__('app.zone')" fieldName="team_id"
                                    search="true">
                            ...
                            <div class="col-lg-6 col-md-6  @if($notice->to == 'customer') d-none @endif" id="employeesDiv">
                                <x-forms.label class="my-3" fieldId="selectEmployee"
                                    :fieldLabel="__('app.select') . ' ' . __('app.cleaner')" fieldRequired="true">
                                </x-forms.label>
                                <x-forms.input-group>
                                    <select class="form-control multiple-users select-picker" multiple name="cleaners[]"
                            ...
                            <div class="col-lg-6 col-md-6 @if($notice->to == 'cleaner') d-none @endif" id="clientsDiv">
                                <x-forms.label class="my-3" fieldId="selectClient"
                                    :fieldLabel="__('app.select') . ' ' . __('app.customer')" fieldRequired="true">
                                </x-forms.label>
                                <x-forms.input-group>
                                    <select class="form-control multiple-users select-picker" multiple name="customers[]"
