                    ...
                    <div  class="description">
                        ...
                        @elseif($invoice->customer && $invoice->clientDetails && ($invoice->customer->name || $invoice->customer->email || $invoice->customer->mobile || $invoice->clientDetails->company_name || $invoice->clientDetails->address) && ($invoiceSetting->show_client_name == 'yes' || $invoiceSetting->show_client_email == 'yes' || $invoiceSetting->show_client_phone == 'yes' || $invoiceSetting->show_client_company_name == 'yes' || $invoiceSetting->show_client_company_address == 'yes'))
                            ...
                            @if ($invoice->customer->name && $invoiceSetting->show_client_name == 'yes')
                                {{ $invoice->customer->name_salutation }}<br>
                            @endif
                            ...
                            @if ($invoice->customer->mobile && $invoiceSetting->show_client_phone == 'yes')
                                {{ $invoice->customer->mobile_with_phonecode }}<br>
                            @endif
            ...
            <tbody>
                ...
                @if ($hasDeducted)
                    ...
                    <tr style="page-break-inside: avoid;" class="tax">
                        ...
                        @endif
                        <td class="qty">&nbsp;</td>
                        <td class="desc">@lang('modules.invoices.totalPayment')</td>
                        <td class="unit border-left-0 border-right-0" style="border-bottom: 1px solid #e7e9eb;">{{ currency_format($totalPaymentAmount, $invoice->currency_id, false) }}</td>
                    </tr>
                    @foreach ($taxesDeducted as $key => $tax)
                        <tr style="page-break-inside: avoid;" class="tax">
                            ...
                            @endif
                            <td class="qty">&nbsp;</td>
                            <td class="desc">{{ $key }} (Deducted)</td>
                            <td class="unit border-left-0 border-right-0" style="border-bottom: 1px solid #e7e9eb;">-{{ currency_format(abs($tax), $invoice->currency_id, false) }}</td>
                        </tr>
                    @endforeach
                    <tr style="page-break-inside: avoid;" class="tax">
                        <td class="no">&nbsp;</td>
                        ...
                        @endif
                        <td class="qty">&nbsp;</td>
                        <td class="desc">@lang('modules.invoices.netPayable')</td>
                        <td class="unit border-left-0 border-right-0" style="border-bottom: 1px solid #e7e9eb;">{{ currency_format($netPayableBeforeAdjustment, $invoice->currency_id, false) }}</td>
                    </tr>
                @else
