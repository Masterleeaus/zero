    ...
    <div id="container">
        <div class="right-invoice">
            <section id="memo" class="description">
                ...
                <div class="logo" id="customer-info" >
                        ...
                        <section class="description">
                            ...
                            @if ($invoice->site->customer->name && $invoiceSetting->show_client_name == 'yes')
                                <div class="customer-name">
                                    <strong>{{ $invoice->site->customer->name_salutation }}</strong>
                                </div>
                            @endif
                            ...
                            @if ($invoice->site->customer->clientDetails->address && $invoiceSetting->show_client_company_address == 'yes')
                                <div class="mb-3">
                                    <span>{!! nl2br($invoice->site->clientDetails->address) !!}</span>
                                </div>
                            @endif
                            ...
                            @if ($invoice->show_shipping_address === 'yes')
                                <div>
                                    <span>
                                        ...
                                        {!! nl2br($invoice->site->customer->clientDetails->shipping_address) !!}
                                    </span>
                                </div>
                            @endif

                            <div>
                                <span>{{ $invoice->site->customer->email }}</span>
                            </div>
                    ...
                    @elseif(!is_null($invoice->client_id))
                        <section id="customer-info" class="description">
                            ...
                            <div class="customer-name">
                                {{ $invoice->customer->name_salutation }}
                            </div>
                    ...
                    @if (is_null($invoice->site) && !is_null($invoice->quote) && !is_null($invoice->quote->customer))
                        <section id="customer-info">
                            <span>@lang('modules.invoices.billedTo'):</span>
                            <div class="customer-name">
                                <strong>{{ $invoice->quote->customer->name_salutation }}</strong>
                            </div>

                            <div>
                                <span>{{ $invoice->quote->customer->clientDetails->company_name }}</span>
                            </div>
                            <div class="mb-3">
                                <span>
                            ...
                            @if ($invoice->show_shipping_address === 'yes')
                                <div>
                                    <span>
                                        <b>@lang('app.shippingAddress') :</b><br>
                                        {!! nl2br($invoice->quote->customer->clientDetails->shipping_address) !!}
                                    </span>
                                </div>
                            @endif
                            <div>
                                <span>{{ $invoice->quote->customer->email }}</span>
                            </div>
