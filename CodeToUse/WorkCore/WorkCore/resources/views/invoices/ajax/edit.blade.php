            ...
            <div class="col-md-4">
                @if(isset($isClient) && $isClient == true)
                    <div class="form-group">
                        <x-forms.label fieldId="client_id" :fieldLabel="__('app.customer')">
                        </x-forms.label>
                        <div class="input-group">
                ...
                @else
                    <x-customer-selection-dropdown :customers="$customers" :selected="$invoice->client_id" />
                @endif
            </div>
            <!-- CLIENT END -->
            <!-- PROJECT START -->
        ...
        <div class="row px-lg-4 px-md-4 px-3 py-3">
            ...
            <div class="col-md-4">
                <div class="form-group c-inv-select mb-0">
                    ...
                    <p class="f-15" id="client_billing_address">{!! nl2br($invoice->customer?->clientDetails?->address) !!}</p>
            ...
            <div class="col-md-4">
                <div class="form-group c-inv-select mb-lg-0 mb-md-0 mb-4">
                    ...
                    <p class="f-15" id="client_shipping_address">
                        @if ($invoice->customer?->clientDetails?->shipping_address)
                ...
                <div class="form-group c-inv-select mb-4">
                    <x-forms.input-group>
                        <select class="form-control select-picker" name="category_id"
                            ...
                            <option value="null">{{ __('app.select') . ' ' . __('app.service / extra') . ' ' . __('app.category')  }}</option>
