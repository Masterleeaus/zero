                   ...
                   @forelse ($payments as $payment)
                       <tr id="row{{$payment->id}}">
                           ...
                           <td class="text-right">
                               ...
                               @if (((is_null($payment->transaction_id) && is_null($payment->payload_id) && !$invoice->credit_note && $payment->gateway) || ($payment->gateway == 'Offline' || $payment->gateway == '')) && !in_array('customer', user_roles()))
