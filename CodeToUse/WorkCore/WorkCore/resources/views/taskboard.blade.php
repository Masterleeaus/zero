...
@section('content')
    ...
    <div class="w-service job-board-box p-4 bg-white">
...
@push('scripts')
    ...
    <script>
        function loadData() {
            ...
            var url = "{{ route('front.taskboard', $site->hash) }}";
        ...
        $('body').on('click', '.load-more-service jobs', function () {
            ...
            var url = "{{ route('front.taskboard.load_more', $site->hash) }}?columnId=" + columnId +
