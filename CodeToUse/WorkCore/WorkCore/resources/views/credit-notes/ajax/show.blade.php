...
<!-- INVOICE CARD START -->
@if (!is_null($creditNote->project_id) && isset($creditNote->site->clientDetails))
    @php
        $customer = $creditNote->site->customer;
    @endphp
    ...
    <div class="card-body">
        <div class="invoice-table-wrapper">
                                ...
                                <td class="p-0 border-right-0" align="right">
                                    <table width="100%">
                                        ...
                                        @php
                                            ...
                                            $netPayableBeforeAdjustment = $totalPaymentAmount - $deductedSum;
                                        ...
                                        @if ($hasDeducted)
                                            ...
                                            <tr class="text-dark-grey font-weight-semibold" align="right">
                                                <td class="w-50 border-top-0 border-left-0">
                                                    @lang('modules.invoices.totalPayment')</td>
                                            </tr>
                                            ...
                                            <tr class=" text-dark-grey font-weight-bold" align="right">
                                                <td class="w-50 border-top-0 border-left-0">
                                                    @lang('modules.invoices.netPayable')</td>
                                            </tr>
                                        @else
                                ...
                                <td class="p-0 border-right-0" align="right">
                                    <table width="100%">
                                        ...
                                        @if ($hasDeducted)
                                            ...
                                            <tr class="text-dark-grey font-weight-semibold" align="right">
                                                <td class="border-top-0 border-left-0">
                                                    {{ currency_format($totalPaymentAmount, $creditNote->currency_id, false) }}</td>
                                            </tr>
                                            @foreach ($taxesDeducted as $key => $tax)
                                                <tr class="text-dark-grey" align="right">
                                                    <td class="border-top-0 border-left-0">
                                                        -{{ currency_format(abs($tax), $creditNote->currency_id, false) }}</td>
                                                </tr>
                                            @endforeach
                                            <tr class=" text-dark-grey font-weight-bold" align="right">
                                                <td class="border-top-0 border-left-0">
                                                    {{ currency_format($netPayableBeforeAdjustment, $creditNote->currency_id, false) }}</td>
                                            </tr>
                                        @else
                                            @foreach ($taxes as $key => $tax)
                                                <tr class="text-dark-grey" align="right">
                                        ...
                                        <tr class=" text-dark-grey font-weight-bold" align="right">
                                            <td class="border-bottom-0 border-left-0">
                                                {{ currency_format($displayTotal, $creditNote->currency_id, false) }}</td>
                                        </tr>
                                        <tr class=" text-dark-grey " align="right">
                                            <td class="border-bottom-0 border-left-0">
            ...
            <table width="100%" class="inv-desc-mob d-block d-lg-none d-md-none">
                ...
                @endif
                <tr>
                    <th width="50%" class="text-dark-grey font-weight-normal">@lang('app.adjustmentAmount')</th>
                    <td width="50%" class="text-dark-grey font-weight-normal">
        ...
        <div class="d-flex mb-4">
            <div class="inv-action mr-3 mr-lg-3 mr-md-3 dropup">
                ...
                <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton" tabindex="0">
                    ...
                    @if ($creditNote->status == 'open' && !in_array('customer', user_roles()))
                        <li>
