    ...
    <header class="clearfix">
        ...
        <table cellpadding="0" cellspacing="0" class="billing">
            ...
            <tr>
                <td id="invoiced_to">
                    <div>
                        @if (!is_null($creditNote->site) && !is_null($creditNote->site->customer) && !is_null($creditNote->site->customer->clientDetails))
                            ...
                            <h3 class="name">
                                {{ $creditNote->site->customer->clientDetails->company_name }}
                            </h3>
                            <div class="mb-3">
                                <b>@lang('app.address') :</b>
                                <div>{!! nl2br($creditNote->site->clientDetails->address) !!}</div>
                            </div>
                            @if ($creditNote->show_shipping_address === 'yes')
                                <div>
                                    <b>@lang('app.shippingAddress') :</b>
                                    <div>{!! nl2br($creditNote->site->clientDetails->shipping_address) !!}</div>
                                </div>
                            @endif
                            ...
                            @if ($creditNoteSetting->show_gst == 'yes' && !is_null($creditNote->site->customer->clientDetails->gst_number))
                                <div> @lang('app.gstIn'):
                                    {{ $creditNote->site->customer->clientDetails->gst_number }} </div>
                            @endif
                        @elseif(!is_null($creditNote->client_id) && !is_null($creditNote->customer) && !is_null($creditNote->customer->clientDetails))
                        ...
                        @if (is_null($creditNote->site) && !is_null($creditNote->quote) && !is_null($creditNote->quote->customer->clientDetails))
                            <small>@lang('modules.invoices.billedTo'):</small>
                            <h3 class="name">
                                {{ $creditNote->quote->customer->clientDetails->company_name }}</h3>
                            <div class="mb-3">
                                <b>@lang('app.address') :</b>
                                <div>{!! nl2br($creditNote->quote->customer->clientDetails->address) !!}</div>
                            </div>
                            @if ($creditNote->show_shipping_address === 'yes')
                                <div>
                                    <b>@lang('app.shippingAddress') :</b>
                                    <div>{!! nl2br($creditNote->quote->customer->clientDetails->shipping_address) !!}</div>
                                </div>
                            @endif
                            @if ($creditNoteSetting->show_gst == 'yes' && !is_null($creditNote->quote->customer->clientDetails->gst_number))
                                <div> @lang('app.gstIn'):
                                    {{ $creditNote->quote->customer->clientDetails->gst_number }} </div>
                            @endif
                        @endif
                    </div>
                </td>
        ...
        <table cellspacing="0" cellpadding="0" id="invoice-table">
            ...
            <tbody>
                ...
                @if ($hasDeducted)
                    ...
                    <tr style="page-break-inside: avoid;" class="tax">
                        ...
                        <td class="unit">{{ currency_format($totalPaymentAmount, $creditNote->currency_id, false) }}</td>
                    </tr>
                    @foreach ($taxesDeducted as $key => $tax)
                        <tr style="page-break-inside: avoid;" class="tax">
                            ...
                            <td class="unit">-{{ currency_format(abs($tax), $creditNote->currency_id, false) }}</td>
                        </tr>
                    @endforeach
                    <tr style="page-break-inside: avoid;" class="tax">
                        <td class="no">&nbsp;</td>
                        ...
                        <td class="unit">{{ currency_format($netPayableBeforeAdjustment, $creditNote->currency_id, false) }}</td>
                    </tr>
                @else
            ...
            <tfoot>
                <tr dontbreak="true">
                    ...
                    <td style="text-align: center">{{ currency_format($displayTotal, $creditNote->currency_id, false) }}</td>
                </tr>
                <tr dontbreak="true">
