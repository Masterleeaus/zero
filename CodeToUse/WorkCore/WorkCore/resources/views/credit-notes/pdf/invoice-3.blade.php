...
<body>
    <div id="container">
        ...
        @elseif (is_null($creditNote->site) && !is_null($creditNote->customer) && !is_null($creditNote->customer->clientDetails))
            <section id="customer-info"  class="description">
                @if (!is_null($creditNote->customer) && !is_null($creditNote->customer->clientDetails))
                    <span class="description">@lang('modules.credit-notes.billedTo')</span>
                    <div>
        ...
        <section id="sums"  class="description">
            ...
            <table cellpadding="0" cellspacing="0">
                ...
                @if ($discount != 0 && $discount != '')
                    <tr data-iterate="tax">
                        <th>@lang('modules.credit-notes.discount'):
