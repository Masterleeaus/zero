        ...
        <div class="right-invoice">
            ...
            @if (!is_null($creditNote->site) && !is_null($creditNote->site->customer))
                <section id="customer-info">
                    ...
                    <div class="customer-name description">
                        <strong>{{ $creditNote->site->customer->name_salutation }}</strong>
                    </div>
            ...
            @elseif (is_null($creditNote->site) && !is_null($creditNote->customer) && !is_null($creditNote->customer->clientDetails))
                <section id="customer-info">
                    <span>@lang('modules.credit-notes.billedTo'):</span>
                    <div class="customer-name description">
                        <strong>{{ $creditNote->customer->name_salutation }}</strong>
                    </div>
                ...
                <table cellpadding="0" cellspacing="0">
                    ...
                    @if ($hasDeducted)
                        ...
                        <tr data-iterate="tax">
                            ...
                            <td>{{ number_format((float) $totalPaymentAmount, 2, '.', '') }}</td>
                        </tr>

                        @foreach ($taxesDeducted as $key => $tax)
                            <tr data-iterate="tax">
                                <th>{{ $key }} (Deducted):</th>
                                <td>-{{ number_format((float) abs($tax), 2, '.', '') }}</td>
                            </tr>
                        @endforeach

                        <tr data-iterate="tax">
                            <th>@lang('modules.invoices.netPayable'):</th>
                            <td>{{ number_format((float) $netPayableBeforeAdjustment, 2, '.', '') }}</td>
                        </tr>
                    @else
                    ...
                    <tr class="amount-total">
                        ...
                        <td>{{ number_format((float) $displayTotal, 2, '.', '') }}</td>
                    </tr>
                    <tr>
                        <th>
                    ...
                    <tr>
                        ...
                        <td>
                            {{ number_format((float) ($displayTotal - $creditNote->creditAmountUsed()), 2, '.', '') }}</td>
                    </tr>
                </table>
