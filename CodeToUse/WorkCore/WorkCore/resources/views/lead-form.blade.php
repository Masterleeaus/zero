                                ...
                                @elseif ($item->field_name == 'country')
                                    <div class="col-md-12">
                                        <x-forms.select fieldId="country"
                                                        :fieldLabel="__('modules.enquiries.'.$item->field_name)"
                                                        :fieldName="$item->field_name"
                                                        :fieldRequired="$item->required == 1"
                                                        search="true">
                                            <option value="">--</option>
                                ...
                                @elseif($item->field_name == 'source')
                                    <div class="col-md-12">
                                        <x-forms.select fieldId="source"
                                                        :fieldLabel="__('modules.enquiry.'.$item->field_name)"
                                                        :fieldName="$item->field_name"
                                                        :fieldRequired="$item->required == 1"
                                                        search="true">
                                            <option value="">--</option>
...
<script>
    ...
    const dropifyMessages = {
        ...
        error: "@lang('team chat.errorOccured')",
    };
