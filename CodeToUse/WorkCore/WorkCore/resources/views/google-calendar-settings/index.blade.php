    ...
    <div class="w-100 d-flex ">
        ...
        <x-setting-card method="POST">
                ...
                <div class="row google_details mt-3 @if ($companyOrGlobalSetting->google_calendar_status == 'inactive') d-none @endif">
                    ...
                    <div class="col-lg-12 mt-4">
                        <x-forms.label fieldId="" for="mail_from_name"
                                       :fieldLabel="__('team chat.googleCalendar.AuthorizedRedirectURI')"
                                       :popover="__('team chat.googleCalendar.AuthorizedRedirectURIInfoMessage')">
                        </x-forms.label>
                        ...
                        <p class="text-primary">(@lang('team chat.googleCalendar.addGoogleCalendarUrl'))</p>
                    </div>
                    @else
            ...
            <div class="col-xl-4 col-lg-12 col-md-12 ntfcn-tab-content-right border-left-grey p-4">
                <h4 class="f-16  f-w-500 text-dark-grey">@lang("team chat.googleCalendar.notificationTitle")</h4>
                <div class="mb-3 d-flex">
                    <x-forms.checkbox :checked="$module->lead_status == '1'"
                                      :fieldLabel="__('app.menu.enquiries')"
                ...
                <div class="mb-3 d-flex">
                    <x-forms.checkbox :checked="$module->contract_status == '1'"
                                      :fieldLabel="__('app.menu.service agreements')"
                ...
                <div class="mb-3 d-flex">
                    <x-forms.checkbox :checked="$module->task_status == '1'"
                                      :fieldLabel="__('app.menu.service jobs')"
    ...
    <script>
        ...
        $(document).on('click', '#disable-google-calendar', function () {
            Swal.fire({
                ...
                text: "@lang('team chat.googleCalendar.confirmRemove')",
                icon: 'warning',
                showCancelButton: true,
                focusConfirm: false,
                confirmButtonText: "@lang('team chat.googleCalendar.yesRemove')",
