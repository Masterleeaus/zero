...
@section('filter-section')
    ...
    <x-filters.filter-box>
        ...
        <div class="service job-search d-flex  py-1 px-0 align-items-center">
          ...
          <div class="d-flex justify-content-between action-bar">
            ...
            <div id="table-actions" class="d-flex align-items-center">
                @if ($manageContractTemplatePermission == 'all' || $manageContractTemplatePermission == 'added')
                    <x-forms.link-primary :link="route('service agreement-template.create')" class="mr-3 openRightModal" icon="plus">
...
@push('scripts')
    ...
    <script>
        $('#service agreement-template-table').on('preXhr.dt', function(e, settings, data) {
        ...
        const showTable = () => {
            window.LaravelDataTables["service agreement-template-table"].draw(true);
        }
        ...
        $('body').on('click', '.delete-table-row', function() {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    var url = "{{ route('service agreement-template.destroy', ':id') }}";
        ...
        const applyQuickAction = () => {
            var rowdIds = $("#service agreement-template-table input:checkbox:checked").map(function() {
                return $(this).val();
            }).get();

            var url = "{{ route('contract_template.apply_quick_action') }}?row_ids=" + rowdIds;
