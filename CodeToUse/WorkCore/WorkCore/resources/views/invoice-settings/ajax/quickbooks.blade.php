<div class="col-xl-12 col-lg-12 col-md-12 w-100 p-20">
    ...
    <div class="row @if ($quickbookSetting->status == 0) d-none @endif" id="paypal_details">
        ...
        <div
            ...
            <div  class="row">
                <div class="col-lg-6">
                    <x-forms.text class="mr-0 mr-lg-2 mr-md-2" fieldLabel="Customer ID"
                ...
                <div class="col-lg-6">
                    <x-forms.label class="mt-3" fieldId="sandbox_client_secret" fieldLabel="Customer Secret"
                        fieldRequired="true">
                    </x-forms.label>
                    <x-forms.input-group>
        ...
        <div
            ...
            <div class="row">
                ...
                <div class="col-lg-6">
                    <x-forms.label class="mt-3" fieldId="client_secret" fieldLabel="Customer Secret"
                        fieldRequired="true">
                    </x-forms.label>
                    <x-forms.input-group>
