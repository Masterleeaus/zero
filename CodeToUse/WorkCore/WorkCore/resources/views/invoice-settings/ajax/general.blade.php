    ...
    <div class="row">
        ...
        <div class="col-lg-6">
            <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2"
                            ...
                            :popover="__('team chat.invoiceLogoTooltip')"/>
        </div>
        <div class="col-lg-6">
            <x-forms.file allowedFileExtensions="png jpg jpeg svg bmp" class="mr-0 mr-lg-2 mr-md-2"
                            ...
                            :popover="__('team chat.authorisedSignatorySignatureTooltip')"/>
        </div>
        ...
        <div class="col-lg-4 mt-2">
            <x-forms.checkbox :checked="$invoiceSetting->show_status==1"
                                ...
                                fieldName="show_status" fieldId="show_status" :popover="__('team chat.invoiceStatusShowTooltip')"/>
        </div>

        <div class="col-lg-4 mt-2">
            <x-forms.checkbox :checked="$invoiceSetting->authorised_signatory==1"
                                :fieldLabel="__('app.showAuthorisedSignatory')"
                                fieldName="show_authorised_signatory" fieldId="show_authorised_signatory" :popover="__('team chat.invoiceAuthorisedSignatoryShowTooltip')"/>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 mt-2">
                    <x-forms.checkbox :checked="$invoiceSetting->show_client_company_address=='yes'"
                                        :fieldLabel="__('app.customer').' '.__('modules.customer.address')"
