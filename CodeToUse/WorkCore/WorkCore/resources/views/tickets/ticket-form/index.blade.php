            ...
            <div class="col-lg-6">
                <div class="row">
                                                ...
                                                <div class="row py-3 pt-4 border-bottom">
                                                    ...
                                                    <div class="col-md-5">
                                                        @if ($item->custom_fields_id === null)
                                                            {{ __('modules.issues / support.'.$item->field_name) }}
                                                        @else
                    ...
                    <div class="col-sm-12 mt-4">
                        <x-cards.data>
                            <p class="f-w-500">@lang('modules.enquiry.iframeSnippet')</p>
                            <code>
...
@push('scripts')
    ...
    <script>
        $(function() {
            $("#sortable").sortable({
                update: function(event, ui) {
                    ...
                    $.easyAjax({
                        url: "{{ route('issue / support-form.sort_fields') }}",
                        type: "POST",
                        blockUI: true,
                        data: {
        ...
        $('.change-setting').change(function() {
            ...
            var url = "{{ route('issue / support-form.update', ':id') }}";
