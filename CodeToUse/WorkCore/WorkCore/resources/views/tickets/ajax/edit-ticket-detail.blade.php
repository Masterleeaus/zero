<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.issues / support.ticketDetail')</h5>
    ...
    <div class="portlet-body">
        <x-form id="editTicketDetail" method="PUT" class="ajax-form">
            <div class="form-body">
                <div class="row">
                    <div class="col-lg-12">
                        <input type="hidden" id="ticket_id" name="ticket_id" value="{{ $issue / support->id }}">
                        <x-forms.text class="mr-0 mr-lg-2 mr-md-2" :fieldLabel="__('modules.issues / support.ticketSubject')"
                            fieldRequired="true" fieldName="subject"
                            :fieldValue="$issue / support->subject" fieldId="subject"/>
...
<div class="modal-footer">
    ...
    <x-forms.button-primary id="save-issue / support" icon="check">@lang('app.save')</x-forms.button-primary>
</div>
...
<script>
    ...
    $('#save-issue / support').click(function () {
        ...
        $.easyAjax({
            url: "{{route('issues / support.update_detail', $issue / support->id)}}",
