            ...
            <x-form class="c-inv-form" id="saveInvoiceForm">
                    ...
                    <div class="col-md-6 col-lg-4">
                        <div class="form-group mb-lg-0 mb-md-0 mb-4">
                            ...
                            <div class="input-group">
                                <input type="text" name="estimate_number" id="estimate_number" class="form-control height-35 f-15 readonly-background" readonly value="{{ $quote->estimate_number }}" >
                            </div>
                        </div>
                    </div>
                    <!-- INVOICE NUMBER END -->
                            ...
                            <div class="select-others height-35 rounded">
                                <select class="form-control select-picker" name="currency_id" id="currency_id">
                                    @foreach ($currencies as $currency)
                                        <option @if($quote->currency_id == $currency->id) selected @endif
                                            value="{{ $currency->id }}">
                     ...
                     <div class="col-md-6">
                        <div class="form-group c-inv-select mb-4">
                            ...
                            <select class="form-control select-picker" name="status" id="status">
                                    <option
                                            @if($quote->status == 'accepted') selected @endif
                                    value="accepted">@lang('modules.quotes.accepted')
                                    </option>
                                    <option
                                            @if($quote->status == 'waiting') selected @endif
                                    value="waiting">@lang('modules.quotes.waiting')
                                    </option>
                                    <option
                                            @if($quote->status == 'declined') selected @endif
                                    value="declined">@lang('modules.quotes.declined')
                                    </option>
                                    @if($quote->status == 'draft')
                                    <option
                                            @if($quote->status == 'draft') selected @endif
                ...
                <div class="d-flex px-4 py-3">
                    <div class="form-group">
                        <select class="form-control select-picker" data-live-search="true" data-size="8" id="add-services / extras">
                                <option value="">{{__('app.select') . ' ' . __('app.service / extra') }}</option>
                                    ...
                                    <table width="100%">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td width="30%" class="border-top-0 sub-total">{{ number_format((float)$quote->sub_total, 2, '.', '') }}</td>
                                                <input type="hidden" class="sub-total-field" name="sub_total" value="{{ $quote->sub_total }}">
                                            </tr>
                                            <tr>
                                                                ...
                                                                <td width="50%" align="left" class="c-inv-sub-padding">
                                                                    <div
                                                                        ...
                                                                        <select class="form-control select-picker"
                                                                            ...
                                                                            <option @if($quote->discount_type == 'percent') selected @endif value="percent">%</option>
                                                ...
                                                <td><span id="discount_amount">{{ number_format((float)$quote->discount, 2, '.', '') }}</span></td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr class="bg-amt-grey f-16 f-w-500">
                                                ...
                                                <td><span class="total">{{ number_format((float)$quote->total, 2, '.', '') }}</span></td>
                                                <input type="hidden" class="total-field" name="total" value="{{ round($quote->total, 2) }}">
                                            </tr>
                                        </tbody>
                                    </table>
                                </td>
