<x-filters.filter-box>
    ...
    <div class="select-box d-flex py-2 px-lg-2 px-md-2 px-0 border-right-grey border-right-grey-sm-0">
        ...
        <div class="select-status">
            <select class="form-control select-picker" name="type" id="type">
                ...
                <option {{ request('type') == 'enquiry' ? 'selected' : '' }} value="enquiry">@lang('modules.enquiry.enquiry')
                </option>
                <option {{ request('type') == 'customer' ? 'selected' : '' }} value="customer">
                    @lang('modules.enquiry.customer')</option>
            </select>
        </div>
    </div>
    <!-- CLIENT END -->
    ...
    <x-filters.more-filter-box>
        ...
        <div class="more-filter-items">
            <label class="f-14 text-dark-grey mb-12 " for="usr">@lang('modules.enquiry.leadSource')</label>
            <div class="select-filter mb-4">
        ...
        <div class="more-filter-items">
            <label class="f-14 text-dark-grey mb-12 " for="usr">@lang('modules.enquiry.leadOwner')</label>
            <div class="select-filter mb-4">
                <div class="select-others">
