        ...
        <x-form id="save-enquiry-data-form" method="PUT">
            <div class="add-customer bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <x-forms.email fieldId="client_email" :fieldLabel="__('app.email')"
                            ...
                            :fieldValue="$leadContact->client_email" :fieldHelp="__('modules.enquiry.leadEmailInfo')">
                        </x-forms.email>
                    </div>
                                ...
                                @if ($addLeadSourcesPermission == 'all' || $addLeadSourcesPermission == 'added')
                                    <x-slot name="append">
                                        <button type="button"
                                            ...
                                            data-toggle="tooltip" data-original-title="{{ __('app.add').' '.__('modules.enquiry.leadSource') }}">@lang('app.add')</button>
                                    </x-slot>
                                @endif
                            </x-forms.input-group>
                        </div>
                ...
                <h4 class="mb-0 p-20 f-21 font-weight-normal  border-top-grey">
                    @lang('modules.enquiry.companyDetails')</h4>
...
<script>
    $(document).ready(function() {
        ...
        $('#save-enquiry-form').click(function() {
            const url = "{{ route('enquiry-contact.update', [$leadContact->id]) }}";
            $.easyAjax({
                url: url,
                ...
                blockUI: true,
                file: true,
                buttonSelector: "#save-enquiry-form",
                data: $('#save-enquiry-data-form').serialize(),
        ...
        $('body').on('click', '.add-enquiry-source', function() {
            const url = '{{ route('enquiry-source-settings.create') }}';
