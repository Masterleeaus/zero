            ...
            <div class="add-customer bg-white rounded">
                ...
                <div class="row p-20">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <x-forms.select fieldId="salutation" :fieldLabel="__('modules.customer.salutation')"
                    ...
                    <div class="col-lg-4 col-md-6">
                        ...
                        <x-forms.email fieldId="client_email" :fieldLabel="__('app.email')"
                            fieldName="client_email" :fieldPlaceholder="__('placeholders.email')" :fieldHelp="__('modules.enquiry.leadEmailInfo')">
                        </x-forms.email>
                    </div>

                    @if ($viewLeadSourcesPermission != 'none')
                        <div class="col-lg-4 col-md-6">
                            <x-forms.label class="my-3" fieldId="source_id" :fieldLabel="__('modules.enquiry.leadSource')">
                            </x-forms.label>
                            <x-forms.input-group>
                                ...
                                @if ($addLeadSourcesPermission == 'all' || $addLeadSourcesPermission == 'added')
                                    <x-slot name="append">
                                        <button type="button"
                                            class="btn btn-outline-secondary border-grey add-enquiry-source"
                                            data-toggle="tooltip" data-original-title="{{ __('app.add').' '.__('modules.enquiry.leadSource') }}">
                                            @lang('app.add')</button>
                                    </x-slot>
                                @endif
                            </x-forms.input-group>
                ...
                <h4 class="mb-0 p-20 f-21 font-weight-normal  border-top-grey">
                    <a href="javascript:;" class="text-dark toggle-other-details"><i class="fa fa-chevron-down"></i>
                        @lang('modules.customer.companyDetails')</a>
                </h4>
                ...
                <div class="row p-20 d-none" id="other-details">
                    ...
                    <div class="col-lg-3 col-md-6">
                        <x-forms.text :fieldLabel="__('modules.enquiry.companyName')" fieldName="company_name"
                            fieldId="company_name" :fieldPlaceholder="__('placeholders.company')" />
                    </div>

                    <div class="col-lg-3 col-md-6">
                        <x-forms.text :fieldLabel="__('modules.enquiry.website')" fieldName="website" fieldId="website"
                            :fieldPlaceholder="__('placeholders.website')" />
                    </div>

                    <div class="col-lg-3 col-md-6">
                        <x-forms.tel fieldId="mobile" :fieldLabel="__('modules.enquiry.mobile')" fieldName="mobile"
                           :fieldPlaceholder="__('placeholders.mobile')"></x-forms.tel>
                    </div>

                    <div class="col-lg-3 col-md-6">
                        <x-forms.text :fieldLabel="__('modules.customer.officePhoneNumber')" fieldName="office"
                ...
                <x-form-actions>
                    ...
                    <x-forms.button-secondary class="mr-3" id="save-more-enquiry-form" icon="check-double">@lang('app.saveAddMore')
...
<script>
    ...
    $(document).ready(function() {
        ...
        $('#save-more-enquiry-form').click(function () {
            ...
            const url = "{{ route('enquiry-contact.store') }}?add_more=true";
        ...
        $('#save-enquiry-form').click(function() {
            const url = "{{ route('enquiry-contact.store') }}";
...
<script>
    //Create deal on enquiry creation script
    $(document).ready(function () {
