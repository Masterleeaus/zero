<x-form id="add-enquiry-category" method="PUT" class="ajax-form">
    <div class="modal-header">
        <h5 class="modal-title" id="modelHeading">@lang('modules.enquiry.editDealCategory')</h5>
...
<script>
    ...
    $('#save-category').click(function() {
        $.easyAjax({
            ...
            container: '#add-enquiry-category',
            type: "POST",
            blockUI: true,
            disableButton: true,
            buttonSelector: "#save-category",
            data: $('#add-enquiry-category').serialize(),
