<x-form id="editLeadSource" method="PUT" class="ajax-form">
    <div class="modal-header">
        <h5 class="modal-title" id="modelHeading">@lang('modules.enquiry.editLeadSource')</h5>
    ...
    <div class="modal-body">
        <div class="portlet-body">
                <div class="form-body">
                    <div class="row">
                        <div class="col-lg-12">
                            <x-forms.text fieldId="type" :fieldLabel="__('modules.enquiry.leadSource')"
...
<script>
    ...
    $('#save-source').click(function() {
        $.easyAjax({
            url: "{{route('enquiry-source-settings.update', $source->id)}}",
