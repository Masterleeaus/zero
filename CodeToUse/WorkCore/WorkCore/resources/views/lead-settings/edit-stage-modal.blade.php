                ...
                <div class="form-body">
                    <div class="row">
                        ...
                        {{-- <div class="col-sm-4 col-md-6">
                            <div class="form-group my-3 text-left">
                                <x-forms.label fieldId="priority" :fieldLabel="__('modules.service jobs.position')" fieldRequired="false"> </x-forms.label>
                        ...
                        <div class="col-md-6">
                            <x-forms.select fieldId="priority" :fieldLabel="__('modules.service jobs.position')" fieldName="priority"
                                search="true">
                                @php
...
<script>
    ...
    $('#save-status').click(function() {
        ...
        if(priorityType == "before"){
            var url = "{{route('enquiry-stage-setting.update', $stage->id)}}?before";
        }
        else{
            var url = "{{route('enquiry-stage-setting.update', $stage->id)}}";
        }
