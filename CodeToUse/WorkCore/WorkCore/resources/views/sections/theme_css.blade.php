<style>
    :root {
        ...
        /* For public pages use company specific header color example invoice,quote public page*/
    ...
    .site-header .site-menu .p-sub-menu.active:after,
    .site-header .site-menu .p-sub-menu::after,
