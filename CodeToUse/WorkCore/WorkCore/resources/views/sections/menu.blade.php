<ul>
    ...
    @if (in_array('service jobs', user_modules()) || in_array('events', user_modules()) || in_array('holidays', user_modules()) ||
                in_array('issues / support', user_modules()) || in_array('leaves', user_modules()))
    ...
    @if (!in_array('customer', user_roles()) && (in_array('enquiries', user_modules())) && (($sidebarUserPermissions['view_lead'] != 5 && $sidebarUserPermissions['view_lead'] != 'none') || ($sidebarUserPermissions['view_deals'] != 5 && $sidebarUserPermissions['view_deals'] != 'none')))
        <x-menu-item icon="person" :text="__('app.menu.enquiry')">
            <x-slot name="iconPath">
            ...
            <div class="accordionItemContent ">
                <x-sub-menu-item :link="route('enquiry-contact.index')" :text="__('app.leadContact')" />
            </div>
            @endif
    ...
    @if (!in_array('customer', user_roles()) && in_array('customers', user_modules()) && $sidebarUserPermissions['view_clients'] != 5 && $sidebarUserPermissions['view_clients'] != 'none')
        <x-menu-item icon="building" :text="__('app.menu.customers')" :link="route('customers.index')">
            <x-slot name="iconPath">
                <path fill-rule="evenodd"
...
<!-- NAV ITEM - HR COLLAPASE MENU -->
    @if (!in_array('customer', user_roles()) && (in_array('cleaners', user_modules()) || in_array('leaves', user_modules()) || in_array('attendance', user_modules()) || in_array('holidays', user_modules())) && ($sidebarUserPermissions['view_employees'] != 5 || $sidebarUserPermissions['view_leave'] != 5 || $sidebarUserPermissions['view_attendance'] != 5 || $sidebarUserPermissions['view_holiday'] != 5) && ($sidebarUserPermissions['view_employees'] != 'none' || $sidebarUserPermissions['view_leave'] != 'none' || $sidebarUserPermissions['view_attendance'] != 'none' || $sidebarUserPermissions['view_holiday'] != 'none' || $sidebarUserPermissions['view_shift_roster'] != 'none'))
        <x-menu-item icon="people" :text="__('app.menu.hr')">
            ...
            <div class="accordionItemContent">
                @if (in_array('cleaners', user_modules()) && $sidebarUserPermissions['view_employees'] != 5 && $sidebarUserPermissions['view_employees'] != 'none' && isset($sidebarUserPermissions['view_employee_menu']) && $sidebarUserPermissions['view_employee_menu'] == 4)
                    <x-sub-menu-item :link="route('cleaners.index')" :text="__('app.menu.cleaners')" />
                @endif
                ...
                @if (isset($sidebarUserPermissions['view_designation']) && $sidebarUserPermissions['view_designation'] == 4 )
                    <x-sub-menu-item :link="route('roles.index')" :text="__('app.menu.role')" />
                @endif
                @if (isset($sidebarUserPermissions['view_department']) && $sidebarUserPermissions['view_department'] == 4)
                    <x-sub-menu-item :link="route('zones.index')" :text="__('app.menu.zone')" />
                @endif
...
<!-- NAV ITEM - WORK COLLAPSE MENU -->
    @if ((in_array('service agreements', user_modules()) || in_array('sites', user_modules()) || in_array('service jobs', user_modules()) || in_array('timelogs', user_modules())) && ($sidebarUserPermissions['view_contract'] != 5 || $sidebarUserPermissions['view_projects'] != 5 || $sidebarUserPermissions['view_tasks'] != 5 || $sidebarUserPermissions['view_timelogs'] != 5) && ($sidebarUserPermissions['view_contract'] != 'none' || $sidebarUserPermissions['view_projects'] != 'none' || $sidebarUserPermissions['view_tasks'] != 'none' || $sidebarUserPermissions['view_timelogs'] != 'none'))
        <x-menu-item icon="briefcase" :text="__('app.menu.work')">
            ...
            <div class="accordionItemContent">
                @if (in_array('service agreements', user_modules()) && $sidebarUserPermissions['view_contract'] != 5 && $sidebarUserPermissions['view_contract'] != 'none')
                    <x-sub-menu-item :link="route('service agreements.index')" :text="__('app.menu.service agreements')" />
                @endif
                @if (in_array('sites', user_modules()) && $sidebarUserPermissions['view_projects'] != 5 && $sidebarUserPermissions['view_projects'] != 'none')
                    <x-sub-menu-item :link="route('sites.index')" :text="__('app.menu.sites')" />
                @endif
                {{-- @if (!in_array('customer', user_roles())) --}}
                @if (in_array('service jobs', user_modules()) && $sidebarUserPermissions['view_tasks'] != 5 && $sidebarUserPermissions['view_tasks'] != 'none')
                    <x-sub-menu-item :link="route('service jobs.index')" :text="__('app.menu.service jobs')" />
                @endif
...
<!-- NAV ITEM - FINANCE COLLAPASE MENU -->
    @if ((in_array('quotes', user_modules()) || in_array('invoices', user_modules()) || in_array('payments', user_modules()) || in_array('expenses', user_modules()) || in_array('bankaccount', user_modules())) && ($sidebarUserPermissions['view_estimates'] != 5 || $sidebarUserPermissions['view_invoices'] != 5 || $sidebarUserPermissions['view_payments'] != 5 || $sidebarUserPermissions['view_expenses'] != 5 || $sidebarUserPermissions['view_lead_proposals'] != 5 || $sidebarUserPermissions['view_bankaccount'] != 5) && ($sidebarUserPermissions['view_estimates'] != 'none' || $sidebarUserPermissions['view_invoices'] != 'none' || $sidebarUserPermissions['view_payments'] != 'none' || $sidebarUserPermissions['view_expenses'] != 'none' || $sidebarUserPermissions['view_lead_proposals'] != 'none' || $sidebarUserPermissions['view_bankaccount'] != 'none'))
        <x-menu-item icon="cash-coin" :active="($currentRouteName === 'payments.index')"
            ...
            <div class="accordionItemContent">
                @if (in_array('enquiries', user_modules()) && $sidebarUserPermissions['view_lead_proposals'] != 5 && $sidebarUserPermissions['view_lead_proposals'] != 'none')
                    <x-sub-menu-item :link="route('proposals.index')" :text="__('app.menu.proposal')" />
                @endif
                @if (in_array('quotes', user_modules()) && $sidebarUserPermissions['view_estimates'] != 5 && $sidebarUserPermissions['view_estimates'] != 'none')
                    <x-sub-menu-item :link="route('quotes.index')" :text="__('app.menu.quotes')" />
                @endif
...
<!-- NAV ITEM - PRODUCTS -->
@if (!in_array('purchase', user_modules()) && in_array('services / extras', user_modules()) && $sidebarUserPermissions['view_product'] != 5 && $sidebarUserPermissions['view_product'] != 'none')
        <x-menu-item icon="basket" :text="__('app.menu.services / extras')" :link="route('services / extras.index')">
            <x-slot name="iconPath">
                <path
...
<!-- NAV ITEM - TICKETS -->
    @if (in_array('issues / support', user_modules()) && $sidebarUserPermissions['view_tickets'] != 5 && $sidebarUserPermissions['view_tickets'] != 'none')
        <x-menu-item icon="headset" :text="__('app.menu.issues / support')" :link="route('issues / support.index')">
            <x-slot name="iconPath">
                <path
...
<!-- NAV ITEM - MESSAGES -->
    @if (in_array('team chat', user_modules()) && (!in_array('groupmessage', user_modules())))
        @if ((message_setting()->allow_client_admin == 'yes' || message_setting()->allow_client_employee == 'yes') && in_array('customer', user_roles()))
            <x-menu-item class="message-menu" icon="chat-left-text" :text="__('app.menu.team chat')"
                         :count="$unreadMessagesCount" :link="route('team chat.index')">
                <x-slot name="iconPath">
                    <path
        ...
        @elseif (in_array('cleaner', user_roles()))
            <x-menu-item class="message-menu" icon="chat-left-text" :text="__('app.menu.team chat')"
                         :link="route('team chat.index')" :count="$unreadMessagesCount">
                <x-slot name="iconPath">
                    <path
                        d="M14 1a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H4.414A2 2 0 0 0 3 11.586l-2 2V2a1 1 0 0 1 1-1h12zM2 0a2 2 0 0 0-2 2v12.793a.5.5 0 0 0 .854.353l2.853-2.853A1 1 0 0 1 4.414 12H14a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2H2z" />
                    <path
...
<!-- NAV ITEM - GDPR -->
    @if ((in_array('admin', user_roles()) || in_array('customer', user_roles())) && $gdpr->enable_gdpr == 1)
...
<!-- Knowledge base -->
    ...
    <!-- NAV ITEM - NOTES -->
    @if (in_array('customer', user_roles()) && $sidebarUserPermissions['view_client_note'] != 5)
        <x-menu-item icon="journal-text" :text="__('app.menu.notes')" :link="route('customer-notes.index')">
            <x-slot name="iconPath">
                <path
...
<!-- NAV ITEM - NOTICES -->
    @if (in_array('reports', user_modules()) && ($sidebarUserPermissions['view_task_report'] == 4 || $sidebarUserPermissions['view_time_log_report'] == 4 || (isset($sidebarUserPermissions['view_expense_report']) && $sidebarUserPermissions['view_expense_report'] == 4) || $sidebarUserPermissions['view_finance_report'] != 5 || $sidebarUserPermissions['view_income_expense_report'] == 4 || $sidebarUserPermissions['view_leave_report'] != 5 || $sidebarUserPermissions['view_attendance_report'] == 4 || $sidebarUserPermissions['view_lead_report'] == 4 || $sidebarUserPermissions['view_sales_report'] == 4) && ($sidebarUserPermissions['view_task_report'] != 'none' || $sidebarUserPermissions['view_time_log_report'] != 'none' || $sidebarUserPermissions['view_finance_report'] != 'none' || $sidebarUserPermissions['view_income_expense_report'] != 'none' || $sidebarUserPermissions['view_leave_report'] != 'none' || $sidebarUserPermissions['view_attendance_report'] != 'none' || $sidebarUserPermissions['view_lead_report'] != 'none' || $sidebarUserPermissions['view_sales_report'] != 'none' || (isset($sidebarUserPermissions['view_expense_report']) && $sidebarUserPermissions['view_expense_report'] != 'none')))
        <x-menu-item icon="graph-up" :text="__('app.menu.reports')">
            ...
            <div class="accordionItemContent">
                @if ($sidebarUserPermissions['view_task_report'] == 4 && $sidebarUserPermissions['view_task_report'] != 'none' && in_array('service jobs', user_modules()))
                    <x-sub-menu-item :link="route('service job-report.index')" :text="__('app.menu.taskReport')" />
                @endif
               ...
               @if ($sidebarUserPermissions['view_time_log_report'] == 4 && $sidebarUserPermissions['view_time_log_report'] != 'none' && in_array('timelogs', user_modules()))
                ...
                @endif
                @if (isset($sidebarUserPermissions['view_lead_report']) && $sidebarUserPermissions['view_lead_report'] == 4 && $sidebarUserPermissions['view_lead_report'] != 'none' && in_array('enquiries', user_modules()))
                    <x-sub-menu-item :link="route('enquiry-report.index')"
