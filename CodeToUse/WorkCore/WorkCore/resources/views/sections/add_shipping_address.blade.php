<div class="modal-header">
    <h5 class="modal-title" id="modelHeading">@lang('modules.customers.addShippingAddress')</h5>
        ...
        <div class="row">
            <div class="col-lg-12">
                <x-forms.textarea class="mr-0 mr-lg-2 mr-md-2"
                    :fieldLabel="__('modules.customers.shippingAddress')" fieldName="shipping_address"
