                                ...
                                <div class="form-group my-3">
                                    ...
                                    <div class="d-flex">
                                        <x-forms.radio fieldId="toEmployee"
                                            ...
                                            fieldValue="cleaner" :checked="$knowledge->to == 'cleaner'">
                                        </x-forms.radio>
                                        @if (in_array('customers', user_modules()) || ($knowledge->to == 'customer'))
                                            <x-forms.radio fieldId="toClient" :fieldLabel="__('modules.notices.toClients')"
                                                fieldValue="customer" fieldName="to" :checked="$knowledge->to == 'customer'">
                                            </x-forms.radio>
                                        @endif
                                    </div>
                                </div>
