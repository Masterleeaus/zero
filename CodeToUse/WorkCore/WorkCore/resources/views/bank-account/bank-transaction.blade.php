...
<div class="row pb-5">
    ...
    <div class="col-lg-7">
                ...
                <div class="d-flex">
                    ...
                    <div class="ml-2">
                        @if ($bankaccount->bank_name != '')
                            <h3 class="heading-h3">{{ $bankaccount->bank_name }}

                                @if($bankaccount->sort_code)
                                     <span class="text-dark font-weight-semibold"> ( {{ $bankaccount->sort_code }} )</span>
                                @endif
                            </h3>
        ...
        <x-cards.data :title="__('modules.bankaccount.creditVsDebit')">
            <x-line-chart id="service job-chart5" :chartData="$creditVsDebitChart" height="250" multiple="true" />
        </x-cards.data>
