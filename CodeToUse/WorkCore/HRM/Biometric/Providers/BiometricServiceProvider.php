...
use Modules\Biometric\Console\ActivateModuleCommand;

use Modules\Biometric\Listeners\CompanyCreatedListener;

class BiometricServiceProvider extends ServiceProvider
{
    protected string $moduleName = 'Biometric';

    protected string $moduleNameLower = 'biometric';
    ...
    public function boot(): void
    {
        ...
        if (class_exists(\Modules\TitanZero\Services\CapabilityRegistry::class)) {
            \Modules\TitanZero\Services\CapabilityRegistry::registerModuleFromConfig('Biometric');
        }
}
