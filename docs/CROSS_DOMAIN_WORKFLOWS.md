...
- Attendance and shift summaries contribute late/missed/open counts; due agreements are included for scheduled job readiness.
...
- Timelog slice added (Work → Timelogs) with company scoping; attendance/shift imports now include late/missed helpers and agreement scheduler wiring.
